...
/// Solid style SignalSteam icon.
///
/// Example:
/// ```dart
/// SolidSignalSteam(size: 24, color: Colors.blue);
/// ```
class SolidSignalSteam extends StatelessWidget {
  ...
  /// Creates a SolidSignalSteam.
  const SolidSignalSteam({
    super.key,
    this.size = 24,
    this.color,
  });
