...
/// Solid style LaptopWired icon.
///
/// Example:
/// ```dart
/// SolidLaptopWired(size: 24, color: Colors.blue);
/// ```
class SolidLaptopWired extends StatelessWidget {
  ...
  /// Creates a SolidLaptopWired.
  const SolidLaptopWired({
    super.key,
    this.size = 24,
    this.color,
  });
