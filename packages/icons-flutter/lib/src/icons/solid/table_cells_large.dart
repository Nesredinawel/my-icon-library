...
/// Solid style TableCellsLarge icon.
///
/// Example:
/// ```dart
/// SolidTableCellsLarge(size: 24, color: Colors.blue);
/// ```
class SolidTableCellsLarge extends StatelessWidget {
  ...
  /// Creates a SolidTableCellsLarge.
  const SolidTableCellsLarge({
    super.key,
    this.size = 24,
    this.color,
  });
