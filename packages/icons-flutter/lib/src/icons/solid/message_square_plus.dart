...
/// Solid style MessageSquarePlus icon.
///
/// Example:
/// ```dart
/// SolidMessageSquarePlus(size: 24, color: Colors.blue);
/// ```
class SolidMessageSquarePlus extends StatelessWidget {
  ...
  /// Creates a SolidMessageSquarePlus.
  const SolidMessageSquarePlus({
    super.key,
    this.size = 24,
    this.color,
  });
