...
/// Solid style FolderExclamation icon.
///
/// Example:
/// ```dart
/// SolidFolderExclamation(size: 24, color: Colors.blue);
/// ```
class SolidFolderExclamation extends StatelessWidget {
  ...
  /// Creates a SolidFolderExclamation.
  const SolidFolderExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
