...
/// Solid style TrashUndoAlt icon.
///
/// Example:
/// ```dart
/// SolidTrashUndoAlt(size: 24, color: Colors.blue);
/// ```
class SolidTrashUndoAlt extends StatelessWidget {
  ...
  /// Creates a SolidTrashUndoAlt.
  const SolidTrashUndoAlt({
    super.key,
    this.size = 24,
    this.color,
  });
