...
/// Solid style FolderCheck icon.
///
/// Example:
/// ```dart
/// SolidFolderCheck(size: 24, color: Colors.blue);
/// ```
class SolidFolderCheck extends StatelessWidget {
  ...
  /// Creates a SolidFolderCheck.
  const SolidFolderCheck({
    super.key,
    this.size = 24,
    this.color,
  });
