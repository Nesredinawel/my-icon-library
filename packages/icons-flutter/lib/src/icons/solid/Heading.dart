...
/// Solid style Heading icon.
///
/// Example:
/// ```dart
/// SolidHeading(size: 24, color: Colors.blue);
/// ```
class SolidHeading extends StatelessWidget {
