...
/// Solid style InboxExclamation icon.
///
/// Example:
/// ```dart
/// SolidInboxExclamation(size: 24, color: Colors.blue);
/// ```
class SolidInboxExclamation extends StatelessWidget {
  ...
  /// Creates a SolidInboxExclamation.
  const SolidInboxExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
