...
/// Solid style MonitorAlt3 icon.
///
/// Example:
/// ```dart
/// SolidMonitorAlt3(size: 24, color: Colors.blue);
/// ```
class SolidMonitorAlt3 extends StatelessWidget {
  ...
  /// Creates a SolidMonitorAlt3.
  const SolidMonitorAlt3({
    super.key,
    this.size = 24,
    this.color,
  });
