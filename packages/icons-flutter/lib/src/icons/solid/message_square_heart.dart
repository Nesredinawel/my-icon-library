...
/// Solid style MessageSquareHeart icon.
///
/// Example:
/// ```dart
/// SolidMessageSquareHeart(size: 24, color: Colors.blue);
/// ```
class SolidMessageSquareHeart extends StatelessWidget {
  ...
  /// Creates a SolidMessageSquareHeart.
  const SolidMessageSquareHeart({
    super.key,
    this.size = 24,
    this.color,
  });
