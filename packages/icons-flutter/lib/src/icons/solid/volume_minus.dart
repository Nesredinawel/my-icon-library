...
/// Solid style VolumeMinus icon.
///
/// Example:
/// ```dart
/// SolidVolumeMinus(size: 24, color: Colors.blue);
/// ```
class SolidVolumeMinus extends StatelessWidget {
  ...
  /// Creates a SolidVolumeMinus.
  const SolidVolumeMinus({
    super.key,
    this.size = 24,
    this.color,
  });
