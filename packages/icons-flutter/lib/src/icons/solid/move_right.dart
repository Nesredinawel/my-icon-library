...
/// Solid style MoveRight icon.
///
/// Example:
/// ```dart
/// SolidMoveRight(size: 24, color: Colors.blue);
/// ```
class SolidMoveRight extends StatelessWidget {
  ...
  /// Creates a SolidMoveRight.
  const SolidMoveRight({
    super.key,
    this.size = 24,
    this.color,
  });
