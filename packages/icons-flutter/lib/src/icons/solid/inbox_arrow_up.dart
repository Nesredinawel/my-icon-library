...
/// Solid style InboxArrowUp icon.
///
/// Example:
/// ```dart
/// SolidInboxArrowUp(size: 24, color: Colors.blue);
/// ```
class SolidInboxArrowUp extends StatelessWidget {
  ...
  /// Creates a SolidInboxArrowUp.
  const SolidInboxArrowUp({
    super.key,
    this.size = 24,
    this.color,
  });
