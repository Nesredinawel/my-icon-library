...
/// Solid style TriangleArrowsBolt icon.
///
/// Example:
/// ```dart
/// SolidTriangleArrowsBolt(size: 24, color: Colors.blue);
/// ```
class SolidTriangleArrowsBolt extends StatelessWidget {
  ...
  /// Creates a SolidTriangleArrowsBolt.
  const SolidTriangleArrowsBolt({
    super.key,
    this.size = 24,
    this.color,
  });
