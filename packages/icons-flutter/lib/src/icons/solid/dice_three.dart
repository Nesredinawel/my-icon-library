...
/// Solid style DiceThree icon.
///
/// Example:
/// ```dart
/// SolidDiceThree(size: 24, color: Colors.blue);
/// ```
class SolidDiceThree extends StatelessWidget {
  ...
  /// Creates a SolidDiceThree.
  const SolidDiceThree({
    super.key,
    this.size = 24,
    this.color,
  });
