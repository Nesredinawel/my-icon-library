...
/// Solid style UserShieldAlt icon.
///
/// Example:
/// ```dart
/// SolidUserShieldAlt(size: 24, color: Colors.blue);
/// ```
class SolidUserShieldAlt extends StatelessWidget {
  ...
  /// Creates a SolidUserShieldAlt.
  const SolidUserShieldAlt({
    super.key,
    this.size = 24,
    this.color,
  });
