...
/// Solid style FolderArrowRight icon.
///
/// Example:
/// ```dart
/// SolidFolderArrowRight(size: 24, color: Colors.blue);
/// ```
class SolidFolderArrowRight extends StatelessWidget {
  ...
  /// Creates a SolidFolderArrowRight.
  const SolidFolderArrowRight({
    super.key,
    this.size = 24,
    this.color,
  });
