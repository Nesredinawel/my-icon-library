...
/// Solid style FolderImage icon.
///
/// Example:
/// ```dart
/// SolidFolderImage(size: 24, color: Colors.blue);
/// ```
class SolidFolderImage extends StatelessWidget {
  ...
  /// Creates a SolidFolderImage.
  const SolidFolderImage({
    super.key,
    this.size = 24,
    this.color,
  });
