...
/// Solid style VideoPlus icon.
///
/// Example:
/// ```dart
/// SolidVideoPlus(size: 24, color: Colors.blue);
/// ```
class SolidVideoPlus extends StatelessWidget {
  ...
  /// Creates a SolidVideoPlus.
  const SolidVideoPlus({
    super.key,
    this.size = 24,
    this.color,
  });
