...
/// Solid style InboxMinus icon.
///
/// Example:
/// ```dart
/// SolidInboxMinus(size: 24, color: Colors.blue);
/// ```
class SolidInboxMinus extends StatelessWidget {
  ...
  /// Creates a SolidInboxMinus.
  const SolidInboxMinus({
    super.key,
    this.size = 24,
    this.color,
  });
