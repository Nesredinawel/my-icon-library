...
/// Solid style VolumeMax icon.
///
/// Example:
/// ```dart
/// SolidVolumeMax(size: 24, color: Colors.blue);
/// ```
class SolidVolumeMax extends StatelessWidget {
  ...
  /// Creates a SolidVolumeMax.
  const SolidVolumeMax({
    super.key,
    this.size = 24,
    this.color,
  });
