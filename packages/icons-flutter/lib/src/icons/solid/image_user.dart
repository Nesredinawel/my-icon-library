...
/// Solid style ImageUser icon.
///
/// Example:
/// ```dart
/// SolidImageUser(size: 24, color: Colors.blue);
/// ```
class SolidImageUser extends StatelessWidget {
  ...
  /// Creates a SolidImageUser.
  const SolidImageUser({
    super.key,
    this.size = 24,
    this.color,
  });
