...
/// Solid style BatteryMid icon.
///
/// Example:
/// ```dart
/// SolidBatteryMid(size: 24, color: Colors.blue);
/// ```
class SolidBatteryMid extends StatelessWidget {
  ...
  /// Creates a SolidBatteryMid.
  const SolidBatteryMid({
    super.key,
    this.size = 24,
    this.color,
  });
