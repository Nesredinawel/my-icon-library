...
/// Solid style HouseBoltAlt icon.
///
/// Example:
/// ```dart
/// SolidHouseBoltAlt(size: 24, color: Colors.blue);
/// ```
class SolidHouseBoltAlt extends StatelessWidget {
  ...
  /// Creates a SolidHouseBoltAlt.
  const SolidHouseBoltAlt({
    super.key,
    this.size = 24,
    this.color,
  });
