...
/// Solid style MessageSquareArrowDown icon.
///
/// Example:
/// ```dart
/// SolidMessageSquareArrowDown(size: 24, color: Colors.blue);
/// ```
class SolidMessageSquareArrowDown extends StatelessWidget {
  ...
  /// Creates a SolidMessageSquareArrowDown.
  const SolidMessageSquareArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
