...
/// Solid style BatteryLow icon.
///
/// Example:
/// ```dart
/// SolidBatteryLow(size: 24, color: Colors.blue);
/// ```
class SolidBatteryLow extends StatelessWidget {
