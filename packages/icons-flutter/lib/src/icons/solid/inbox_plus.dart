...
/// Solid style InboxPlus icon.
///
/// Example:
/// ```dart
/// SolidInboxPlus(size: 24, color: Colors.blue);
/// ```
class SolidInboxPlus extends StatelessWidget {
  ...
  /// Creates a SolidInboxPlus.
  const SolidInboxPlus({
    super.key,
    this.size = 24,
    this.color,
  });
