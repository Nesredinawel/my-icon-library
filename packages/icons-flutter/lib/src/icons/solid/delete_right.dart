...
/// Solid style DeleteRight icon.
///
/// Example:
/// ```dart
/// SolidDeleteRight(size: 24, color: Colors.blue);
/// ```
class SolidDeleteRight extends StatelessWidget {
  ...
  /// Creates a SolidDeleteRight.
  const SolidDeleteRight({
    super.key,
    this.size = 24,
    this.color,
  });
