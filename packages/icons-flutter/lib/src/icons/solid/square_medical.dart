...
/// Solid style SquareMedical icon.
///
/// Example:
/// ```dart
/// SolidSquareMedical(size: 24, color: Colors.blue);
/// ```
class SolidSquareMedical extends StatelessWidget {
  ...
  /// Creates a SolidSquareMedical.
  const SolidSquareMedical({
    super.key,
    this.size = 24,
    this.color,
  });
