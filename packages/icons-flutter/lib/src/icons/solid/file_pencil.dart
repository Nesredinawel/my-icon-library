...
/// Solid style FilePencil icon.
///
/// Example:
/// ```dart
/// SolidFilePencil(size: 24, color: Colors.blue);
/// ```
class SolidFilePencil extends StatelessWidget {
  ...
  /// Creates a SolidFilePencil.
  const SolidFilePencil({
    super.key,
    this.size = 24,
    this.color,
  });
