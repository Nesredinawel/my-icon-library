...
/// Solid style CodeFork icon.
///
/// Example:
/// ```dart
/// SolidCodeFork(size: 24, color: Colors.blue);
/// ```
class SolidCodeFork extends StatelessWidget {
