...
/// Solid style Mobile icon.
///
/// Example:
/// ```dart
/// SolidMobile(size: 24, color: Colors.blue);
/// ```
class SolidMobile extends StatelessWidget {
