...
/// Solid style TrashArrowUpAlt icon.
///
/// Example:
/// ```dart
/// SolidTrashArrowUpAlt(size: 24, color: Colors.blue);
/// ```
class SolidTrashArrowUpAlt extends StatelessWidget {
  ...
  /// Creates a SolidTrashArrowUpAlt.
  const SolidTrashArrowUpAlt({
    super.key,
    this.size = 24,
    this.color,
  });
