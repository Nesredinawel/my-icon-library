...
/// Solid style HouseCrack icon.
///
/// Example:
/// ```dart
/// SolidHouseCrack(size: 24, color: Colors.blue);
/// ```
class SolidHouseCrack extends StatelessWidget {
  ...
  /// Creates a SolidHouseCrack.
  const SolidHouseCrack({
    super.key,
    this.size = 24,
    this.color,
  });
