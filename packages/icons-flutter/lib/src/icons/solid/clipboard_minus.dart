...
/// Solid style ClipboardMinus icon.
///
/// Example:
/// ```dart
/// SolidClipboardMinus(size: 24, color: Colors.blue);
/// ```
class SolidClipboardMinus extends StatelessWidget {
  ...
  /// Creates a SolidClipboardMinus.
  const SolidClipboardMinus({
    super.key,
    this.size = 24,
    this.color,
  });
