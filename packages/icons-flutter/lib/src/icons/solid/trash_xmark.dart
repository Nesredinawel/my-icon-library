...
/// Solid style TrashXmark icon.
///
/// Example:
/// ```dart
/// SolidTrashXmark(size: 24, color: Colors.blue);
/// ```
class SolidTrashXmark extends StatelessWidget {
  ...
  /// Creates a SolidTrashXmark.
  const SolidTrashXmark({
    super.key,
    this.size = 24,
    this.color,
  });
