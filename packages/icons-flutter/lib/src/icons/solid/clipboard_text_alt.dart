...
/// Solid style ClipboardTextAlt icon.
///
/// Example:
/// ```dart
/// SolidClipboardTextAlt(size: 24, color: Colors.blue);
/// ```
class SolidClipboardTextAlt extends StatelessWidget {
  ...
  /// Creates a SolidClipboardTextAlt.
  const SolidClipboardTextAlt({
    super.key,
    this.size = 24,
    this.color,
  });
