...
/// Solid style Drum icon.
///
/// Example:
/// ```dart
/// SolidDrum(size: 24, color: Colors.blue);
/// ```
class SolidDrum extends StatelessWidget {
