...
/// Solid style MessageSquareRefresh icon.
///
/// Example:
/// ```dart
/// SolidMessageSquareRefresh(size: 24, color: Colors.blue);
/// ```
class SolidMessageSquareRefresh extends StatelessWidget {
  ...
  /// Creates a SolidMessageSquareRefresh.
  const SolidMessageSquareRefresh({
    super.key,
    this.size = 24,
    this.color,
  });
