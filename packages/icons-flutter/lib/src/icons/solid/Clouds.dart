...
/// Solid style Clouds icon.
///
/// Example:
/// ```dart
/// SolidClouds(size: 24, color: Colors.blue);
/// ```
class SolidClouds extends StatelessWidget {
