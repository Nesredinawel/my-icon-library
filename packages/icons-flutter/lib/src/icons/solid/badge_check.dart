...
/// Solid style BadgeCheck icon.
///
/// Example:
/// ```dart
/// SolidBadgeCheck(size: 24, color: Colors.blue);
/// ```
class SolidBadgeCheck extends StatelessWidget {
