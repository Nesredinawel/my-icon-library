...
/// Solid style BatteryBolt icon.
///
/// Example:
/// ```dart
/// SolidBatteryBolt(size: 24, color: Colors.blue);
/// ```
class SolidBatteryBolt extends StatelessWidget {
  ...
  /// Creates a SolidBatteryBolt.
  const SolidBatteryBolt({
    super.key,
    this.size = 24,
    this.color,
  });
