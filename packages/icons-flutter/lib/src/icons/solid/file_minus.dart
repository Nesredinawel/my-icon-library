...
/// Solid style FileMinus icon.
///
/// Example:
/// ```dart
/// SolidFileMinus(size: 24, color: Colors.blue);
/// ```
class SolidFileMinus extends StatelessWidget {
