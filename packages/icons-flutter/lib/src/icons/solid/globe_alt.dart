...
/// Solid style GlobeAlt icon.
///
/// Example:
/// ```dart
/// SolidGlobeAlt(size: 24, color: Colors.blue);
/// ```
class SolidGlobeAlt extends StatelessWidget {
