...
/// Solid style LaptopXmarkAlt icon.
///
/// Example:
/// ```dart
/// SolidLaptopXmarkAlt(size: 24, color: Colors.blue);
/// ```
class SolidLaptopXmarkAlt extends StatelessWidget {
  ...
  /// Creates a SolidLaptopXmarkAlt.
  const SolidLaptopXmarkAlt({
    super.key,
    this.size = 24,
    this.color,
  });
