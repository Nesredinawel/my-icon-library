...
/// Solid style SquareUser icon.
///
/// Example:
/// ```dart
/// SolidSquareUser(size: 24, color: Colors.blue);
/// ```
class SolidSquareUser extends StatelessWidget {
  ...
  /// Creates a SolidSquareUser.
  const SolidSquareUser({
    super.key,
    this.size = 24,
    this.color,
  });
