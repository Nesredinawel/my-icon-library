...
/// Solid style TrashSlashAlt icon.
///
/// Example:
/// ```dart
/// SolidTrashSlashAlt(size: 24, color: Colors.blue);
/// ```
class SolidTrashSlashAlt extends StatelessWidget {
  ...
  /// Creates a SolidTrashSlashAlt.
  const SolidTrashSlashAlt({
    super.key,
    this.size = 24,
    this.color,
  });
