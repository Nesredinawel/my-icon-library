...
/// Solid style ClipboardUser icon.
///
/// Example:
/// ```dart
/// SolidClipboardUser(size: 24, color: Colors.blue);
/// ```
class SolidClipboardUser extends StatelessWidget {
  ...
  /// Creates a SolidClipboardUser.
  const SolidClipboardUser({
    super.key,
    this.size = 24,
    this.color,
  });
