...
/// Solid style MonitorAlt icon.
///
/// Example:
/// ```dart
/// SolidMonitorAlt(size: 24, color: Colors.blue);
/// ```
class SolidMonitorAlt extends StatelessWidget {
  ...
  /// Creates a SolidMonitorAlt.
  const SolidMonitorAlt({
    super.key,
    this.size = 24,
    this.color,
  });
