...
/// Solid style Train icon.
///
/// Example:
/// ```dart
/// SolidTrain(size: 24, color: Colors.blue);
/// ```
class SolidTrain extends StatelessWidget {
