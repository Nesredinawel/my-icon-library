...
/// Solid style MailMinus icon.
///
/// Example:
/// ```dart
/// SolidMailMinus(size: 24, color: Colors.blue);
/// ```
class SolidMailMinus extends StatelessWidget {
  ...
  /// Creates a SolidMailMinus.
  const SolidMailMinus({
    super.key,
    this.size = 24,
    this.color,
  });
