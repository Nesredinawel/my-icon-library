...
/// Solid style CartShoppingFast icon.
///
/// Example:
/// ```dart
/// SolidCartShoppingFast(size: 24, color: Colors.blue);
/// ```
class SolidCartShoppingFast extends StatelessWidget {
  ...
  /// Creates a SolidCartShoppingFast.
  const SolidCartShoppingFast({
    super.key,
    this.size = 24,
    this.color,
  });
