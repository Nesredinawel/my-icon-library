...
/// Solid style DiamondTurnRight icon.
///
/// Example:
/// ```dart
/// SolidDiamondTurnRight(size: 24, color: Colors.blue);
/// ```
class SolidDiamondTurnRight extends StatelessWidget {
  ...
  /// Creates a SolidDiamondTurnRight.
  const SolidDiamondTurnRight({
    super.key,
    this.size = 24,
    this.color,
  });
