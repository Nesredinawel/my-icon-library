...
/// Solid style DialMed icon.
///
/// Example:
/// ```dart
/// SolidDialMed(size: 24, color: Colors.blue);
/// ```
class SolidDialMed extends StatelessWidget {
