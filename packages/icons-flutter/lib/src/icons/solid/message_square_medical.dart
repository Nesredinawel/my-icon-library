...
/// Solid style MessageSquareMedical icon.
///
/// Example:
/// ```dart
/// SolidMessageSquareMedical(size: 24, color: Colors.blue);
/// ```
class SolidMessageSquareMedical extends StatelessWidget {
  ...
  /// Creates a SolidMessageSquareMedical.
  const SolidMessageSquareMedical({
    super.key,
    this.size = 24,
    this.color,
  });
