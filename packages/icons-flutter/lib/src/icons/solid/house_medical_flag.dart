...
/// Solid style HouseMedicalFlag icon.
///
/// Example:
/// ```dart
/// SolidHouseMedicalFlag(size: 24, color: Colors.blue);
/// ```
class SolidHouseMedicalFlag extends StatelessWidget {
  ...
  /// Creates a SolidHouseMedicalFlag.
  const SolidHouseMedicalFlag({
    super.key,
    this.size = 24,
    this.color,
  });
