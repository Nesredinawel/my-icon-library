...
/// Solid style TrashAlt icon.
///
/// Example:
/// ```dart
/// SolidTrashAlt(size: 24, color: Colors.blue);
/// ```
class SolidTrashAlt extends StatelessWidget {
