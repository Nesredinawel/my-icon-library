...
/// Solid style ClipboardArrowDown icon.
///
/// Example:
/// ```dart
/// SolidClipboardArrowDown(size: 24, color: Colors.blue);
/// ```
class SolidClipboardArrowDown extends StatelessWidget {
  ...
  /// Creates a SolidClipboardArrowDown.
  const SolidClipboardArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
