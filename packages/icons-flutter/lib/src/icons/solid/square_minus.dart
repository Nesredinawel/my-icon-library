...
/// Solid style SquareMinus icon.
///
/// Example:
/// ```dart
/// SolidSquareMinus(size: 24, color: Colors.blue);
/// ```
class SolidSquareMinus extends StatelessWidget {
  ...
  /// Creates a SolidSquareMinus.
  const SolidSquareMinus({
    super.key,
    this.size = 24,
    this.color,
  });
