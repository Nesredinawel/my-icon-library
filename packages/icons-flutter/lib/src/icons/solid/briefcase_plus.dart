...
/// Solid style BriefcasePlus icon.
///
/// Example:
/// ```dart
/// SolidBriefcasePlus(size: 24, color: Colors.blue);
/// ```
class SolidBriefcasePlus extends StatelessWidget {
  ...
  /// Creates a SolidBriefcasePlus.
  const SolidBriefcasePlus({
    super.key,
    this.size = 24,
    this.color,
  });
