...
/// Solid style CalendarLines icon.
///
/// Example:
/// ```dart
/// SolidCalendarLines(size: 24, color: Colors.blue);
/// ```
class SolidCalendarLines extends StatelessWidget {
  ...
  /// Creates a SolidCalendarLines.
  const SolidCalendarLines({
    super.key,
    this.size = 24,
    this.color,
  });
