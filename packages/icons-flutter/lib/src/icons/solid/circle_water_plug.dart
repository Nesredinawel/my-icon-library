...
/// Solid style CircleWaterPlug icon.
///
/// Example:
/// ```dart
/// SolidCircleWaterPlug(size: 24, color: Colors.blue);
/// ```
class SolidCircleWaterPlug extends StatelessWidget {
  ...
  /// Creates a SolidCircleWaterPlug.
  const SolidCircleWaterPlug({
    super.key,
    this.size = 24,
    this.color,
  });
