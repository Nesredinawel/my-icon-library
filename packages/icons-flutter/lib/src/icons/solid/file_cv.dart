...
/// Solid style FileCv icon.
///
/// Example:
/// ```dart
/// SolidFileCv(size: 24, color: Colors.blue);
/// ```
class SolidFileCv extends StatelessWidget {
