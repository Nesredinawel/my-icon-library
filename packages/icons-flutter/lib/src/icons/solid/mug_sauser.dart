...
/// Solid style MugSauser icon.
///
/// Example:
/// ```dart
/// SolidMugSauser(size: 24, color: Colors.blue);
/// ```
class SolidMugSauser extends StatelessWidget {
  ...
  /// Creates a SolidMugSauser.
  const SolidMugSauser({
    super.key,
    this.size = 24,
    this.color,
  });
