...
/// Solid style MessageSquareChartLines icon.
///
/// Example:
/// ```dart
/// SolidMessageSquareChartLines(size: 24, color: Colors.blue);
/// ```
class SolidMessageSquareChartLines extends StatelessWidget {
  ...
  /// Creates a SolidMessageSquareChartLines.
  const SolidMessageSquareChartLines({
    super.key,
    this.size = 24,
    this.color,
  });
