...
/// Solid style DiceTwo icon.
///
/// Example:
/// ```dart
/// SolidDiceTwo(size: 24, color: Colors.blue);
/// ```
class SolidDiceTwo extends StatelessWidget {
