...
/// Solid style IdBadge icon.
///
/// Example:
/// ```dart
/// SolidIdBadge(size: 24, color: Colors.blue);
/// ```
class SolidIdBadge extends StatelessWidget {
