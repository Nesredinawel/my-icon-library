...
/// Solid style FolderXmark icon.
///
/// Example:
/// ```dart
/// SolidFolderXmark(size: 24, color: Colors.blue);
/// ```
class SolidFolderXmark extends StatelessWidget {
  ...
  /// Creates a SolidFolderXmark.
  const SolidFolderXmark({
    super.key,
    this.size = 24,
    this.color,
  });
