...
/// Solid style Clipboard icon.
///
/// Example:
/// ```dart
/// SolidClipboard(size: 24, color: Colors.blue);
/// ```
class SolidClipboard extends StatelessWidget {
