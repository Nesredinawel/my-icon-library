...
/// Solid style TableCells icon.
///
/// Example:
/// ```dart
/// SolidTableCells(size: 24, color: Colors.blue);
/// ```
class SolidTableCells extends StatelessWidget {
  ...
  /// Creates a SolidTableCells.
  const SolidTableCells({
    super.key,
    this.size = 24,
    this.color,
  });
