...
/// Solid style SquareCv icon.
///
/// Example:
/// ```dart
/// SolidSquareCv(size: 24, color: Colors.blue);
/// ```
class SolidSquareCv extends StatelessWidget {
