...
/// Solid style TvAlt1 icon.
///
/// Example:
/// ```dart
/// SolidTvAlt1(size: 24, color: Colors.blue);
/// ```
class SolidTvAlt1 extends StatelessWidget {
