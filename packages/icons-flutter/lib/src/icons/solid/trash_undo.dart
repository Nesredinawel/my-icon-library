...
/// Solid style TrashUndo icon.
///
/// Example:
/// ```dart
/// SolidTrashUndo(size: 24, color: Colors.blue);
/// ```
class SolidTrashUndo extends StatelessWidget {
  ...
  /// Creates a SolidTrashUndo.
  const SolidTrashUndo({
    super.key,
    this.size = 24,
    this.color,
  });
