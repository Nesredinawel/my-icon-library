...
/// Solid style SquareCheck icon.
///
/// Example:
/// ```dart
/// SolidSquareCheck(size: 24, color: Colors.blue);
/// ```
class SolidSquareCheck extends StatelessWidget {
  ...
  /// Creates a SolidSquareCheck.
  const SolidSquareCheck({
    super.key,
    this.size = 24,
    this.color,
  });
