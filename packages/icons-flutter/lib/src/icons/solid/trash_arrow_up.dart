...
/// Solid style TrashArrowUp icon.
///
/// Example:
/// ```dart
/// SolidTrashArrowUp(size: 24, color: Colors.blue);
/// ```
class SolidTrashArrowUp extends StatelessWidget {
  ...
  /// Creates a SolidTrashArrowUp.
  const SolidTrashArrowUp({
    super.key,
    this.size = 24,
    this.color,
  });
