...
/// Solid style FolderArrowLeft icon.
///
/// Example:
/// ```dart
/// SolidFolderArrowLeft(size: 24, color: Colors.blue);
/// ```
class SolidFolderArrowLeft extends StatelessWidget {
  ...
  /// Creates a SolidFolderArrowLeft.
  const SolidFolderArrowLeft({
    super.key,
    this.size = 24,
    this.color,
  });
