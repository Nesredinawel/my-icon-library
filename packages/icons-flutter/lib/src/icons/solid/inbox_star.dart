...
/// Solid style InboxStar icon.
///
/// Example:
/// ```dart
/// SolidInboxStar(size: 24, color: Colors.blue);
/// ```
class SolidInboxStar extends StatelessWidget {
  ...
  /// Creates a SolidInboxStar.
  const SolidInboxStar({
    super.key,
    this.size = 24,
    this.color,
  });
