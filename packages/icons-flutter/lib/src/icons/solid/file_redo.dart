...
/// Solid style FileRedo icon.
///
/// Example:
/// ```dart
/// SolidFileRedo(size: 24, color: Colors.blue);
/// ```
class SolidFileRedo extends StatelessWidget {
