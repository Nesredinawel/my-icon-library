...
/// Solid style RectanglesMixed icon.
///
/// Example:
/// ```dart
/// SolidRectanglesMixed(size: 24, color: Colors.blue);
/// ```
class SolidRectanglesMixed extends StatelessWidget {
  ...
  /// Creates a SolidRectanglesMixed.
  const SolidRectanglesMixed({
    super.key,
    this.size = 24,
    this.color,
  });
