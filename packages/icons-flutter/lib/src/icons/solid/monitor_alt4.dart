...
/// Solid style MonitorAlt4 icon.
///
/// Example:
/// ```dart
/// SolidMonitorAlt4(size: 24, color: Colors.blue);
/// ```
class SolidMonitorAlt4 extends StatelessWidget {
  ...
  /// Creates a SolidMonitorAlt4.
  const SolidMonitorAlt4({
    super.key,
    this.size = 24,
    this.color,
  });
