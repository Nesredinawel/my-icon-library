...
/// Solid style BadgeDollar icon.
///
/// Example:
/// ```dart
/// SolidBadgeDollar(size: 24, color: Colors.blue);
/// ```
class SolidBadgeDollar extends StatelessWidget {
  ...
  /// Creates a SolidBadgeDollar.
  const SolidBadgeDollar({
    super.key,
    this.size = 24,
    this.color,
  });
