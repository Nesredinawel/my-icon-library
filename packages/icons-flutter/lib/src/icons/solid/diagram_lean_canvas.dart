...
/// Solid style DiagramLeanCanvas icon.
///
/// Example:
/// ```dart
/// SolidDiagramLeanCanvas(size: 24, color: Colors.blue);
/// ```
class SolidDiagramLeanCanvas extends StatelessWidget {
  ...
  /// Creates a SolidDiagramLeanCanvas.
  const SolidDiagramLeanCanvas({
    super.key,
    this.size = 24,
    this.color,
  });
