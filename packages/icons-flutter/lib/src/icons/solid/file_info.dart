...
/// Solid style FileInfo icon.
///
/// Example:
/// ```dart
/// SolidFileInfo(size: 24, color: Colors.blue);
/// ```
class SolidFileInfo extends StatelessWidget {
