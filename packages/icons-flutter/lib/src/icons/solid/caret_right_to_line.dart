...
/// Solid style CaretRightToLine icon.
///
/// Example:
/// ```dart
/// SolidCaretRightToLine(size: 24, color: Colors.blue);
/// ```
class SolidCaretRightToLine extends StatelessWidget {
  ...
  /// Creates a SolidCaretRightToLine.
  const SolidCaretRightToLine({
    super.key,
    this.size = 24,
    this.color,
  });
