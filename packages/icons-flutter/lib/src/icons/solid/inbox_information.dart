...
/// Solid style InboxInformation icon.
///
/// Example:
/// ```dart
/// SolidInboxInformation(size: 24, color: Colors.blue);
/// ```
class SolidInboxInformation extends StatelessWidget {
  ...
  /// Creates a SolidInboxInformation.
  const SolidInboxInformation({
    super.key,
    this.size = 24,
    this.color,
  });
