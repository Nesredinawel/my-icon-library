...
/// Solid style Diamond icon.
///
/// Example:
/// ```dart
/// SolidDiamond(size: 24, color: Colors.blue);
/// ```
class SolidDiamond extends StatelessWidget {
