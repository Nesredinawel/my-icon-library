...
/// Solid style ListOl icon.
///
/// Example:
/// ```dart
/// SolidListOl(size: 24, color: Colors.blue);
/// ```
class SolidListOl extends StatelessWidget {
