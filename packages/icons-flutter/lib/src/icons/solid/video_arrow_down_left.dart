...
/// Solid style VideoArrowDownLeft icon.
///
/// Example:
/// ```dart
/// SolidVideoArrowDownLeft(size: 24, color: Colors.blue);
/// ```
class SolidVideoArrowDownLeft extends StatelessWidget {
  ...
  /// Creates a SolidVideoArrowDownLeft.
  const SolidVideoArrowDownLeft({
    super.key,
    this.size = 24,
    this.color,
  });
