...
/// Solid style TableTree icon.
///
/// Example:
/// ```dart
/// SolidTableTree(size: 24, color: Colors.blue);
/// ```
class SolidTableTree extends StatelessWidget {
  ...
  /// Creates a SolidTableTree.
  const SolidTableTree({
    super.key,
    this.size = 24,
    this.color,
  });
