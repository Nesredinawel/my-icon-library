...
/// Solid style GarageOpen icon.
///
/// Example:
/// ```dart
/// SolidGarageOpen(size: 24, color: Colors.blue);
/// ```
class SolidGarageOpen extends StatelessWidget {
  ...
  /// Creates a SolidGarageOpen.
  const SolidGarageOpen({
    super.key,
    this.size = 24,
    this.color,
  });
