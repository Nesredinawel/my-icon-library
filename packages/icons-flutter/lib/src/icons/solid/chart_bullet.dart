...
/// Solid style ChartBullet icon.
///
/// Example:
/// ```dart
/// SolidChartBullet(size: 24, color: Colors.blue);
/// ```
class SolidChartBullet extends StatelessWidget {
  ...
  /// Creates a SolidChartBullet.
  const SolidChartBullet({
    super.key,
    this.size = 24,
    this.color,
  });
