...
/// Solid style CaretLeftToLine icon.
///
/// Example:
/// ```dart
/// SolidCaretLeftToLine(size: 24, color: Colors.blue);
/// ```
class SolidCaretLeftToLine extends StatelessWidget {
  ...
  /// Creates a SolidCaretLeftToLine.
  const SolidCaretLeftToLine({
    super.key,
    this.size = 24,
    this.color,
  });
