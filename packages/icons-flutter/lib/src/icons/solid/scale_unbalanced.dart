...
/// Solid style ScaleUnbalanced icon.
///
/// Example:
/// ```dart
/// SolidScaleUnbalanced(size: 24, color: Colors.blue);
/// ```
class SolidScaleUnbalanced extends StatelessWidget {
  ...
  /// Creates a SolidScaleUnbalanced.
  const SolidScaleUnbalanced({
    super.key,
    this.size = 24,
    this.color,
  });
