...
/// Solid style Shuffle icon.
///
/// Example:
/// ```dart
/// SolidShuffle(size: 24, color: Colors.blue);
/// ```
class SolidShuffle extends StatelessWidget {
