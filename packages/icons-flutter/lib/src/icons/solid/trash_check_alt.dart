...
/// Solid style TrashCheckAlt icon.
///
/// Example:
/// ```dart
/// SolidTrashCheckAlt(size: 24, color: Colors.blue);
/// ```
class SolidTrashCheckAlt extends StatelessWidget {
  ...
  /// Creates a SolidTrashCheckAlt.
  const SolidTrashCheckAlt({
    super.key,
    this.size = 24,
    this.color,
  });
