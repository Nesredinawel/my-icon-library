...
/// Solid style InboxArrowDown icon.
///
/// Example:
/// ```dart
/// SolidInboxArrowDown(size: 24, color: Colors.blue);
/// ```
class SolidInboxArrowDown extends StatelessWidget {
  ...
  /// Creates a SolidInboxArrowDown.
  const SolidInboxArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
