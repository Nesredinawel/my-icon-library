...
/// Solid style FilePlus icon.
///
/// Example:
/// ```dart
/// SolidFilePlus(size: 24, color: Colors.blue);
/// ```
class SolidFilePlus extends StatelessWidget {
