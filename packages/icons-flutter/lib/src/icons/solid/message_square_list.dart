...
/// Solid style MessageSquareList icon.
///
/// Example:
/// ```dart
/// SolidMessageSquareList(size: 24, color: Colors.blue);
/// ```
class SolidMessageSquareList extends StatelessWidget {
  ...
  /// Creates a SolidMessageSquareList.
  const SolidMessageSquareList({
    super.key,
    this.size = 24,
    this.color,
  });
