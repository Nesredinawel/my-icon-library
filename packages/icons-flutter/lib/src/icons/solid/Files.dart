...
/// Solid style Files icon.
///
/// Example:
/// ```dart
/// SolidFiles(size: 24, color: Colors.blue);
/// ```
class SolidFiles extends StatelessWidget {
