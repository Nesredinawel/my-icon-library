...
/// Solid style ArrowSquareDownRight icon.
///
/// Example:
/// ```dart
/// SolidArrowSquareDownRight(size: 24, color: Colors.blue);
/// ```
class SolidArrowSquareDownRight extends StatelessWidget {
  ...
  /// Creates a SolidArrowSquareDownRight.
