...
/// Solid style MailOpenXmark icon.
///
/// Example:
/// ```dart
/// SolidMailOpenXmark(size: 24, color: Colors.blue);
/// ```
class SolidMailOpenXmark extends StatelessWidget {
  ...
  /// Creates a SolidMailOpenXmark.
  const SolidMailOpenXmark({
    super.key,
    this.size = 24,
    this.color,
  });
