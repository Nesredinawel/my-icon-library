...
/// Solid style MessageSquareDots icon.
///
/// Example:
/// ```dart
/// SolidMessageSquareDots(size: 24, color: Colors.blue);
/// ```
class SolidMessageSquareDots extends StatelessWidget {
  ...
  /// Creates a SolidMessageSquareDots.
  const SolidMessageSquareDots({
    super.key,
    this.size = 24,
    this.color,
  });
