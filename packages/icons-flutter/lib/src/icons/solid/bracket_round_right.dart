...
/// Solid style BracketRoundRight icon.
///
/// Example:
/// ```dart
/// SolidBracketRoundRight(size: 24, color: Colors.blue);
/// ```
class SolidBracketRoundRight extends StatelessWidget {
  ...
  /// Creates a SolidBracketRoundRight.
  const SolidBracketRoundRight({
    super.key,
    this.size = 24,
    this.color,
  });
