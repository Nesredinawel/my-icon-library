...
/// Solid style RectangleWide icon.
///
/// Example:
/// ```dart
/// SolidRectangleWide(size: 24, color: Colors.blue);
/// ```
class SolidRectangleWide extends StatelessWidget {
  ...
  /// Creates a SolidRectangleWide.
  const SolidRectangleWide({
    super.key,
    this.size = 24,
    this.color,
  });
