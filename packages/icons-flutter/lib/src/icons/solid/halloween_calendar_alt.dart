...
/// Solid style HalloweenCalendarAlt icon.
///
/// Example:
/// ```dart
/// SolidHalloweenCalendarAlt(size: 24, color: Colors.blue);
/// ```
class SolidHalloweenCalendarAlt extends StatelessWidget {
  ...
  /// Creates a SolidHalloweenCalendarAlt.
  const SolidHalloweenCalendarAlt({
    super.key,
    this.size = 24,
    this.color,
  });
