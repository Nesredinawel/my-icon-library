...
/// Solid style KeyboardAlt1 icon.
///
/// Example:
/// ```dart
/// SolidKeyboardAlt1(size: 24, color: Colors.blue);
/// ```
class SolidKeyboardAlt1 extends StatelessWidget {
  ...
  /// Creates a SolidKeyboardAlt1.
  const SolidKeyboardAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
