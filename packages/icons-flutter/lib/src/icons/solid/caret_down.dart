...
/// Solid style CaretDown icon.
///
/// Example:
/// ```dart
/// SolidCaretDown(size: 24, color: Colors.blue);
/// ```
class SolidCaretDown extends StatelessWidget {
  ...
  /// Creates a SolidCaretDown.
  const SolidCaretDown({
    super.key,
    this.size = 24,
    this.color,
  });
