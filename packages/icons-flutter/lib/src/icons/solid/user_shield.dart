...
/// Solid style UserShield icon.
///
/// Example:
/// ```dart
/// SolidUserShield(size: 24, color: Colors.blue);
/// ```
class SolidUserShield extends StatelessWidget {
  ...
  /// Creates a SolidUserShield.
  const SolidUserShield({
    super.key,
    this.size = 24,
    this.color,
  });
