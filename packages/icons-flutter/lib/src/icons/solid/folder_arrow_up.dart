...
/// Solid style FolderArrowUp icon.
///
/// Example:
/// ```dart
/// SolidFolderArrowUp(size: 24, color: Colors.blue);
/// ```
class SolidFolderArrowUp extends StatelessWidget {
  ...
  /// Creates a SolidFolderArrowUp.
  const SolidFolderArrowUp({
    super.key,
    this.size = 24,
    this.color,
  });
