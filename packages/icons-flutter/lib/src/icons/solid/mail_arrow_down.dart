...
/// Solid style MailArrowDown icon.
///
/// Example:
/// ```dart
/// SolidMailArrowDown(size: 24, color: Colors.blue);
/// ```
class SolidMailArrowDown extends StatelessWidget {
  ...
  /// Creates a SolidMailArrowDown.
  const SolidMailArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
