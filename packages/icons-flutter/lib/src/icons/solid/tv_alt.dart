...
/// Solid style TvAlt icon.
///
/// Example:
/// ```dart
/// SolidTvAlt(size: 24, color: Colors.blue);
/// ```
class SolidTvAlt extends StatelessWidget {
