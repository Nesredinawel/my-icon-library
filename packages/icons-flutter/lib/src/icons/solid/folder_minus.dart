...
/// Solid style FolderMinus icon.
///
/// Example:
/// ```dart
/// SolidFolderMinus(size: 24, color: Colors.blue);
/// ```
class SolidFolderMinus extends StatelessWidget {
  ...
  /// Creates a SolidFolderMinus.
  const SolidFolderMinus({
    super.key,
    this.size = 24,
    this.color,
  });
