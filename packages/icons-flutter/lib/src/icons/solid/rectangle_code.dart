...
/// Solid style RectangleCode icon.
///
/// Example:
/// ```dart
/// SolidRectangleCode(size: 24, color: Colors.blue);
/// ```
class SolidRectangleCode extends StatelessWidget {
  ...
  /// Creates a SolidRectangleCode.
  const SolidRectangleCode({
    super.key,
    this.size = 24,
    this.color,
  });
