...
/// Solid style MailOpenMinus icon.
///
/// Example:
/// ```dart
/// SolidMailOpenMinus(size: 24, color: Colors.blue);
/// ```
class SolidMailOpenMinus extends StatelessWidget {
  ...
  /// Creates a SolidMailOpenMinus.
  const SolidMailOpenMinus({
    super.key,
    this.size = 24,
    this.color,
  });
