...
/// Solid style SquareH icon.
///
/// Example:
/// ```dart
/// SolidSquareH(size: 24, color: Colors.blue);
/// ```
class SolidSquareH extends StatelessWidget {
