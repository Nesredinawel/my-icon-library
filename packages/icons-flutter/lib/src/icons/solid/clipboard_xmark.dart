...
/// Solid style ClipboardXmark icon.
///
/// Example:
/// ```dart
/// SolidClipboardXmark(size: 24, color: Colors.blue);
/// ```
class SolidClipboardXmark extends StatelessWidget {
  ...
  /// Creates a SolidClipboardXmark.
  const SolidClipboardXmark({
    super.key,
    this.size = 24,
    this.color,
  });
