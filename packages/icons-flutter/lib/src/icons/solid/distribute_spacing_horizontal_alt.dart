...
/// Solid style DistributeSpacingHorizontalAlt icon.
///
/// Example:
/// ```dart
/// SolidDistributeSpacingHorizontalAlt(size: 24, color: Colors.blue);
/// ```
class SolidDistributeSpacingHorizontalAlt extends StatelessWidget {
  ...
  /// Creates a SolidDistributeSpacingHorizontalAlt.
