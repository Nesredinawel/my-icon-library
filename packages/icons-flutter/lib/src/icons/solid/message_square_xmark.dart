...
/// Solid style MessageSquareXmark icon.
///
/// Example:
/// ```dart
/// SolidMessageSquareXmark(size: 24, color: Colors.blue);
/// ```
class SolidMessageSquareXmark extends StatelessWidget {
  ...
  /// Creates a SolidMessageSquareXmark.
  const SolidMessageSquareXmark({
    super.key,
    this.size = 24,
    this.color,
  });
