...
/// Solid style CalendarPen icon.
///
/// Example:
/// ```dart
/// SolidCalendarPen(size: 24, color: Colors.blue);
/// ```
class SolidCalendarPen extends StatelessWidget {
  ...
  /// Creates a SolidCalendarPen.
  const SolidCalendarPen({
    super.key,
    this.size = 24,
    this.color,
  });
