...
/// Solid style SquareALock icon.
///
/// Example:
/// ```dart
/// SolidSquareALock(size: 24, color: Colors.blue);
/// ```
class SolidSquareALock extends StatelessWidget {
  ...
  /// Creates a SolidSquareALock.
  const SolidSquareALock({
    super.key,
    this.size = 24,
    this.color,
  });
