...
/// Solid style InboxXmark icon.
///
/// Example:
/// ```dart
/// SolidInboxXmark(size: 24, color: Colors.blue);
/// ```
class SolidInboxXmark extends StatelessWidget {
  ...
  /// Creates a SolidInboxXmark.
  const SolidInboxXmark({
    super.key,
    this.size = 24,
    this.color,
  });
