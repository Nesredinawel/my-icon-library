...
/// Solid style ClipboardText icon.
///
/// Example:
/// ```dart
/// SolidClipboardText(size: 24, color: Colors.blue);
/// ```
class SolidClipboardText extends StatelessWidget {
  ...
  /// Creates a SolidClipboardText.
  const SolidClipboardText({
    super.key,
    this.size = 24,
    this.color,
  });
