...
/// Solid style ClipboardAttachment icon.
///
/// Example:
/// ```dart
/// SolidClipboardAttachment(size: 24, color: Colors.blue);
/// ```
class SolidClipboardAttachment extends StatelessWidget {
  ...
  /// Creates a SolidClipboardAttachment.
  const SolidClipboardAttachment({
    super.key,
    this.size = 24,
    this.color,
  });
