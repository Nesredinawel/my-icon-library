...
/// Solid style BriefcaseDollar icon.
///
/// Example:
/// ```dart
/// SolidBriefcaseDollar(size: 24, color: Colors.blue);
/// ```
class SolidBriefcaseDollar extends StatelessWidget {
  ...
  /// Creates a SolidBriefcaseDollar.
  const SolidBriefcaseDollar({
    super.key,
    this.size = 24,
    this.color,
  });
