...
/// Solid style CartCheck icon.
///
/// Example:
/// ```dart
/// SolidCartCheck(size: 24, color: Colors.blue);
/// ```
class SolidCartCheck extends StatelessWidget {
  ...
  /// Creates a SolidCartCheck.
  const SolidCartCheck({
    super.key,
    this.size = 24,
    this.color,
  });
