...
/// Solid style CalendarXmark icon.
///
/// Example:
/// ```dart
/// SolidCalendarXmark(size: 24, color: Colors.blue);
/// ```
class SolidCalendarXmark extends StatelessWidget {
  ...
  /// Creates a SolidCalendarXmark.
  const SolidCalendarXmark({
    super.key,
    this.size = 24,
    this.color,
  });
