...
/// Solid style FerrisWheel icon.
///
/// Example:
/// ```dart
/// SolidFerrisWheel(size: 24, color: Colors.blue);
/// ```
class SolidFerrisWheel extends StatelessWidget {
  ...
  /// Creates a SolidFerrisWheel.
  const SolidFerrisWheel({
    super.key,
    this.size = 24,
    this.color,
  });
