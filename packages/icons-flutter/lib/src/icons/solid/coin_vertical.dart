...
/// Solid style CoinVertical icon.
///
/// Example:
/// ```dart
/// SolidCoinVertical(size: 24, color: Colors.blue);
/// ```
class SolidCoinVertical extends StatelessWidget {
  ...
  /// Creates a SolidCoinVertical.
  const SolidCoinVertical({
    super.key,
    this.size = 24,
    this.color,
  });
