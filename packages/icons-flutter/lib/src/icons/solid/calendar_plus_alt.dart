...
/// Solid style CalendarPlusAlt icon.
///
/// Example:
/// ```dart
/// SolidCalendarPlusAlt(size: 24, color: Colors.blue);
/// ```
class SolidCalendarPlusAlt extends StatelessWidget {
  ...
  /// Creates a SolidCalendarPlusAlt.
  const SolidCalendarPlusAlt({
    super.key,
    this.size = 24,
    this.color,
  });
