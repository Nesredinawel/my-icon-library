...
/// Solid style HalloweenDecorations icon.
///
/// Example:
/// ```dart
/// SolidHalloweenDecorations(size: 24, color: Colors.blue);
/// ```
class SolidHalloweenDecorations extends StatelessWidget {
  ...
  /// Creates a SolidHalloweenDecorations.
  const SolidHalloweenDecorations({
    super.key,
    this.size = 24,
    this.color,
  });
