...
/// Solid style StarAlt2 icon.
///
/// Example:
/// ```dart
/// SolidStarAlt2(size: 24, color: Colors.blue);
/// ```
class SolidStarAlt2 extends StatelessWidget {
