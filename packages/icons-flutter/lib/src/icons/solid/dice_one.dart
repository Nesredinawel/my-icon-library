...
/// Solid style DiceOne icon.
///
/// Example:
/// ```dart
/// SolidDiceOne(size: 24, color: Colors.blue);
/// ```
class SolidDiceOne extends StatelessWidget {
