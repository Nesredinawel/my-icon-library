...
/// Solid style ReceiptAlt3 icon.
///
/// Example:
/// ```dart
/// SolidReceiptAlt3(size: 24, color: Colors.blue);
/// ```
class SolidReceiptAlt3 extends StatelessWidget {
  ...
  /// Creates a SolidReceiptAlt3.
  const SolidReceiptAlt3({
    super.key,
    this.size = 24,
    this.color,
  });
