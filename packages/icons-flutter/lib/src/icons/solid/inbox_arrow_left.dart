...
/// Solid style InboxArrowLeft icon.
///
/// Example:
/// ```dart
/// SolidInboxArrowLeft(size: 24, color: Colors.blue);
/// ```
class SolidInboxArrowLeft extends StatelessWidget {
  ...
  /// Creates a SolidInboxArrowLeft.
  const SolidInboxArrowLeft({
    super.key,
    this.size = 24,
    this.color,
  });
