...
/// Solid style InboxCheck icon.
///
/// Example:
/// ```dart
/// SolidInboxCheck(size: 24, color: Colors.blue);
/// ```
class SolidInboxCheck extends StatelessWidget {
  ...
  /// Creates a SolidInboxCheck.
  const SolidInboxCheck({
    super.key,
    this.size = 24,
    this.color,
  });
