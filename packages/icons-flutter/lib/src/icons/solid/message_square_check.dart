...
/// Solid style MessageSquareCheck icon.
///
/// Example:
/// ```dart
/// SolidMessageSquareCheck(size: 24, color: Colors.blue);
/// ```
class SolidMessageSquareCheck extends StatelessWidget {
  ...
  /// Creates a SolidMessageSquareCheck.
  const SolidMessageSquareCheck({
    super.key,
    this.size = 24,
    this.color,
  });
