...
/// Solid style PhoneFlip icon.
///
/// Example:
/// ```dart
/// SolidPhoneFlip(size: 24, color: Colors.blue);
/// ```
class SolidPhoneFlip extends StatelessWidget {
  ...
  /// Creates a SolidPhoneFlip.
  const SolidPhoneFlip({
    super.key,
    this.size = 24,
    this.color,
  });
