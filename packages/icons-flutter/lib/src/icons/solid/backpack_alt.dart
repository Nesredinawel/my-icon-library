...
/// Solid style BackpackAlt icon.
///
/// Example:
/// ```dart
/// SolidBackpackAlt(size: 24, color: Colors.blue);
/// ```
class SolidBackpackAlt extends StatelessWidget {
  ...
  /// Creates a SolidBackpackAlt.
  const SolidBackpackAlt({
    super.key,
    this.size = 24,
    this.color,
  });
