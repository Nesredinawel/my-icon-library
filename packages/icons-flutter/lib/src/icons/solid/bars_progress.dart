...
/// Solid style BarsProgress icon.
///
/// Example:
/// ```dart
/// SolidBarsProgress(size: 24, color: Colors.blue);
/// ```
class SolidBarsProgress extends StatelessWidget {
  ...
  /// Creates a SolidBarsProgress.
  const SolidBarsProgress({
    super.key,
    this.size = 24,
    this.color,
  });
