...
/// Solid style CalendarUser icon.
///
/// Example:
/// ```dart
/// SolidCalendarUser(size: 24, color: Colors.blue);
/// ```
class SolidCalendarUser extends StatelessWidget {
  ...
  /// Creates a SolidCalendarUser.
  const SolidCalendarUser({
    super.key,
    this.size = 24,
    this.color,
  });
