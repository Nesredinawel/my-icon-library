...
/// Solid style RectangleVertical icon.
///
/// Example:
/// ```dart
/// SolidRectangleVertical(size: 24, color: Colors.blue);
/// ```
class SolidRectangleVertical extends StatelessWidget {
  ...
  /// Creates a SolidRectangleVertical.
  const SolidRectangleVertical({
    super.key,
    this.size = 24,
    this.color,
  });
