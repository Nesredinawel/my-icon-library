...
/// Solid style MonitorAlt1 icon.
///
/// Example:
/// ```dart
/// SolidMonitorAlt1(size: 24, color: Colors.blue);
/// ```
class SolidMonitorAlt1 extends StatelessWidget {
  ...
  /// Creates a SolidMonitorAlt1.
  const SolidMonitorAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
