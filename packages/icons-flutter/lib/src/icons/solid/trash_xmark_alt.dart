...
/// Solid style TrashXmarkAlt icon.
///
/// Example:
/// ```dart
/// SolidTrashXmarkAlt(size: 24, color: Colors.blue);
/// ```
class SolidTrashXmarkAlt extends StatelessWidget {
  ...
  /// Creates a SolidTrashXmarkAlt.
  const SolidTrashXmarkAlt({
    super.key,
    this.size = 24,
    this.color,
  });
