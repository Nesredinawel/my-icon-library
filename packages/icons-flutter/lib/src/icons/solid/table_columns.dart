...
/// Solid style TableColumns icon.
///
/// Example:
/// ```dart
/// SolidTableColumns(size: 24, color: Colors.blue);
/// ```
class SolidTableColumns extends StatelessWidget {
  ...
  /// Creates a SolidTableColumns.
  const SolidTableColumns({
    super.key,
    this.size = 24,
    this.color,
  });
