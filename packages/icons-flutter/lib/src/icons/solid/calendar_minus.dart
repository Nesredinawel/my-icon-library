...
/// Solid style CalendarMinus icon.
///
/// Example:
/// ```dart
/// SolidCalendarMinus(size: 24, color: Colors.blue);
/// ```
class SolidCalendarMinus extends StatelessWidget {
