...
/// Solid style SnowAlt icon.
///
/// Example:
/// ```dart
/// SolidSnowAlt(size: 24, color: Colors.blue);
/// ```
class SolidSnowAlt extends StatelessWidget {
