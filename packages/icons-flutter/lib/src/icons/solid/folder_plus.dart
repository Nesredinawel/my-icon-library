...
/// Solid style FolderPlus icon.
///
/// Example:
/// ```dart
/// SolidFolderPlus(size: 24, color: Colors.blue);
/// ```
class SolidFolderPlus extends StatelessWidget {
  ...
  /// Creates a SolidFolderPlus.
  const SolidFolderPlus({
    super.key,
    this.size = 24,
    this.color,
  });
