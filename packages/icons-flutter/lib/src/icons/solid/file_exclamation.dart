...
/// Solid style FileExclamation icon.
///
/// Example:
/// ```dart
/// SolidFileExclamation(size: 24, color: Colors.blue);
/// ```
class SolidFileExclamation extends StatelessWidget {
  ...
  /// Creates a SolidFileExclamation.
  const SolidFileExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
