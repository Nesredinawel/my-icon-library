...
/// Solid style InboxArrowRight icon.
///
/// Example:
/// ```dart
/// SolidInboxArrowRight(size: 24, color: Colors.blue);
/// ```
class SolidInboxArrowRight extends StatelessWidget {
  ...
  /// Creates a SolidInboxArrowRight.
  const SolidInboxArrowRight({
    super.key,
    this.size = 24,
    this.color,
  });
