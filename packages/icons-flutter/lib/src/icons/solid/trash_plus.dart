...
/// Solid style TrashPlus icon.
///
/// Example:
/// ```dart
/// SolidTrashPlus(size: 24, color: Colors.blue);
/// ```
class SolidTrashPlus extends StatelessWidget {
  ...
  /// Creates a SolidTrashPlus.
  const SolidTrashPlus({
    super.key,
    this.size = 24,
    this.color,
  });
