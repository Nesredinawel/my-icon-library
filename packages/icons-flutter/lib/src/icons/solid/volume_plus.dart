...
/// Solid style VolumePlus icon.
///
/// Example:
/// ```dart
/// SolidVolumePlus(size: 24, color: Colors.blue);
/// ```
class SolidVolumePlus extends StatelessWidget {
  ...
  /// Creates a SolidVolumePlus.
  const SolidVolumePlus({
    super.key,
    this.size = 24,
    this.color,
  });
