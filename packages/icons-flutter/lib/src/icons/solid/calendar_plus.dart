...
/// Solid style CalendarPlus icon.
///
/// Example:
/// ```dart
/// SolidCalendarPlus(size: 24, color: Colors.blue);
/// ```
class SolidCalendarPlus extends StatelessWidget {
  ...
  /// Creates a SolidCalendarPlus.
  const SolidCalendarPlus({
    super.key,
    this.size = 24,
    this.color,
  });
