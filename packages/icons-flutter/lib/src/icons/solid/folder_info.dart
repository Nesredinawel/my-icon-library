...
/// Solid style FolderInfo icon.
///
/// Example:
/// ```dart
/// SolidFolderInfo(size: 24, color: Colors.blue);
/// ```
class SolidFolderInfo extends StatelessWidget {
  ...
  /// Creates a SolidFolderInfo.
  const SolidFolderInfo({
    super.key,
    this.size = 24,
    this.color,
  });
