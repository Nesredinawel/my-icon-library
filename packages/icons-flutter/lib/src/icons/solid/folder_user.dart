...
/// Solid style FolderUser icon.
///
/// Example:
/// ```dart
/// SolidFolderUser(size: 24, color: Colors.blue);
/// ```
class SolidFolderUser extends StatelessWidget {
  ...
  /// Creates a SolidFolderUser.
  const SolidFolderUser({
    super.key,
    this.size = 24,
    this.color,
  });
