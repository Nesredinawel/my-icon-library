...
/// Solid style VirusCovid19 icon.
///
/// Example:
/// ```dart
/// SolidVirusCovid19(size: 24, color: Colors.blue);
/// ```
class SolidVirusCovid19 extends StatelessWidget {
  ...
  /// Creates a SolidVirusCovid19.
  const SolidVirusCovid19({
    super.key,
    this.size = 24,
    this.color,
  });
