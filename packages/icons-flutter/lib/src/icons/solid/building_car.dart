...
/// Solid style BuildingCar icon.
///
/// Example:
/// ```dart
/// SolidBuildingCar(size: 24, color: Colors.blue);
/// ```
class SolidBuildingCar extends StatelessWidget {
  ...
  /// Creates a SolidBuildingCar.
  const SolidBuildingCar({
    super.key,
    this.size = 24,
    this.color,
  });
