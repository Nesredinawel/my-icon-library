...
/// Solid style ClipboardArrowUp icon.
///
/// Example:
/// ```dart
/// SolidClipboardArrowUp(size: 24, color: Colors.blue);
/// ```
class SolidClipboardArrowUp extends StatelessWidget {
  ...
  /// Creates a SolidClipboardArrowUp.
  const SolidClipboardArrowUp({
    super.key,
    this.size = 24,
    this.color,
  });
