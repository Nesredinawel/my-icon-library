...
/// Solid style CaretLeft icon.
///
/// Example:
/// ```dart
/// SolidCaretLeft(size: 24, color: Colors.blue);
/// ```
class SolidCaretLeft extends StatelessWidget {
  ...
  /// Creates a SolidCaretLeft.
  const SolidCaretLeft({
    super.key,
    this.size = 24,
    this.color,
  });
