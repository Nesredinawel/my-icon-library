...
/// Duotone style FileChartColumn icon.
///
/// Example:
/// ```dart
/// DuotoneFileChartColumn(size: 24, color: Colors.blue);
/// ```
class DuotoneFileChartColumn extends StatelessWidget {
  ...
  /// Creates a DuotoneFileChartColumn.
  const DuotoneFileChartColumn({
    super.key,
    this.size = 24,
    this.color,
  });
