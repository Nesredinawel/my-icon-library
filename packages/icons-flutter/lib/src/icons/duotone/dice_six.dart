...
/// Duotone style DiceSix icon.
///
/// Example:
/// ```dart
/// DuotoneDiceSix(size: 24, color: Colors.blue);
/// ```
class DuotoneDiceSix extends StatelessWidget {
  ...
  /// Creates a DuotoneDiceSix.
  const DuotoneDiceSix({
    super.key,
    this.size = 24,
    this.color,
  });
