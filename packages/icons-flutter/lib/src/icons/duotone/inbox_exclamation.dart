...
/// Duotone style InboxExclamation icon.
///
/// Example:
/// ```dart
/// DuotoneInboxExclamation(size: 24, color: Colors.blue);
/// ```
class DuotoneInboxExclamation extends StatelessWidget {
  ...
  /// Creates a DuotoneInboxExclamation.
  const DuotoneInboxExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
