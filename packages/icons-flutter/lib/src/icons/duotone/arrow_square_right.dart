...
/// Duotone style ArrowSquareRight icon.
///
/// Example:
/// ```dart
/// DuotoneArrowSquareRight(size: 24, color: Colors.blue);
/// ```
class DuotoneArrowSquareRight extends StatelessWidget {
  ...
  /// Creates a DuotoneArrowSquareRight.
  const DuotoneArrowSquareRight({
    super.key,
    this.size = 24,
    this.color,
  });
