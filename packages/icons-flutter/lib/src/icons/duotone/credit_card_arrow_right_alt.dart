...
/// Duotone style CreditCardArrowRightAlt icon.
///
/// Example:
/// ```dart
/// DuotoneCreditCardArrowRightAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneCreditCardArrowRightAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneCreditCardArrowRightAlt.
  const DuotoneCreditCardArrowRightAlt({
    super.key,
    this.size = 24,
    this.color,
  });
