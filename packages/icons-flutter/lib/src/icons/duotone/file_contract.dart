...
/// Duotone style FileContract icon.
///
/// Example:
/// ```dart
/// DuotoneFileContract(size: 24, color: Colors.blue);
/// ```
class DuotoneFileContract extends StatelessWidget {
  ...
  /// Creates a DuotoneFileContract.
  const DuotoneFileContract({
    super.key,
    this.size = 24,
    this.color,
  });
