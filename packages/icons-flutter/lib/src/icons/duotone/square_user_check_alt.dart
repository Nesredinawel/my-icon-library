...
/// Duotone style SquareUserCheckAlt icon.
///
/// Example:
/// ```dart
/// DuotoneSquareUserCheckAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareUserCheckAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareUserCheckAlt.
  const DuotoneSquareUserCheckAlt({
    super.key,
    this.size = 24,
    this.color,
  });
