...
/// Duotone style CreditCardPlus icon.
///
/// Example:
/// ```dart
/// DuotoneCreditCardPlus(size: 24, color: Colors.blue);
/// ```
class DuotoneCreditCardPlus extends StatelessWidget {
  ...
  /// Creates a DuotoneCreditCardPlus.
  const DuotoneCreditCardPlus({
    super.key,
    this.size = 24,
    this.color,
  });
