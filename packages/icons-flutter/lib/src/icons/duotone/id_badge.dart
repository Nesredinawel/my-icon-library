...
/// Duotone style IdBadge icon.
///
/// Example:
/// ```dart
/// DuotoneIdBadge(size: 24, color: Colors.blue);
/// ```
class DuotoneIdBadge extends StatelessWidget {
  ...
  /// Creates a DuotoneIdBadge.
  const DuotoneIdBadge({
    super.key,
    this.size = 24,
    this.color,
  });
