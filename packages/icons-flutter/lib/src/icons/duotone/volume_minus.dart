...
/// Duotone style VolumeMinus icon.
///
/// Example:
/// ```dart
/// DuotoneVolumeMinus(size: 24, color: Colors.blue);
/// ```
class DuotoneVolumeMinus extends StatelessWidget {
  ...
  /// Creates a DuotoneVolumeMinus.
  const DuotoneVolumeMinus({
    super.key,
    this.size = 24,
    this.color,
  });
