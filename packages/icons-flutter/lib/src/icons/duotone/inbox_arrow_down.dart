...
/// Duotone style InboxArrowDown icon.
///
/// Example:
/// ```dart
/// DuotoneInboxArrowDown(size: 24, color: Colors.blue);
/// ```
class DuotoneInboxArrowDown extends StatelessWidget {
  ...
  /// Creates a DuotoneInboxArrowDown.
  const DuotoneInboxArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
