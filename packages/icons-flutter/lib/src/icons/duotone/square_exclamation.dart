...
/// Duotone style SquareExclamation icon.
///
/// Example:
/// ```dart
/// DuotoneSquareExclamation(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareExclamation extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareExclamation.
  const DuotoneSquareExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
