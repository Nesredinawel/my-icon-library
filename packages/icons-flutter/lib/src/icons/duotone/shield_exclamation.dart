...
/// Duotone style ShieldExclamation icon.
///
/// Example:
/// ```dart
/// DuotoneShieldExclamation(size: 24, color: Colors.blue);
/// ```
class DuotoneShieldExclamation extends StatelessWidget {
  ...
  /// Creates a DuotoneShieldExclamation.
  const DuotoneShieldExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
