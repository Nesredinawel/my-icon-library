...
/// Duotone style BriefcaseAlt2 icon.
///
/// Example:
/// ```dart
/// DuotoneBriefcaseAlt2(size: 24, color: Colors.blue);
/// ```
class DuotoneBriefcaseAlt2 extends StatelessWidget {
  ...
  /// Creates a DuotoneBriefcaseAlt2.
  const DuotoneBriefcaseAlt2({
    super.key,
    this.size = 24,
    this.color,
  });
