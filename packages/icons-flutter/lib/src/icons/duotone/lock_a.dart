...
/// Duotone style LockA icon.
///
/// Example:
/// ```dart
/// DuotoneLockA(size: 24, color: Colors.blue);
/// ```
class DuotoneLockA extends StatelessWidget {
