...
/// Duotone style IdCardClip icon.
///
/// Example:
/// ```dart
/// DuotoneIdCardClip(size: 24, color: Colors.blue);
/// ```
class DuotoneIdCardClip extends StatelessWidget {
  ...
  /// Creates a DuotoneIdCardClip.
  const DuotoneIdCardClip({
    super.key,
    this.size = 24,
    this.color,
  });
