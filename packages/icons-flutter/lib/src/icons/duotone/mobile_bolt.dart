...
/// Duotone style MobileBolt icon.
///
/// Example:
/// ```dart
/// DuotoneMobileBolt(size: 24, color: Colors.blue);
/// ```
class DuotoneMobileBolt extends StatelessWidget {
  ...
  /// Creates a DuotoneMobileBolt.
  const DuotoneMobileBolt({
    super.key,
    this.size = 24,
    this.color,
  });
