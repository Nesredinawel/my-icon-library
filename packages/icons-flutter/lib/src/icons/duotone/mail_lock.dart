...
/// Duotone style MailLock icon.
///
/// Example:
/// ```dart
/// DuotoneMailLock(size: 24, color: Colors.blue);
/// ```
class DuotoneMailLock extends StatelessWidget {
  ...
  /// Creates a DuotoneMailLock.
  const DuotoneMailLock({
    super.key,
    this.size = 24,
    this.color,
  });
