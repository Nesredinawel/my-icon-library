...
/// Duotone style WalletPlus icon.
///
/// Example:
/// ```dart
/// DuotoneWalletPlus(size: 24, color: Colors.blue);
/// ```
class DuotoneWalletPlus extends StatelessWidget {
  ...
  /// Creates a DuotoneWalletPlus.
  const DuotoneWalletPlus({
    super.key,
    this.size = 24,
    this.color,
  });
