...
/// Duotone style LocationXmark icon.
///
/// Example:
/// ```dart
/// DuotoneLocationXmark(size: 24, color: Colors.blue);
/// ```
class DuotoneLocationXmark extends StatelessWidget {
  ...
  /// Creates a DuotoneLocationXmark.
  const DuotoneLocationXmark({
    super.key,
    this.size = 24,
    this.color,
  });
