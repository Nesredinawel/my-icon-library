...
/// Duotone style PhoneOffice icon.
///
/// Example:
/// ```dart
/// DuotonePhoneOffice(size: 24, color: Colors.blue);
/// ```
class DuotonePhoneOffice extends StatelessWidget {
  ...
  /// Creates a DuotonePhoneOffice.
  const DuotonePhoneOffice({
    super.key,
    this.size = 24,
    this.color,
  });
