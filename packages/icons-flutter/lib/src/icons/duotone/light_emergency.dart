...
/// Duotone style LightEmergency icon.
///
/// Example:
/// ```dart
/// DuotoneLightEmergency(size: 24, color: Colors.blue);
/// ```
class DuotoneLightEmergency extends StatelessWidget {
  ...
  /// Creates a DuotoneLightEmergency.
  const DuotoneLightEmergency({
    super.key,
    this.size = 24,
    this.color,
  });
