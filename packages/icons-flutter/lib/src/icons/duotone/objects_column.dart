...
/// Duotone style ObjectsColumn icon.
///
/// Example:
/// ```dart
/// DuotoneObjectsColumn(size: 24, color: Colors.blue);
/// ```
class DuotoneObjectsColumn extends StatelessWidget {
  ...
  /// Creates a DuotoneObjectsColumn.
  const DuotoneObjectsColumn({
    super.key,
    this.size = 24,
    this.color,
  });
