...
/// Duotone style PenNibSlash icon.
///
/// Example:
/// ```dart
/// DuotonePenNibSlash(size: 24, color: Colors.blue);
/// ```
class DuotonePenNibSlash extends StatelessWidget {
  ...
  /// Creates a DuotonePenNibSlash.
  const DuotonePenNibSlash({
    super.key,
    this.size = 24,
    this.color,
  });
