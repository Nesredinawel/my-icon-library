...
/// Duotone style RectangleCode icon.
///
/// Example:
/// ```dart
/// DuotoneRectangleCode(size: 24, color: Colors.blue);
/// ```
class DuotoneRectangleCode extends StatelessWidget {
  ...
  /// Creates a DuotoneRectangleCode.
  const DuotoneRectangleCode({
    super.key,
    this.size = 24,
    this.color,
  });
