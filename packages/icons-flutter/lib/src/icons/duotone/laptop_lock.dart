...
/// Duotone style LaptopLock icon.
///
/// Example:
/// ```dart
/// DuotoneLaptopLock(size: 24, color: Colors.blue);
/// ```
class DuotoneLaptopLock extends StatelessWidget {
  ...
  /// Creates a DuotoneLaptopLock.
  const DuotoneLaptopLock({
    super.key,
    this.size = 24,
    this.color,
  });
