...
/// Duotone style MessageSquareHeart icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareHeart(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareHeart extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareHeart.
  const DuotoneMessageSquareHeart({
    super.key,
    this.size = 24,
    this.color,
  });
