...
/// Duotone style MailXmark icon.
///
/// Example:
/// ```dart
/// DuotoneMailXmark(size: 24, color: Colors.blue);
/// ```
class DuotoneMailXmark extends StatelessWidget {
  ...
  /// Creates a DuotoneMailXmark.
  const DuotoneMailXmark({
    super.key,
    this.size = 24,
    this.color,
  });
