...
/// Duotone style SquareRing icon.
///
/// Example:
/// ```dart
/// DuotoneSquareRing(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareRing extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareRing.
  const DuotoneSquareRing({
    super.key,
    this.size = 24,
    this.color,
  });
