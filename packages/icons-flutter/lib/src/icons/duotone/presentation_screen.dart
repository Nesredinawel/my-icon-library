...
/// Duotone style PresentationScreen icon.
///
/// Example:
/// ```dart
/// DuotonePresentationScreen(size: 24, color: Colors.blue);
/// ```
class DuotonePresentationScreen extends StatelessWidget {
  ...
  /// Creates a DuotonePresentationScreen.
  const DuotonePresentationScreen({
    super.key,
    this.size = 24,
    this.color,
  });
