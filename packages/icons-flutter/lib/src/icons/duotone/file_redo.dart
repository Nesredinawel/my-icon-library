...
/// Duotone style FileRedo icon.
///
/// Example:
/// ```dart
/// DuotoneFileRedo(size: 24, color: Colors.blue);
/// ```
class DuotoneFileRedo extends StatelessWidget {
  ...
  /// Creates a DuotoneFileRedo.
  const DuotoneFileRedo({
    super.key,
    this.size = 24,
    this.color,
  });
