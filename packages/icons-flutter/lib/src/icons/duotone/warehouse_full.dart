...
/// Duotone style WarehouseFull icon.
///
/// Example:
/// ```dart
/// DuotoneWarehouseFull(size: 24, color: Colors.blue);
/// ```
class DuotoneWarehouseFull extends StatelessWidget {
  ...
  /// Creates a DuotoneWarehouseFull.
  const DuotoneWarehouseFull({
    super.key,
    this.size = 24,
    this.color,
  });
