...
/// Duotone style FolderHeart icon.
///
/// Example:
/// ```dart
/// DuotoneFolderHeart(size: 24, color: Colors.blue);
/// ```
class DuotoneFolderHeart extends StatelessWidget {
  ...
  /// Creates a DuotoneFolderHeart.
  const DuotoneFolderHeart({
    super.key,
    this.size = 24,
    this.color,
  });
