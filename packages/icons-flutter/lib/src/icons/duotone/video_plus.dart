...
/// Duotone style VideoPlus icon.
///
/// Example:
/// ```dart
/// DuotoneVideoPlus(size: 24, color: Colors.blue);
/// ```
class DuotoneVideoPlus extends StatelessWidget {
  ...
  /// Creates a DuotoneVideoPlus.
  const DuotoneVideoPlus({
    super.key,
    this.size = 24,
    this.color,
  });
