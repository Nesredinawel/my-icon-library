...
/// Duotone style UnlockAlt icon.
///
/// Example:
/// ```dart
/// DuotoneUnlockAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneUnlockAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneUnlockAlt.
  const DuotoneUnlockAlt({
    super.key,
    this.size = 24,
    this.color,
  });
