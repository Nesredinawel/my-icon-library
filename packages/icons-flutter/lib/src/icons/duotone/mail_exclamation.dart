...
/// Duotone style MailExclamation icon.
///
/// Example:
/// ```dart
/// DuotoneMailExclamation(size: 24, color: Colors.blue);
/// ```
class DuotoneMailExclamation extends StatelessWidget {
  ...
  /// Creates a DuotoneMailExclamation.
  const DuotoneMailExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
