...
/// Duotone style TableRows icon.
///
/// Example:
/// ```dart
/// DuotoneTableRows(size: 24, color: Colors.blue);
/// ```
class DuotoneTableRows extends StatelessWidget {
  ...
  /// Creates a DuotoneTableRows.
  const DuotoneTableRows({
    super.key,
    this.size = 24,
    this.color,
  });
