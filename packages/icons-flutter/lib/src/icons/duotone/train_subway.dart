...
/// Duotone style TrainSubway icon.
///
/// Example:
/// ```dart
/// DuotoneTrainSubway(size: 24, color: Colors.blue);
/// ```
class DuotoneTrainSubway extends StatelessWidget {
  ...
  /// Creates a DuotoneTrainSubway.
  const DuotoneTrainSubway({
    super.key,
    this.size = 24,
    this.color,
  });
