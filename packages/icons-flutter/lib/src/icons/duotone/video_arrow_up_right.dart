...
/// Duotone style VideoArrowUpRight icon.
///
/// Example:
/// ```dart
/// DuotoneVideoArrowUpRight(size: 24, color: Colors.blue);
/// ```
class DuotoneVideoArrowUpRight extends StatelessWidget {
  ...
  /// Creates a DuotoneVideoArrowUpRight.
  const DuotoneVideoArrowUpRight({
    super.key,
    this.size = 24,
    this.color,
  });
