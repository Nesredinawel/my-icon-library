...
/// Duotone style MonitorAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneMonitorAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneMonitorAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneMonitorAlt1.
  const DuotoneMonitorAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
