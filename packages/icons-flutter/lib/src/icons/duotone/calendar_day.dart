...
/// Duotone style CalendarDay icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarDay(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarDay extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarDay.
  const DuotoneCalendarDay({
    super.key,
    this.size = 24,
    this.color,
  });
