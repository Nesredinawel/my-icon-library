...
/// Duotone style ToiletPaperDots icon.
///
/// Example:
/// ```dart
/// DuotoneToiletPaperDots(size: 24, color: Colors.blue);
/// ```
class DuotoneToiletPaperDots extends StatelessWidget {
  ...
  /// Creates a DuotoneToiletPaperDots.
  const DuotoneToiletPaperDots({
    super.key,
    this.size = 24,
    this.color,
  });
