...
/// Duotone style ObjectsAlignCenterHorizontal icon.
///
/// Example:
/// ```dart
/// DuotoneObjectsAlignCenterHorizontal(size: 24, color: Colors.blue);
/// ```
class DuotoneObjectsAlignCenterHorizontal extends StatelessWidget {
  ...
  /// Creates a DuotoneObjectsAlignCenterHorizontal.
  const DuotoneObjectsAlignCenterHorizontal({
    super.key,
    this.size = 24,
    this.color,
  });
