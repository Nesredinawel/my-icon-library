...
/// Duotone style FileSearchAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileSearchAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileSearchAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileSearchAlt.
  const DuotoneFileSearchAlt({
    super.key,
    this.size = 24,
    this.color,
  });
