...
/// Duotone style InboxCheck icon.
///
/// Example:
/// ```dart
/// DuotoneInboxCheck(size: 24, color: Colors.blue);
/// ```
class DuotoneInboxCheck extends StatelessWidget {
  ...
  /// Creates a DuotoneInboxCheck.
  const DuotoneInboxCheck({
    super.key,
    this.size = 24,
    this.color,
  });
