...
/// Duotone style FileInfo icon.
///
/// Example:
/// ```dart
/// DuotoneFileInfo(size: 24, color: Colors.blue);
/// ```
class DuotoneFileInfo extends StatelessWidget {
  ...
  /// Creates a DuotoneFileInfo.
  const DuotoneFileInfo({
    super.key,
    this.size = 24,
    this.color,
  });
