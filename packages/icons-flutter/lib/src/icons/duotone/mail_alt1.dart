...
/// Duotone style MailAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneMailAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneMailAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneMailAlt1.
  const DuotoneMailAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
