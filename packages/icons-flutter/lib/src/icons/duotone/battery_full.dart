...
/// Duotone style BatteryFull icon.
///
/// Example:
/// ```dart
/// DuotoneBatteryFull(size: 24, color: Colors.blue);
/// ```
class DuotoneBatteryFull extends StatelessWidget {
  ...
  /// Creates a DuotoneBatteryFull.
  const DuotoneBatteryFull({
    super.key,
    this.size = 24,
    this.color,
  });
