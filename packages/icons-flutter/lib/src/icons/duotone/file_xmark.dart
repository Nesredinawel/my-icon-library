...
/// Duotone style FileXmark icon.
///
/// Example:
/// ```dart
/// DuotoneFileXmark(size: 24, color: Colors.blue);
/// ```
class DuotoneFileXmark extends StatelessWidget {
  ...
  /// Creates a DuotoneFileXmark.
  const DuotoneFileXmark({
    super.key,
    this.size = 24,
    this.color,
  });
