...
/// Duotone style CalendarExclamationAlt icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarExclamationAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarExclamationAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarExclamationAlt.
  const DuotoneCalendarExclamationAlt({
    super.key,
    this.size = 24,
    this.color,
  });
