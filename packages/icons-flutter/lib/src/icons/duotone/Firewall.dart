...
/// Duotone style Firewall icon.
///
/// Example:
/// ```dart
/// DuotoneFirewall(size: 24, color: Colors.blue);
/// ```
class DuotoneFirewall extends StatelessWidget {
  ...
  /// Creates a DuotoneFirewall.
  const DuotoneFirewall({
    super.key,
    this.size = 24,
    this.color,
  });
