...
/// Duotone style InboxMinus icon.
///
/// Example:
/// ```dart
/// DuotoneInboxMinus(size: 24, color: Colors.blue);
/// ```
class DuotoneInboxMinus extends StatelessWidget {
  ...
  /// Creates a DuotoneInboxMinus.
  const DuotoneInboxMinus({
    super.key,
    this.size = 24,
    this.color,
  });
