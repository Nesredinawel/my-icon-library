...
/// Duotone style TrashXmarkAlt icon.
///
/// Example:
/// ```dart
/// DuotoneTrashXmarkAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneTrashXmarkAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneTrashXmarkAlt.
  const DuotoneTrashXmarkAlt({
    super.key,
    this.size = 24,
    this.color,
  });
