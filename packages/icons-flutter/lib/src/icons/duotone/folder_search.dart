...
/// Duotone style FolderSearch icon.
///
/// Example:
/// ```dart
/// DuotoneFolderSearch(size: 24, color: Colors.blue);
/// ```
class DuotoneFolderSearch extends StatelessWidget {
  ...
  /// Creates a DuotoneFolderSearch.
  const DuotoneFolderSearch({
    super.key,
    this.size = 24,
    this.color,
  });
