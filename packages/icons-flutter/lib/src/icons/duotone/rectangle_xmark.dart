...
/// Duotone style RectangleXmark icon.
///
/// Example:
/// ```dart
/// DuotoneRectangleXmark(size: 24, color: Colors.blue);
/// ```
class DuotoneRectangleXmark extends StatelessWidget {
  ...
  /// Creates a DuotoneRectangleXmark.
  const DuotoneRectangleXmark({
    super.key,
    this.size = 24,
    this.color,
  });
