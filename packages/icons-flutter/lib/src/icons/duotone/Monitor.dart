...
/// Duotone style Monitor icon.
///
/// Example:
/// ```dart
/// DuotoneMonitor(size: 24, color: Colors.blue);
/// ```
class DuotoneMonitor extends StatelessWidget {
  ...
  /// Creates a DuotoneMonitor.
  const DuotoneMonitor({
    super.key,
    this.size = 24,
    this.color,
  });
