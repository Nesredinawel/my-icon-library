...
/// Duotone style InboxArrowRight icon.
///
/// Example:
/// ```dart
/// DuotoneInboxArrowRight(size: 24, color: Colors.blue);
/// ```
class DuotoneInboxArrowRight extends StatelessWidget {
  ...
  /// Creates a DuotoneInboxArrowRight.
  const DuotoneInboxArrowRight({
    super.key,
    this.size = 24,
    this.color,
  });
