...
/// Duotone style FileArrowUpAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileArrowUpAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileArrowUpAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileArrowUpAlt.
  const DuotoneFileArrowUpAlt({
    super.key,
    this.size = 24,
    this.color,
  });
