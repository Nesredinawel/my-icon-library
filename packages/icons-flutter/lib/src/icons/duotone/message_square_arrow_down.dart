...
/// Duotone style MessageSquareArrowDown icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareArrowDown(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareArrowDown extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareArrowDown.
  const DuotoneMessageSquareArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
