...
/// Duotone style DiceThree icon.
///
/// Example:
/// ```dart
/// DuotoneDiceThree(size: 24, color: Colors.blue);
/// ```
class DuotoneDiceThree extends StatelessWidget {
  ...
  /// Creates a DuotoneDiceThree.
  const DuotoneDiceThree({
    super.key,
    this.size = 24,
    this.color,
  });
