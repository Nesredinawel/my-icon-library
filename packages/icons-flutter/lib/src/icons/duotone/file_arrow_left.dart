...
/// Duotone style FileArrowLeft icon.
///
/// Example:
/// ```dart
/// DuotoneFileArrowLeft(size: 24, color: Colors.blue);
/// ```
class DuotoneFileArrowLeft extends StatelessWidget {
  ...
  /// Creates a DuotoneFileArrowLeft.
  const DuotoneFileArrowLeft({
    super.key,
    this.size = 24,
    this.color,
  });
