...
/// Duotone style FileMinusAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneFileMinusAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneFileMinusAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneFileMinusAlt1.
  const DuotoneFileMinusAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
