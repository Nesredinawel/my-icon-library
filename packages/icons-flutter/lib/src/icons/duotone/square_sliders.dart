...
/// Duotone style SquareSliders icon.
///
/// Example:
/// ```dart
/// DuotoneSquareSliders(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareSliders extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareSliders.
  const DuotoneSquareSliders({
    super.key,
    this.size = 24,
    this.color,
  });
