...
/// Duotone style FileAudio icon.
///
/// Example:
/// ```dart
/// DuotoneFileAudio(size: 24, color: Colors.blue);
/// ```
class DuotoneFileAudio extends StatelessWidget {
  ...
  /// Creates a DuotoneFileAudio.
  const DuotoneFileAudio({
    super.key,
    this.size = 24,
    this.color,
  });
