...
/// Duotone style ShieldDollar icon.
///
/// Example:
/// ```dart
/// DuotoneShieldDollar(size: 24, color: Colors.blue);
/// ```
class DuotoneShieldDollar extends StatelessWidget {
  ...
  /// Creates a DuotoneShieldDollar.
  const DuotoneShieldDollar({
    super.key,
    this.size = 24,
    this.color,
  });
