...
/// Duotone style SquarePollHorizontal icon.
///
/// Example:
/// ```dart
/// DuotoneSquarePollHorizontal(size: 24, color: Colors.blue);
/// ```
class DuotoneSquarePollHorizontal extends StatelessWidget {
  ...
  /// Creates a DuotoneSquarePollHorizontal.
  const DuotoneSquarePollHorizontal({
    super.key,
    this.size = 24,
    this.color,
  });
