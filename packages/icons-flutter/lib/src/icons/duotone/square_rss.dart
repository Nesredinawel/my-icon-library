...
/// Duotone style SquareRss icon.
///
/// Example:
/// ```dart
/// DuotoneSquareRss(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareRss extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareRss.
  const DuotoneSquareRss({
    super.key,
    this.size = 24,
    this.color,
  });
