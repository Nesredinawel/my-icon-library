...
/// Duotone style CalendarArrowDown icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarArrowDown(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarArrowDown extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarArrowDown.
  const DuotoneCalendarArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
