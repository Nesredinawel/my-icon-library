...
/// Duotone style CalendarMinus icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarMinus(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarMinus extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarMinus.
  const DuotoneCalendarMinus({
    super.key,
    this.size = 24,
    this.color,
  });
