...
/// Duotone style TableCells icon.
///
/// Example:
/// ```dart
/// DuotoneTableCells(size: 24, color: Colors.blue);
/// ```
class DuotoneTableCells extends StatelessWidget {
  ...
  /// Creates a DuotoneTableCells.
  const DuotoneTableCells({
    super.key,
    this.size = 24,
    this.color,
  });
