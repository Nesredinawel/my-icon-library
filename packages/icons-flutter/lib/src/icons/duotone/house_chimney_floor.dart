...
/// Duotone style HouseChimneyFloor icon.
///
/// Example:
/// ```dart
/// DuotoneHouseChimneyFloor(size: 24, color: Colors.blue);
/// ```
class DuotoneHouseChimneyFloor extends StatelessWidget {
  ...
  /// Creates a DuotoneHouseChimneyFloor.
  const DuotoneHouseChimneyFloor({
    super.key,
    this.size = 24,
    this.color,
  });
