...
/// Duotone style InboxInformation icon.
///
/// Example:
/// ```dart
/// DuotoneInboxInformation(size: 24, color: Colors.blue);
/// ```
class DuotoneInboxInformation extends StatelessWidget {
  ...
  /// Creates a DuotoneInboxInformation.
  const DuotoneInboxInformation({
    super.key,
    this.size = 24,
    this.color,
  });
