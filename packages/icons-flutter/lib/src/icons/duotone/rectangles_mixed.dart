...
/// Duotone style RectanglesMixed icon.
///
/// Example:
/// ```dart
/// DuotoneRectanglesMixed(size: 24, color: Colors.blue);
/// ```
class DuotoneRectanglesMixed extends StatelessWidget {
  ...
  /// Creates a DuotoneRectanglesMixed.
  const DuotoneRectanglesMixed({
    super.key,
    this.size = 24,
    this.color,
  });
