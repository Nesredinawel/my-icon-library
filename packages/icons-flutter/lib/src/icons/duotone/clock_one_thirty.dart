...
/// Duotone style ClockOneThirty icon.
///
/// Example:
/// ```dart
/// DuotoneClockOneThirty(size: 24, color: Colors.blue);
/// ```
class DuotoneClockOneThirty extends StatelessWidget {
  ...
  /// Creates a DuotoneClockOneThirty.
  const DuotoneClockOneThirty({
    super.key,
    this.size = 24,
    this.color,
  });
