...
/// Duotone style WalletMinus icon.
///
/// Example:
/// ```dart
/// DuotoneWalletMinus(size: 24, color: Colors.blue);
/// ```
class DuotoneWalletMinus extends StatelessWidget {
  ...
  /// Creates a DuotoneWalletMinus.
  const DuotoneWalletMinus({
    super.key,
    this.size = 24,
    this.color,
  });
