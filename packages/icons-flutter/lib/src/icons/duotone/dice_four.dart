...
/// Duotone style DiceFour icon.
///
/// Example:
/// ```dart
/// DuotoneDiceFour(size: 24, color: Colors.blue);
/// ```
class DuotoneDiceFour extends StatelessWidget {
  ...
  /// Creates a DuotoneDiceFour.
  const DuotoneDiceFour({
    super.key,
    this.size = 24,
    this.color,
  });
