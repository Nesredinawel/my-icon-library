...
/// Duotone style MessageSquareBlock icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareBlock(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareBlock extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareBlock.
  const DuotoneMessageSquareBlock({
    super.key,
    this.size = 24,
    this.color,
  });
