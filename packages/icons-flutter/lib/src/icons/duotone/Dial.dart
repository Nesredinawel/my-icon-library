...
/// Duotone style Dial icon.
///
/// Example:
/// ```dart
/// DuotoneDial(size: 24, color: Colors.blue);
/// ```
class DuotoneDial extends StatelessWidget {
