...
/// Duotone style ArrowSquareUpRight icon.
///
/// Example:
/// ```dart
/// DuotoneArrowSquareUpRight(size: 24, color: Colors.blue);
/// ```
class DuotoneArrowSquareUpRight extends StatelessWidget {
  ...
  /// Creates a DuotoneArrowSquareUpRight.
  const DuotoneArrowSquareUpRight({
    super.key,
    this.size = 24,
    this.color,
  });
