...
/// Duotone style SquareMinus icon.
///
/// Example:
/// ```dart
/// DuotoneSquareMinus(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareMinus extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareMinus.
  const DuotoneSquareMinus({
    super.key,
    this.size = 24,
    this.color,
  });
