...
/// Duotone style FilePlusAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFilePlusAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFilePlusAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFilePlusAlt.
  const DuotoneFilePlusAlt({
    super.key,
    this.size = 24,
    this.color,
  });
