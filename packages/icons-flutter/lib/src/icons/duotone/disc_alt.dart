...
/// Duotone style DiscAlt icon.
///
/// Example:
/// ```dart
/// DuotoneDiscAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneDiscAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneDiscAlt.
  const DuotoneDiscAlt({
    super.key,
    this.size = 24,
    this.color,
  });
