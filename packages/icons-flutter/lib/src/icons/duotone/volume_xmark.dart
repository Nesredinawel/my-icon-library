...
/// Duotone style VolumeXmark icon.
///
/// Example:
/// ```dart
/// DuotoneVolumeXmark(size: 24, color: Colors.blue);
/// ```
class DuotoneVolumeXmark extends StatelessWidget {
  ...
  /// Creates a DuotoneVolumeXmark.
  const DuotoneVolumeXmark({
    super.key,
    this.size = 24,
    this.color,
  });
