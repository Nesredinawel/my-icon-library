...
/// Duotone style InboxHeart icon.
///
/// Example:
/// ```dart
/// DuotoneInboxHeart(size: 24, color: Colors.blue);
/// ```
class DuotoneInboxHeart extends StatelessWidget {
  ...
  /// Creates a DuotoneInboxHeart.
  const DuotoneInboxHeart({
    super.key,
    this.size = 24,
    this.color,
  });
