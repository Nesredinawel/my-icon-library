...
/// Duotone style CalendarLinesAlt icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarLinesAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarLinesAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarLinesAlt.
  const DuotoneCalendarLinesAlt({
    super.key,
    this.size = 24,
    this.color,
  });
