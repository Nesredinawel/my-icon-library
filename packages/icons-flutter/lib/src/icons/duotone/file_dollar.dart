...
/// Duotone style FileDollar icon.
///
/// Example:
/// ```dart
/// DuotoneFileDollar(size: 24, color: Colors.blue);
/// ```
class DuotoneFileDollar extends StatelessWidget {
  ...
  /// Creates a DuotoneFileDollar.
  const DuotoneFileDollar({
    super.key,
    this.size = 24,
    this.color,
  });
