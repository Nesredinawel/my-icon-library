...
/// Duotone style CreditCardMinus icon.
///
/// Example:
/// ```dart
/// DuotoneCreditCardMinus(size: 24, color: Colors.blue);
/// ```
class DuotoneCreditCardMinus extends StatelessWidget {
  ...
  /// Creates a DuotoneCreditCardMinus.
  const DuotoneCreditCardMinus({
    super.key,
    this.size = 24,
    this.color,
  });
