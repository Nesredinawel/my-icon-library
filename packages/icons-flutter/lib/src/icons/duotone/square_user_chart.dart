...
/// Duotone style SquareUserChart icon.
///
/// Example:
/// ```dart
/// DuotoneSquareUserChart(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareUserChart extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareUserChart.
  const DuotoneSquareUserChart({
    super.key,
    this.size = 24,
    this.color,
  });
