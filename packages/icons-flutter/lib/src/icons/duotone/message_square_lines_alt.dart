...
/// Duotone style MessageSquareLinesAlt icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareLinesAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareLinesAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareLinesAlt.
  const DuotoneMessageSquareLinesAlt({
    super.key,
    this.size = 24,
    this.color,
  });
