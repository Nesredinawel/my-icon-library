...
/// Duotone style FileAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileAlt.
  const DuotoneFileAlt({
    super.key,
    this.size = 24,
    this.color,
  });
