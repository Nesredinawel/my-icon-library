...
/// Duotone style FileCheckAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileCheckAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileCheckAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileCheckAlt.
  const DuotoneFileCheckAlt({
    super.key,
    this.size = 24,
    this.color,
  });
