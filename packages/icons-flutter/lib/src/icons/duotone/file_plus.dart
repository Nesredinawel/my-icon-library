...
/// Duotone style FilePlus icon.
///
/// Example:
/// ```dart
/// DuotoneFilePlus(size: 24, color: Colors.blue);
/// ```
class DuotoneFilePlus extends StatelessWidget {
  ...
  /// Creates a DuotoneFilePlus.
  const DuotoneFilePlus({
    super.key,
    this.size = 24,
    this.color,
  });
