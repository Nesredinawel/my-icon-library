...
/// Duotone style MobileAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneMobileAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneMobileAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneMobileAlt1.
  const DuotoneMobileAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
