...
/// Duotone style Suitcase icon.
///
/// Example:
/// ```dart
/// DuotoneSuitcase(size: 24, color: Colors.blue);
/// ```
class DuotoneSuitcase extends StatelessWidget {
  ...
  /// Creates a DuotoneSuitcase.
  const DuotoneSuitcase({
    super.key,
    this.size = 24,
    this.color,
  });
