...
/// Duotone style MailArrowDown icon.
///
/// Example:
/// ```dart
/// DuotoneMailArrowDown(size: 24, color: Colors.blue);
/// ```
class DuotoneMailArrowDown extends StatelessWidget {
  ...
  /// Creates a DuotoneMailArrowDown.
  const DuotoneMailArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
