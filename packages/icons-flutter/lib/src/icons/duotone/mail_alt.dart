...
/// Duotone style MailAlt icon.
///
/// Example:
/// ```dart
/// DuotoneMailAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneMailAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneMailAlt.
  const DuotoneMailAlt({
    super.key,
    this.size = 24,
    this.color,
  });
