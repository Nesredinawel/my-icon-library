...
/// Duotone style MessageSquareDots icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareDots(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareDots extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareDots.
  const DuotoneMessageSquareDots({
    super.key,
    this.size = 24,
    this.color,
  });
