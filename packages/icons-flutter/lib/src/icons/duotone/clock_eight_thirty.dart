...
/// Duotone style ClockEightThirty icon.
///
/// Example:
/// ```dart
/// DuotoneClockEightThirty(size: 24, color: Colors.blue);
/// ```
class DuotoneClockEightThirty extends StatelessWidget {
  ...
  /// Creates a DuotoneClockEightThirty.
  const DuotoneClockEightThirty({
    super.key,
    this.size = 24,
    this.color,
  });
