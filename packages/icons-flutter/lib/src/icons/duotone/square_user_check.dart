...
/// Duotone style SquareUserCheck icon.
///
/// Example:
/// ```dart
/// DuotoneSquareUserCheck(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareUserCheck extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareUserCheck.
  const DuotoneSquareUserCheck({
    super.key,
    this.size = 24,
    this.color,
  });
