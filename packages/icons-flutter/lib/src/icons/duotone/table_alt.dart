...
/// Duotone style TableAlt icon.
///
/// Example:
/// ```dart
/// DuotoneTableAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneTableAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneTableAlt.
  const DuotoneTableAlt({
    super.key,
    this.size = 24,
    this.color,
  });
