...
/// Duotone style ArrowSquareDownLeft icon.
///
/// Example:
/// ```dart
/// DuotoneArrowSquareDownLeft(size: 24, color: Colors.blue);
/// ```
class DuotoneArrowSquareDownLeft extends StatelessWidget {
  ...
  /// Creates a DuotoneArrowSquareDownLeft.
  const DuotoneArrowSquareDownLeft({
    super.key,
    this.size = 24,
    this.color,
  });
