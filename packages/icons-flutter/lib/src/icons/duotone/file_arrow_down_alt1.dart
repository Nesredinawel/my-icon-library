...
/// Duotone style FileArrowDownAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneFileArrowDownAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneFileArrowDownAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneFileArrowDownAlt1.
  const DuotoneFileArrowDownAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
