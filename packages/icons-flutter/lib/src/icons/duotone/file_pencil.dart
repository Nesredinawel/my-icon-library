...
/// Duotone style FilePencil icon.
///
/// Example:
/// ```dart
/// DuotoneFilePencil(size: 24, color: Colors.blue);
/// ```
class DuotoneFilePencil extends StatelessWidget {
  ...
  /// Creates a DuotoneFilePencil.
  const DuotoneFilePencil({
    super.key,
    this.size = 24,
    this.color,
  });
