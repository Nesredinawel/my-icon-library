...
/// Duotone style PrinterAlt icon.
///
/// Example:
/// ```dart
/// DuotonePrinterAlt(size: 24, color: Colors.blue);
/// ```
class DuotonePrinterAlt extends StatelessWidget {
  ...
  /// Creates a DuotonePrinterAlt.
  const DuotonePrinterAlt({
    super.key,
    this.size = 24,
    this.color,
  });
