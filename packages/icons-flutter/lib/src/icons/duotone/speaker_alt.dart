...
/// Duotone style SpeakerAlt icon.
///
/// Example:
/// ```dart
/// DuotoneSpeakerAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneSpeakerAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneSpeakerAlt.
  const DuotoneSpeakerAlt({
    super.key,
    this.size = 24,
    this.color,
  });
