...
/// Duotone style VideoArrowDownLeft icon.
///
/// Example:
/// ```dart
/// DuotoneVideoArrowDownLeft(size: 24, color: Colors.blue);
/// ```
class DuotoneVideoArrowDownLeft extends StatelessWidget {
  ...
  /// Creates a DuotoneVideoArrowDownLeft.
  const DuotoneVideoArrowDownLeft({
    super.key,
    this.size = 24,
    this.color,
  });
