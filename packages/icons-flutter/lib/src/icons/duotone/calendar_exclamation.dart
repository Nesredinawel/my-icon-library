...
/// Duotone style CalendarExclamation icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarExclamation(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarExclamation extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarExclamation.
  const DuotoneCalendarExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
