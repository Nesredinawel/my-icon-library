...
/// Duotone style Weight icon.
///
/// Example:
/// ```dart
/// DuotoneWeight(size: 24, color: Colors.blue);
/// ```
class DuotoneWeight extends StatelessWidget {
