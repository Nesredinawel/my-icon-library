...
/// Duotone style FileHeartAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileHeartAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileHeartAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileHeartAlt.
  const DuotoneFileHeartAlt({
    super.key,
    this.size = 24,
    this.color,
  });
