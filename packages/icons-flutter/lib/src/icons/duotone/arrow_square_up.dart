...
/// Duotone style ArrowSquareUp icon.
///
/// Example:
/// ```dart
/// DuotoneArrowSquareUp(size: 24, color: Colors.blue);
/// ```
class DuotoneArrowSquareUp extends StatelessWidget {
  ...
  /// Creates a DuotoneArrowSquareUp.
  const DuotoneArrowSquareUp({
    super.key,
    this.size = 24,
    this.color,
  });
