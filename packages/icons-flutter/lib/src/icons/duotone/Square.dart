...
/// Duotone style Square icon.
///
/// Example:
/// ```dart
/// DuotoneSquare(size: 24, color: Colors.blue);
/// ```
class DuotoneSquare extends StatelessWidget {
