...
/// Duotone style UserPlusAlt icon.
///
/// Example:
/// ```dart
/// DuotoneUserPlusAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneUserPlusAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneUserPlusAlt.
  const DuotoneUserPlusAlt({
    super.key,
    this.size = 24,
    this.color,
  });
