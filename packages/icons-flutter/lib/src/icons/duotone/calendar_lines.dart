...
/// Duotone style CalendarLines icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarLines(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarLines extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarLines.
  const DuotoneCalendarLines({
    super.key,
    this.size = 24,
    this.color,
  });
