...
/// Duotone style SquareList icon.
///
/// Example:
/// ```dart
/// DuotoneSquareList(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareList extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareList.
  const DuotoneSquareList({
    super.key,
    this.size = 24,
    this.color,
  });
