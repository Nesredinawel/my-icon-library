...
/// Duotone style SquareTerminal icon.
///
/// Example:
/// ```dart
/// DuotoneSquareTerminal(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareTerminal extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareTerminal.
  const DuotoneSquareTerminal({
    super.key,
    this.size = 24,
    this.color,
  });
