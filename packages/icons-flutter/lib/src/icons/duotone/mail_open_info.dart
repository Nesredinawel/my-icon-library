...
/// Duotone style MailOpenInfo icon.
///
/// Example:
/// ```dart
/// DuotoneMailOpenInfo(size: 24, color: Colors.blue);
/// ```
class DuotoneMailOpenInfo extends StatelessWidget {
  ...
  /// Creates a DuotoneMailOpenInfo.
  const DuotoneMailOpenInfo({
    super.key,
    this.size = 24,
    this.color,
  });
