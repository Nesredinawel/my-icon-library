...
/// Duotone style ClosedCaptioning icon.
///
/// Example:
/// ```dart
/// DuotoneClosedCaptioning(size: 24, color: Colors.blue);
/// ```
class DuotoneClosedCaptioning extends StatelessWidget {
  ...
  /// Creates a DuotoneClosedCaptioning.
  const DuotoneClosedCaptioning({
    super.key,
    this.size = 24,
    this.color,
  });
