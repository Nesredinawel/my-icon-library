...
/// Duotone style MessageSquareExclamation icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareExclamation(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareExclamation extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareExclamation.
  const DuotoneMessageSquareExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
