...
/// Duotone style ArrowSquareLeft icon.
///
/// Example:
/// ```dart
/// DuotoneArrowSquareLeft(size: 24, color: Colors.blue);
/// ```
class DuotoneArrowSquareLeft extends StatelessWidget {
  ...
  /// Creates a DuotoneArrowSquareLeft.
  const DuotoneArrowSquareLeft({
    super.key,
    this.size = 24,
    this.color,
  });
