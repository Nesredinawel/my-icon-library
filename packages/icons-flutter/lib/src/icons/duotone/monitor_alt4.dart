...
/// Duotone style MonitorAlt4 icon.
///
/// Example:
/// ```dart
/// DuotoneMonitorAlt4(size: 24, color: Colors.blue);
/// ```
class DuotoneMonitorAlt4 extends StatelessWidget {
  ...
  /// Creates a DuotoneMonitorAlt4.
  const DuotoneMonitorAlt4({
    super.key,
    this.size = 24,
    this.color,
  });
