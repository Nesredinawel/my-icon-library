...
/// Duotone style MobileAlt2 icon.
///
/// Example:
/// ```dart
/// DuotoneMobileAlt2(size: 24, color: Colors.blue);
/// ```
class DuotoneMobileAlt2 extends StatelessWidget {
  ...
  /// Creates a DuotoneMobileAlt2.
  const DuotoneMobileAlt2({
    super.key,
    this.size = 24,
    this.color,
  });
