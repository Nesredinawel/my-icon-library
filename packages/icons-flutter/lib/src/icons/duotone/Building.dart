...
/// Duotone style Building icon.
///
/// Example:
/// ```dart
/// DuotoneBuilding(size: 24, color: Colors.blue);
/// ```
class DuotoneBuilding extends StatelessWidget {
  ...
  /// Creates a DuotoneBuilding.
  const DuotoneBuilding({
    super.key,
    this.size = 24,
    this.color,
  });
