...
/// Duotone style FileGraph icon.
///
/// Example:
/// ```dart
/// DuotoneFileGraph(size: 24, color: Colors.blue);
/// ```
class DuotoneFileGraph extends StatelessWidget {
  ...
  /// Creates a DuotoneFileGraph.
  const DuotoneFileGraph({
    super.key,
    this.size = 24,
    this.color,
  });
