...
/// Duotone style MessageSquareChartLines icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareChartLines(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareChartLines extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareChartLines.
  const DuotoneMessageSquareChartLines({
    super.key,
    this.size = 24,
    this.color,
  });
