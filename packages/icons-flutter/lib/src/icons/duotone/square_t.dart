...
/// Duotone style SquareT icon.
///
/// Example:
/// ```dart
/// DuotoneSquareT(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareT extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareT.
  const DuotoneSquareT({
    super.key,
    this.size = 24,
    this.color,
  });
