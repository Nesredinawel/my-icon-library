...
/// Duotone style FileArrowRight icon.
///
/// Example:
/// ```dart
/// DuotoneFileArrowRight(size: 24, color: Colors.blue);
/// ```
class DuotoneFileArrowRight extends StatelessWidget {
  ...
  /// Creates a DuotoneFileArrowRight.
  const DuotoneFileArrowRight({
    super.key,
    this.size = 24,
    this.color,
  });
