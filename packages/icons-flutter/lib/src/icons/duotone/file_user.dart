...
/// Duotone style FileUser icon.
///
/// Example:
/// ```dart
/// DuotoneFileUser(size: 24, color: Colors.blue);
/// ```
class DuotoneFileUser extends StatelessWidget {
  ...
  /// Creates a DuotoneFileUser.
  const DuotoneFileUser({
    super.key,
    this.size = 24,
    this.color,
  });
