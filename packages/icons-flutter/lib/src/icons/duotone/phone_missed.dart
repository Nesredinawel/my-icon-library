...
/// Duotone style PhoneMissed icon.
///
/// Example:
/// ```dart
/// DuotonePhoneMissed(size: 24, color: Colors.blue);
/// ```
class DuotonePhoneMissed extends StatelessWidget {
  ...
  /// Creates a DuotonePhoneMissed.
  const DuotonePhoneMissed({
    super.key,
    this.size = 24,
    this.color,
  });
