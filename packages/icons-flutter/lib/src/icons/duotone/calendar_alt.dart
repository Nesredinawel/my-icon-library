...
/// Duotone style CalendarAlt icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarAlt.
  const DuotoneCalendarAlt({
    super.key,
    this.size = 24,
    this.color,
  });
