...
/// Duotone style TabletAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneTabletAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneTabletAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneTabletAlt1.
  const DuotoneTabletAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
