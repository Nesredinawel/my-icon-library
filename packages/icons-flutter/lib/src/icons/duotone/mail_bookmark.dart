...
/// Duotone style MailBookmark icon.
///
/// Example:
/// ```dart
/// DuotoneMailBookmark(size: 24, color: Colors.blue);
/// ```
class DuotoneMailBookmark extends StatelessWidget {
  ...
  /// Creates a DuotoneMailBookmark.
  const DuotoneMailBookmark({
    super.key,
    this.size = 24,
    this.color,
  });
