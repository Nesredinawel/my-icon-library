...
/// Duotone style MessageSquarePlus icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquarePlus(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquarePlus extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquarePlus.
  const DuotoneMessageSquarePlus({
    super.key,
    this.size = 24,
    this.color,
  });
