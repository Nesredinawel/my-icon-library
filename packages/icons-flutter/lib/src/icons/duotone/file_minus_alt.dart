...
/// Duotone style FileMinusAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileMinusAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileMinusAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileMinusAlt.
  const DuotoneFileMinusAlt({
    super.key,
    this.size = 24,
    this.color,
  });
