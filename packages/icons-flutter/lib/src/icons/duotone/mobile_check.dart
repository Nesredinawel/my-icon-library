...
/// Duotone style MobileCheck icon.
///
/// Example:
/// ```dart
/// DuotoneMobileCheck(size: 24, color: Colors.blue);
/// ```
class DuotoneMobileCheck extends StatelessWidget {
  ...
  /// Creates a DuotoneMobileCheck.
  const DuotoneMobileCheck({
    super.key,
    this.size = 24,
    this.color,
  });
