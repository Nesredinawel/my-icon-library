...
/// Duotone style KitMedical icon.
///
/// Example:
/// ```dart
/// DuotoneKitMedical(size: 24, color: Colors.blue);
/// ```
class DuotoneKitMedical extends StatelessWidget {
  ...
  /// Creates a DuotoneKitMedical.
  const DuotoneKitMedical({
    super.key,
    this.size = 24,
    this.color,
  });
