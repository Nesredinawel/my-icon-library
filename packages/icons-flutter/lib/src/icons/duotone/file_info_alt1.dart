...
/// Duotone style FileInfoAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneFileInfoAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneFileInfoAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneFileInfoAlt1.
  const DuotoneFileInfoAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
