...
/// Duotone style PhoneOutgoingAlt icon.
///
/// Example:
/// ```dart
/// DuotonePhoneOutgoingAlt(size: 24, color: Colors.blue);
/// ```
class DuotonePhoneOutgoingAlt extends StatelessWidget {
  ...
  /// Creates a DuotonePhoneOutgoingAlt.
  const DuotonePhoneOutgoingAlt({
    super.key,
    this.size = 24,
    this.color,
  });
