...
/// Duotone style InboxXmark icon.
///
/// Example:
/// ```dart
/// DuotoneInboxXmark(size: 24, color: Colors.blue);
/// ```
class DuotoneInboxXmark extends StatelessWidget {
  ...
  /// Creates a DuotoneInboxXmark.
  const DuotoneInboxXmark({
    super.key,
    this.size = 24,
    this.color,
  });
