...
/// Duotone style MonitorAlt5 icon.
///
/// Example:
/// ```dart
/// DuotoneMonitorAlt5(size: 24, color: Colors.blue);
/// ```
class DuotoneMonitorAlt5 extends StatelessWidget {
  ...
  /// Creates a DuotoneMonitorAlt5.
  const DuotoneMonitorAlt5({
    super.key,
    this.size = 24,
    this.color,
  });
