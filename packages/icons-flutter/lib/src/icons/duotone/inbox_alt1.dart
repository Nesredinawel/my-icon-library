...
/// Duotone style InboxAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneInboxAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneInboxAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneInboxAlt1.
  const DuotoneInboxAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
