...
/// Duotone style MessageSquareMedical icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareMedical(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareMedical extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareMedical.
  const DuotoneMessageSquareMedical({
    super.key,
    this.size = 24,
    this.color,
  });
