...
/// Duotone style HalloweenCalendar icon.
///
/// Example:
/// ```dart
/// DuotoneHalloweenCalendar(size: 24, color: Colors.blue);
/// ```
class DuotoneHalloweenCalendar extends StatelessWidget {
  ...
  /// Creates a DuotoneHalloweenCalendar.
  const DuotoneHalloweenCalendar({
    super.key,
    this.size = 24,
    this.color,
  });
