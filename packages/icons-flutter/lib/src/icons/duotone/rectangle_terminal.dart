...
/// Duotone style RectangleTerminal icon.
///
/// Example:
/// ```dart
/// DuotoneRectangleTerminal(size: 24, color: Colors.blue);
/// ```
class DuotoneRectangleTerminal extends StatelessWidget {
  ...
  /// Creates a DuotoneRectangleTerminal.
  const DuotoneRectangleTerminal({
    super.key,
    this.size = 24,
    this.color,
  });
