...
/// Duotone style UserCheckAlt icon.
///
/// Example:
/// ```dart
/// DuotoneUserCheckAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneUserCheckAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneUserCheckAlt.
  const DuotoneUserCheckAlt({
    super.key,
    this.size = 24,
    this.color,
  });
