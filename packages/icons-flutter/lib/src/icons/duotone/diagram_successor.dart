...
/// Duotone style DiagramSuccessor icon.
///
/// Example:
/// ```dart
/// DuotoneDiagramSuccessor(size: 24, color: Colors.blue);
/// ```
class DuotoneDiagramSuccessor extends StatelessWidget {
  ...
  /// Creates a DuotoneDiagramSuccessor.
  const DuotoneDiagramSuccessor({
    super.key,
    this.size = 24,
    this.color,
  });
