...
/// Duotone style MessageSquareList icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareList(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareList extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareList.
  const DuotoneMessageSquareList({
    super.key,
    this.size = 24,
    this.color,
  });
