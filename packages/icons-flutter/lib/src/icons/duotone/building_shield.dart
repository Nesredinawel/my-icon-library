...
/// Duotone style BuildingShield icon.
///
/// Example:
/// ```dart
/// DuotoneBuildingShield(size: 24, color: Colors.blue);
/// ```
class DuotoneBuildingShield extends StatelessWidget {
  ...
  /// Creates a DuotoneBuildingShield.
  const DuotoneBuildingShield({
    super.key,
    this.size = 24,
    this.color,
  });
