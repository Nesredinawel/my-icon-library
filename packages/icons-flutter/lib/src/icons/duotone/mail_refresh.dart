...
/// Duotone style MailRefresh icon.
///
/// Example:
/// ```dart
/// DuotoneMailRefresh(size: 24, color: Colors.blue);
/// ```
class DuotoneMailRefresh extends StatelessWidget {
  ...
  /// Creates a DuotoneMailRefresh.
  const DuotoneMailRefresh({
    super.key,
    this.size = 24,
    this.color,
  });
