...
/// Duotone style DiceOne icon.
///
/// Example:
/// ```dart
/// DuotoneDiceOne(size: 24, color: Colors.blue);
/// ```
class DuotoneDiceOne extends StatelessWidget {
  ...
  /// Creates a DuotoneDiceOne.
  const DuotoneDiceOne({
    super.key,
    this.size = 24,
    this.color,
  });
