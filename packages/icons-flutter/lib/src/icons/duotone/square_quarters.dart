...
/// Duotone style SquareQuarters icon.
///
/// Example:
/// ```dart
/// DuotoneSquareQuarters(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareQuarters extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareQuarters.
  const DuotoneSquareQuarters({
    super.key,
    this.size = 24,
    this.color,
  });
