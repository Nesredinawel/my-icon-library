...
/// Duotone style WindowFlip icon.
///
/// Example:
/// ```dart
/// DuotoneWindowFlip(size: 24, color: Colors.blue);
/// ```
class DuotoneWindowFlip extends StatelessWidget {
  ...
  /// Creates a DuotoneWindowFlip.
  const DuotoneWindowFlip({
    super.key,
    this.size = 24,
    this.color,
  });
