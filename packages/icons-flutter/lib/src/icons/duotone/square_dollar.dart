...
/// Duotone style SquareDollar icon.
///
/// Example:
/// ```dart
/// DuotoneSquareDollar(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareDollar extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareDollar.
  const DuotoneSquareDollar({
    super.key,
    this.size = 24,
    this.color,
  });
