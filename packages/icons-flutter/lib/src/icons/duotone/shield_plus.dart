...
/// Duotone style ShieldPlus icon.
///
/// Example:
/// ```dart
/// DuotoneShieldPlus(size: 24, color: Colors.blue);
/// ```
class DuotoneShieldPlus extends StatelessWidget {
  ...
  /// Creates a DuotoneShieldPlus.
  const DuotoneShieldPlus({
    super.key,
    this.size = 24,
    this.color,
  });
