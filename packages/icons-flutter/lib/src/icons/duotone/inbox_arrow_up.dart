...
/// Duotone style InboxArrowUp icon.
///
/// Example:
/// ```dart
/// DuotoneInboxArrowUp(size: 24, color: Colors.blue);
/// ```
class DuotoneInboxArrowUp extends StatelessWidget {
  ...
  /// Creates a DuotoneInboxArrowUp.
  const DuotoneInboxArrowUp({
    super.key,
    this.size = 24,
    this.color,
  });
