...
/// Duotone style FilePencilAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneFilePencilAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneFilePencilAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneFilePencilAlt1.
  const DuotoneFilePencilAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
