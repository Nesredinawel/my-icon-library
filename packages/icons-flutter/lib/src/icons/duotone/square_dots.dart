...
/// Duotone style SquareDots icon.
///
/// Example:
/// ```dart
/// DuotoneSquareDots(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareDots extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareDots.
  const DuotoneSquareDots({
    super.key,
    this.size = 24,
    this.color,
  });
