...
/// Duotone style TrashBlankAlt icon.
///
/// Example:
/// ```dart
/// DuotoneTrashBlankAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneTrashBlankAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneTrashBlankAlt.
  const DuotoneTrashBlankAlt({
    super.key,
    this.size = 24,
    this.color,
  });
