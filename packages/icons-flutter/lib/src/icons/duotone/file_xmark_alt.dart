...
/// Duotone style FileXmarkAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileXmarkAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileXmarkAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileXmarkAlt.
  const DuotoneFileXmarkAlt({
    super.key,
    this.size = 24,
    this.color,
  });
