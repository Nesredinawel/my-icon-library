...
/// Duotone style MonitorHeartRate icon.
///
/// Example:
/// ```dart
/// DuotoneMonitorHeartRate(size: 24, color: Colors.blue);
/// ```
class DuotoneMonitorHeartRate extends StatelessWidget {
  ...
  /// Creates a DuotoneMonitorHeartRate.
  const DuotoneMonitorHeartRate({
    super.key,
    this.size = 24,
    this.color,
  });
