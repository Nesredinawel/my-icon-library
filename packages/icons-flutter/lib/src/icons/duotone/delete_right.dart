...
/// Duotone style DeleteRight icon.
///
/// Example:
/// ```dart
/// DuotoneDeleteRight(size: 24, color: Colors.blue);
/// ```
class DuotoneDeleteRight extends StatelessWidget {
  ...
  /// Creates a DuotoneDeleteRight.
  const DuotoneDeleteRight({
    super.key,
    this.size = 24,
    this.color,
  });
