...
/// Duotone style CalendarWeek icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarWeek(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarWeek extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarWeek.
  const DuotoneCalendarWeek({
    super.key,
    this.size = 24,
    this.color,
  });
