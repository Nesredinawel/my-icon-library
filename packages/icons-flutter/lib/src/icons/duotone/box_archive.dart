...
/// Duotone style BoxArchive icon.
///
/// Example:
/// ```dart
/// DuotoneBoxArchive(size: 24, color: Colors.blue);
/// ```
class DuotoneBoxArchive extends StatelessWidget {
  ...
  /// Creates a DuotoneBoxArchive.
  const DuotoneBoxArchive({
    super.key,
    this.size = 24,
    this.color,
  });
