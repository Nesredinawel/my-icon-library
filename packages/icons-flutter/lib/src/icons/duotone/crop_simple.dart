...
/// Duotone style CropSimple icon.
///
/// Example:
/// ```dart
/// DuotoneCropSimple(size: 24, color: Colors.blue);
/// ```
class DuotoneCropSimple extends StatelessWidget {
  ...
  /// Creates a DuotoneCropSimple.
  const DuotoneCropSimple({
    super.key,
    this.size = 24,
    this.color,
  });
