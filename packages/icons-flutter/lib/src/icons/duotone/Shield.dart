...
/// Duotone style Shield icon.
///
/// Example:
/// ```dart
/// DuotoneShield(size: 24, color: Colors.blue);
/// ```
class DuotoneShield extends StatelessWidget {
