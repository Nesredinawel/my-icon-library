...
/// Duotone style FileShieldAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileShieldAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileShieldAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileShieldAlt.
  const DuotoneFileShieldAlt({
    super.key,
    this.size = 24,
    this.color,
  });
