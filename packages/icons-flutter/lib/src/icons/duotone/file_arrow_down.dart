...
/// Duotone style FileArrowDown icon.
///
/// Example:
/// ```dart
/// DuotoneFileArrowDown(size: 24, color: Colors.blue);
/// ```
class DuotoneFileArrowDown extends StatelessWidget {
  ...
  /// Creates a DuotoneFileArrowDown.
  const DuotoneFileArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
