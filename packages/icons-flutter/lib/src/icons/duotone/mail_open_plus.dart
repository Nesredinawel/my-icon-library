...
/// Duotone style MailOpenPlus icon.
///
/// Example:
/// ```dart
/// DuotoneMailOpenPlus(size: 24, color: Colors.blue);
/// ```
class DuotoneMailOpenPlus extends StatelessWidget {
  ...
  /// Creates a DuotoneMailOpenPlus.
  const DuotoneMailOpenPlus({
    super.key,
    this.size = 24,
    this.color,
  });
