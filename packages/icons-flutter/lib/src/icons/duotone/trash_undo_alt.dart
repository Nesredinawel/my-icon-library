...
/// Duotone style TrashUndoAlt icon.
///
/// Example:
/// ```dart
/// DuotoneTrashUndoAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneTrashUndoAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneTrashUndoAlt.
  const DuotoneTrashUndoAlt({
    super.key,
    this.size = 24,
    this.color,
  });
