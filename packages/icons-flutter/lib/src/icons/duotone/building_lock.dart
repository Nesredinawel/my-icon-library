...
/// Duotone style BuildingLock icon.
///
/// Example:
/// ```dart
/// DuotoneBuildingLock(size: 24, color: Colors.blue);
/// ```
class DuotoneBuildingLock extends StatelessWidget {
  ...
  /// Creates a DuotoneBuildingLock.
  const DuotoneBuildingLock({
    super.key,
    this.size = 24,
    this.color,
  });
