...
/// Duotone style RectangleWide icon.
///
/// Example:
/// ```dart
/// DuotoneRectangleWide(size: 24, color: Colors.blue);
/// ```
class DuotoneRectangleWide extends StatelessWidget {
  ...
  /// Creates a DuotoneRectangleWide.
  const DuotoneRectangleWide({
    super.key,
    this.size = 24,
    this.color,
  });
