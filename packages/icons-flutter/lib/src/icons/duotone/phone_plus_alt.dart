...
/// Duotone style PhonePlusAlt icon.
///
/// Example:
/// ```dart
/// DuotonePhonePlusAlt(size: 24, color: Colors.blue);
/// ```
class DuotonePhonePlusAlt extends StatelessWidget {
  ...
  /// Creates a DuotonePhonePlusAlt.
  const DuotonePhonePlusAlt({
    super.key,
    this.size = 24,
    this.color,
  });
