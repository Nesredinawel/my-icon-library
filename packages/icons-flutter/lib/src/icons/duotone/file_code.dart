...
/// Duotone style FileCode icon.
///
/// Example:
/// ```dart
/// DuotoneFileCode(size: 24, color: Colors.blue);
/// ```
class DuotoneFileCode extends StatelessWidget {
  ...
  /// Creates a DuotoneFileCode.
  const DuotoneFileCode({
    super.key,
    this.size = 24,
    this.color,
  });
