...
/// Duotone style CreditCard icon.
///
/// Example:
/// ```dart
/// DuotoneCreditCard(size: 24, color: Colors.blue);
/// ```
class DuotoneCreditCard extends StatelessWidget {
  ...
  /// Creates a DuotoneCreditCard.
  const DuotoneCreditCard({
    super.key,
    this.size = 24,
    this.color,
  });
