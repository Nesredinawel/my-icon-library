...
/// Duotone style MessageSquareXmark icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareXmark(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareXmark extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareXmark.
  const DuotoneMessageSquareXmark({
    super.key,
    this.size = 24,
    this.color,
  });
