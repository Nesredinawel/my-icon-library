...
/// Duotone style ShieldCheck icon.
///
/// Example:
/// ```dart
/// DuotoneShieldCheck(size: 24, color: Colors.blue);
/// ```
class DuotoneShieldCheck extends StatelessWidget {
  ...
  /// Creates a DuotoneShieldCheck.
  const DuotoneShieldCheck({
    super.key,
    this.size = 24,
    this.color,
  });
