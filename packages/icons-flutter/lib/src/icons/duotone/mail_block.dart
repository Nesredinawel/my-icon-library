...
/// Duotone style MailBlock icon.
///
/// Example:
/// ```dart
/// DuotoneMailBlock(size: 24, color: Colors.blue);
/// ```
class DuotoneMailBlock extends StatelessWidget {
  ...
  /// Creates a DuotoneMailBlock.
  const DuotoneMailBlock({
    super.key,
    this.size = 24,
    this.color,
  });
