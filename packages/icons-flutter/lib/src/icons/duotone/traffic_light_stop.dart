...
/// Duotone style TrafficLightStop icon.
///
/// Example:
/// ```dart
/// DuotoneTrafficLightStop(size: 24, color: Colors.blue);
/// ```
class DuotoneTrafficLightStop extends StatelessWidget {
  ...
  /// Creates a DuotoneTrafficLightStop.
  const DuotoneTrafficLightStop({
    super.key,
    this.size = 24,
    this.color,
  });
