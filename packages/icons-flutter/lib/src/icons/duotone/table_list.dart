...
/// Duotone style TableList icon.
///
/// Example:
/// ```dart
/// DuotoneTableList(size: 24, color: Colors.blue);
/// ```
class DuotoneTableList extends StatelessWidget {
  ...
  /// Creates a DuotoneTableList.
  const DuotoneTableList({
    super.key,
    this.size = 24,
    this.color,
  });
