...
/// Duotone style BatteryBolt icon.
///
/// Example:
/// ```dart
/// DuotoneBatteryBolt(size: 24, color: Colors.blue);
/// ```
class DuotoneBatteryBolt extends StatelessWidget {
  ...
  /// Creates a DuotoneBatteryBolt.
  const DuotoneBatteryBolt({
    super.key,
    this.size = 24,
    this.color,
  });
