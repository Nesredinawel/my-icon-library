...
/// Duotone style PenSwirl icon.
///
/// Example:
/// ```dart
/// DuotonePenSwirl(size: 24, color: Colors.blue);
/// ```
class DuotonePenSwirl extends StatelessWidget {
  ...
  /// Creates a DuotonePenSwirl.
  const DuotonePenSwirl({
    super.key,
    this.size = 24,
    this.color,
  });
