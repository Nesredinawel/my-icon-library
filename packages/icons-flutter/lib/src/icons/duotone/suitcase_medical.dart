...
/// Duotone style SuitcaseMedical icon.
///
/// Example:
/// ```dart
/// DuotoneSuitcaseMedical(size: 24, color: Colors.blue);
/// ```
class DuotoneSuitcaseMedical extends StatelessWidget {
  ...
  /// Creates a DuotoneSuitcaseMedical.
  const DuotoneSuitcaseMedical({
    super.key,
    this.size = 24,
    this.color,
  });
