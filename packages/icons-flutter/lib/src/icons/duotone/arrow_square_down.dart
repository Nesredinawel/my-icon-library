...
/// Duotone style ArrowSquareDown icon.
///
/// Example:
/// ```dart
/// DuotoneArrowSquareDown(size: 24, color: Colors.blue);
/// ```
class DuotoneArrowSquareDown extends StatelessWidget {
  ...
  /// Creates a DuotoneArrowSquareDown.
  const DuotoneArrowSquareDown({
    super.key,
    this.size = 24,
    this.color,
  });
