...
/// Duotone style PhonePauseAlt icon.
///
/// Example:
/// ```dart
/// DuotonePhonePauseAlt(size: 24, color: Colors.blue);
/// ```
class DuotonePhonePauseAlt extends StatelessWidget {
  ...
  /// Creates a DuotonePhonePauseAlt.
  const DuotonePhonePauseAlt({
    super.key,
    this.size = 24,
    this.color,
  });
