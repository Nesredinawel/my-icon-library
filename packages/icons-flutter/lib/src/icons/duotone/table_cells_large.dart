...
/// Duotone style TableCellsLarge icon.
///
/// Example:
/// ```dart
/// DuotoneTableCellsLarge(size: 24, color: Colors.blue);
/// ```
class DuotoneTableCellsLarge extends StatelessWidget {
  ...
  /// Creates a DuotoneTableCellsLarge.
  const DuotoneTableCellsLarge({
    super.key,
    this.size = 24,
    this.color,
  });
