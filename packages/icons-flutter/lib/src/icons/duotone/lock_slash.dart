...
/// Duotone style LockSlash icon.
///
/// Example:
/// ```dart
/// DuotoneLockSlash(size: 24, color: Colors.blue);
/// ```
class DuotoneLockSlash extends StatelessWidget {
  ...
  /// Creates a DuotoneLockSlash.
  const DuotoneLockSlash({
    super.key,
    this.size = 24,
    this.color,
  });
