...
/// Duotone style FileLockAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneFileLockAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneFileLockAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneFileLockAlt1.
  const DuotoneFileLockAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
