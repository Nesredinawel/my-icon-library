...
/// Duotone style CalendarUser icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarUser(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarUser extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarUser.
  const DuotoneCalendarUser({
    super.key,
    this.size = 24,
    this.color,
  });
