...
/// Duotone style MonitorAlt2 icon.
///
/// Example:
/// ```dart
/// DuotoneMonitorAlt2(size: 24, color: Colors.blue);
/// ```
class DuotoneMonitorAlt2 extends StatelessWidget {
  ...
  /// Creates a DuotoneMonitorAlt2.
  const DuotoneMonitorAlt2({
    super.key,
    this.size = 24,
    this.color,
  });
