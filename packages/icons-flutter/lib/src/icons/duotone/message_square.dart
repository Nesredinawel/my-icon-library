...
/// Duotone style MessageSquare icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquare(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquare extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquare.
  const DuotoneMessageSquare({
    super.key,
    this.size = 24,
    this.color,
  });
