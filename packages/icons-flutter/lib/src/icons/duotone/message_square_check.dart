...
/// Duotone style MessageSquareCheck icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareCheck(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareCheck extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareCheck.
  const DuotoneMessageSquareCheck({
    super.key,
    this.size = 24,
    this.color,
  });
