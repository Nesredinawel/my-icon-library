...
/// Duotone style MailMinus icon.
///
/// Example:
/// ```dart
/// DuotoneMailMinus(size: 24, color: Colors.blue);
/// ```
class DuotoneMailMinus extends StatelessWidget {
  ...
  /// Creates a DuotoneMailMinus.
  const DuotoneMailMinus({
    super.key,
    this.size = 24,
    this.color,
  });
