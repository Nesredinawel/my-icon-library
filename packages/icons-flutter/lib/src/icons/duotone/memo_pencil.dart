...
/// Duotone style MemoPencil icon.
///
/// Example:
/// ```dart
/// DuotoneMemoPencil(size: 24, color: Colors.blue);
/// ```
class DuotoneMemoPencil extends StatelessWidget {
  ...
  /// Creates a DuotoneMemoPencil.
  const DuotoneMemoPencil({
    super.key,
    this.size = 24,
    this.color,
  });
