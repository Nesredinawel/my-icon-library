...
/// Duotone style CreditCardAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneCreditCardAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneCreditCardAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneCreditCardAlt1.
  const DuotoneCreditCardAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
