...
/// Duotone style Mail icon.
///
/// Example:
/// ```dart
/// DuotoneMail(size: 24, color: Colors.blue);
/// ```
class DuotoneMail extends StatelessWidget {
