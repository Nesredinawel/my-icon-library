...
class DuotoneCalendarXmark extends StatelessWidget {
  final double size;
  final Color? color;

  const DuotoneCalendarXmark({
    super.key,
    this.size = 24,
    this.color,
  });
