...
/// Duotone style HalloweenCalendarBat icon.
///
/// Example:
/// ```dart
/// DuotoneHalloweenCalendarBat(size: 24, color: Colors.blue);
/// ```
class DuotoneHalloweenCalendarBat extends StatelessWidget {
  ...
  /// Creates a DuotoneHalloweenCalendarBat.
  const DuotoneHalloweenCalendarBat({
    super.key,
    this.size = 24,
    this.color,
  });
