...
/// Duotone style FileArrowDownAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileArrowDownAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileArrowDownAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileArrowDownAlt.
  const DuotoneFileArrowDownAlt({
    super.key,
    this.size = 24,
    this.color,
  });
