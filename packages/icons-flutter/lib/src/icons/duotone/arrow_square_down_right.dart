...
/// Duotone style ArrowSquareDownRight icon.
///
/// Example:
/// ```dart
/// DuotoneArrowSquareDownRight(size: 24, color: Colors.blue);
/// ```
class DuotoneArrowSquareDownRight extends StatelessWidget {
  ...
  /// Creates a DuotoneArrowSquareDownRight.
  const DuotoneArrowSquareDownRight({
    super.key,
    this.size = 24,
    this.color,
  });
