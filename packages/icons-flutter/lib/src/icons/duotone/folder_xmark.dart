...
/// Duotone style FolderXmark icon.
///
/// Example:
/// ```dart
/// DuotoneFolderXmark(size: 24, color: Colors.blue);
/// ```
class DuotoneFolderXmark extends StatelessWidget {
  ...
  /// Creates a DuotoneFolderXmark.
  const DuotoneFolderXmark({
    super.key,
    this.size = 24,
    this.color,
  });
