...
class DuotoneSquareCheck extends StatelessWidget {
  final double size;
  final Color? color;

  const DuotoneSquareCheck({
    super.key,
    this.size = 24,
    this.color,
  });
