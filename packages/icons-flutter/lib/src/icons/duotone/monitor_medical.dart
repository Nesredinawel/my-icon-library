...
/// Duotone style MonitorMedical icon.
///
/// Example:
/// ```dart
/// DuotoneMonitorMedical(size: 24, color: Colors.blue);
/// ```
class DuotoneMonitorMedical extends StatelessWidget {
  ...
  /// Creates a DuotoneMonitorMedical.
  const DuotoneMonitorMedical({
    super.key,
    this.size = 24,
    this.color,
  });
