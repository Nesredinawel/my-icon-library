...
/// Duotone style TrashPlusAlt icon.
///
/// Example:
/// ```dart
/// DuotoneTrashPlusAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneTrashPlusAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneTrashPlusAlt.
  const DuotoneTrashPlusAlt({
    super.key,
    this.size = 24,
    this.color,
  });
