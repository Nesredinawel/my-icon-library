...
/// Duotone style MailCheck icon.
///
/// Example:
/// ```dart
/// DuotoneMailCheck(size: 24, color: Colors.blue);
/// ```
class DuotoneMailCheck extends StatelessWidget {
  ...
  /// Creates a DuotoneMailCheck.
  const DuotoneMailCheck({
    super.key,
    this.size = 24,
    this.color,
  });
