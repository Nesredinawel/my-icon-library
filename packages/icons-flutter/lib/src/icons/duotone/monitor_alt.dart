...
/// Duotone style MonitorAlt icon.
///
/// Example:
/// ```dart
/// DuotoneMonitorAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneMonitorAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneMonitorAlt.
  const DuotoneMonitorAlt({
    super.key,
    this.size = 24,
    this.color,
  });
