...
/// Duotone style CalendarXmarkAlt icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarXmarkAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarXmarkAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarXmarkAlt.
  const DuotoneCalendarXmarkAlt({
    super.key,
    this.size = 24,
    this.color,
  });
