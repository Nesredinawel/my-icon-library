...
/// Duotone style MoneyCheckDollar icon.
///
/// Example:
/// ```dart
/// DuotoneMoneyCheckDollar(size: 24, color: Colors.blue);
/// ```
class DuotoneMoneyCheckDollar extends StatelessWidget {
  ...
  /// Creates a DuotoneMoneyCheckDollar.
  const DuotoneMoneyCheckDollar({
    super.key,
    this.size = 24,
    this.color,
  });
