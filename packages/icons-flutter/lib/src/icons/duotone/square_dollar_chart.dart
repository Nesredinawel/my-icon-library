...
/// Duotone style SquareDollarChart icon.
///
/// Example:
/// ```dart
/// DuotoneSquareDollarChart(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareDollarChart extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareDollarChart.
  const DuotoneSquareDollarChart({
    super.key,
    this.size = 24,
    this.color,
  });
