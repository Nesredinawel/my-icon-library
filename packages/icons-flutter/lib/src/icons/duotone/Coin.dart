...
/// Duotone style Coin icon.
///
/// Example:
/// ```dart
/// DuotoneCoin(size: 24, color: Colors.blue);
/// ```
class DuotoneCoin extends StatelessWidget {
