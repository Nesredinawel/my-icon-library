...
/// Duotone style SquareDotsVertical icon.
///
/// Example:
/// ```dart
/// DuotoneSquareDotsVertical(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareDotsVertical extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareDotsVertical.
  const DuotoneSquareDotsVertical({
    super.key,
    this.size = 24,
    this.color,
  });
