...
/// Duotone style SquareH icon.
///
/// Example:
/// ```dart
/// DuotoneSquareH(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareH extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareH.
  const DuotoneSquareH({
    super.key,
    this.size = 24,
    this.color,
  });
