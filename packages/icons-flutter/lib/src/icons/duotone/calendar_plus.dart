...
/// Duotone style CalendarPlus icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarPlus(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarPlus extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarPlus.
  const DuotoneCalendarPlus({
    super.key,
    this.size = 24,
    this.color,
  });
