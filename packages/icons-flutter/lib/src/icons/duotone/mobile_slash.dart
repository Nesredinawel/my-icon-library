...
/// Duotone style MobileSlash icon.
///
/// Example:
/// ```dart
/// DuotoneMobileSlash(size: 24, color: Colors.blue);
/// ```
class DuotoneMobileSlash extends StatelessWidget {
  ...
  /// Creates a DuotoneMobileSlash.
  const DuotoneMobileSlash({
    super.key,
    this.size = 24,
    this.color,
  });
