...
/// Duotone style LaptopAlt icon.
///
/// Example:
/// ```dart
/// DuotoneLaptopAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneLaptopAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneLaptopAlt.
  const DuotoneLaptopAlt({
    super.key,
    this.size = 24,
    this.color,
  });
