...
/// Duotone style LaptopArrowDown icon.
///
/// Example:
/// ```dart
/// DuotoneLaptopArrowDown(size: 24, color: Colors.blue);
/// ```
class DuotoneLaptopArrowDown extends StatelessWidget {
  ...
  /// Creates a DuotoneLaptopArrowDown.
  const DuotoneLaptopArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
