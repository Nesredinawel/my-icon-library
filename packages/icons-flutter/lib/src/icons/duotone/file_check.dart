...
/// Duotone style FileCheck icon.
///
/// Example:
/// ```dart
/// DuotoneFileCheck(size: 24, color: Colors.blue);
/// ```
class DuotoneFileCheck extends StatelessWidget {
  ...
  /// Creates a DuotoneFileCheck.
  const DuotoneFileCheck({
    super.key,
    this.size = 24,
    this.color,
  });
