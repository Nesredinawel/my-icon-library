...
/// Duotone style ArrowSquareUpLeft icon.
///
/// Example:
/// ```dart
/// DuotoneArrowSquareUpLeft(size: 24, color: Colors.blue);
/// ```
class DuotoneArrowSquareUpLeft extends StatelessWidget {
  ...
  /// Creates a DuotoneArrowSquareUpLeft.
  const DuotoneArrowSquareUpLeft({
    super.key,
    this.size = 24,
    this.color,
  });
