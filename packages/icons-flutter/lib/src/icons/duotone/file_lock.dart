...
/// Duotone style FileLock icon.
///
/// Example:
/// ```dart
/// DuotoneFileLock(size: 24, color: Colors.blue);
/// ```
class DuotoneFileLock extends StatelessWidget {
  ...
  /// Creates a DuotoneFileLock.
  const DuotoneFileLock({
    super.key,
    this.size = 24,
    this.color,
  });
