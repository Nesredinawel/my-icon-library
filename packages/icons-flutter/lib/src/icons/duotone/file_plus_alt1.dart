...
/// Duotone style FilePlusAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneFilePlusAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneFilePlusAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneFilePlusAlt1.
  const DuotoneFilePlusAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
