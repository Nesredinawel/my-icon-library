...
/// Duotone style Garage icon.
///
/// Example:
/// ```dart
/// DuotoneGarage(size: 24, color: Colors.blue);
/// ```
class DuotoneGarage extends StatelessWidget {
