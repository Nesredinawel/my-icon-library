...
/// Duotone style MessageSquareLines icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareLines(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareLines extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareLines.
  const DuotoneMessageSquareLines({
    super.key,
    this.size = 24,
    this.color,
  });
