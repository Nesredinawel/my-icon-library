...
/// Duotone style MailOpenCheck icon.
///
/// Example:
/// ```dart
/// DuotoneMailOpenCheck(size: 24, color: Colors.blue);
/// ```
class DuotoneMailOpenCheck extends StatelessWidget {
  ...
  /// Creates a DuotoneMailOpenCheck.
  const DuotoneMailOpenCheck({
    super.key,
    this.size = 24,
    this.color,
  });
