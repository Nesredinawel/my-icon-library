...
/// Duotone style VideoSlash icon.
///
/// Example:
/// ```dart
/// DuotoneVideoSlash(size: 24, color: Colors.blue);
/// ```
class DuotoneVideoSlash extends StatelessWidget {
  ...
  /// Creates a DuotoneVideoSlash.
  const DuotoneVideoSlash({
    super.key,
    this.size = 24,
    this.color,
  });
