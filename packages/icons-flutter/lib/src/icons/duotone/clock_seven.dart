...
/// Duotone style ClockSeven icon.
///
/// Example:
/// ```dart
/// DuotoneClockSeven(size: 24, color: Colors.blue);
/// ```
class DuotoneClockSeven extends StatelessWidget {
  ...
  /// Creates a DuotoneClockSeven.
  const DuotoneClockSeven({
    super.key,
    this.size = 24,
    this.color,
  });
