...
/// Duotone style MailOpenMinus icon.
///
/// Example:
/// ```dart
/// DuotoneMailOpenMinus(size: 24, color: Colors.blue);
/// ```
class DuotoneMailOpenMinus extends StatelessWidget {
  ...
  /// Creates a DuotoneMailOpenMinus.
  const DuotoneMailOpenMinus({
    super.key,
    this.size = 24,
    this.color,
  });
