...
/// Duotone style FileBookmarkAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileBookmarkAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileBookmarkAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileBookmarkAlt.
  const DuotoneFileBookmarkAlt({
    super.key,
    this.size = 24,
    this.color,
  });
