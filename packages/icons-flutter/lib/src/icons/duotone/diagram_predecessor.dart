...
/// Duotone style DiagramPredecessor icon.
///
/// Example:
/// ```dart
/// DuotoneDiagramPredecessor(size: 24, color: Colors.blue);
/// ```
class DuotoneDiagramPredecessor extends StatelessWidget {
  ...
  /// Creates a DuotoneDiagramPredecessor.
  const DuotoneDiagramPredecessor({
    super.key,
    this.size = 24,
    this.color,
  });
