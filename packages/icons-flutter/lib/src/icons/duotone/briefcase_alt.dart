...
/// Duotone style BriefcaseAlt icon.
///
/// Example:
/// ```dart
/// DuotoneBriefcaseAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneBriefcaseAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneBriefcaseAlt.
  const DuotoneBriefcaseAlt({
    super.key,
    this.size = 24,
    this.color,
  });
