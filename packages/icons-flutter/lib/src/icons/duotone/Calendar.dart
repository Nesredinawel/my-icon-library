...
/// Duotone style Calendar icon.
///
/// Example:
/// ```dart
/// DuotoneCalendar(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendar extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendar.
  const DuotoneCalendar({
    super.key,
    this.size = 24,
    this.color,
  });
