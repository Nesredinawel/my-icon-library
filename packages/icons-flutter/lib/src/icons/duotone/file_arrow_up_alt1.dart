...
/// Duotone style FileArrowUpAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneFileArrowUpAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneFileArrowUpAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneFileArrowUpAlt1.
  const DuotoneFileArrowUpAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
