...
/// Duotone style BriefcasePlus icon.
///
/// Example:
/// ```dart
/// DuotoneBriefcasePlus(size: 24, color: Colors.blue);
/// ```
class DuotoneBriefcasePlus extends StatelessWidget {
  ...
  /// Creates a DuotoneBriefcasePlus.
  const DuotoneBriefcasePlus({
    super.key,
    this.size = 24,
    this.color,
  });
