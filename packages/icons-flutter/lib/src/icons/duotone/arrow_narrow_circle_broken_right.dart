...
/// Duotone style ArrowNarrowCircleBrokenRight icon.
///
/// Example:
/// ```dart
/// DuotoneArrowNarrowCircleBrokenRight(size: 24, color: Colors.blue);
/// ```
class DuotoneArrowNarrowCircleBrokenRight extends StatelessWidget {
  ...
  /// Creates a DuotoneArrowNarrowCircleBrokenRight.
