...
/// Duotone style DiceTwo icon.
///
/// Example:
/// ```dart
/// DuotoneDiceTwo(size: 24, color: Colors.blue);
/// ```
class DuotoneDiceTwo extends StatelessWidget {
  ...
  /// Creates a DuotoneDiceTwo.
  const DuotoneDiceTwo({
    super.key,
    this.size = 24,
    this.color,
  });
