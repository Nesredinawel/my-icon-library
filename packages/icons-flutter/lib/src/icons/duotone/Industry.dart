...
/// Duotone style Industry icon.
///
/// Example:
/// ```dart
/// DuotoneIndustry(size: 24, color: Colors.blue);
/// ```
class DuotoneIndustry extends StatelessWidget {
  ...
  /// Creates a DuotoneIndustry.
  const DuotoneIndustry({
    super.key,
    this.size = 24,
    this.color,
  });
