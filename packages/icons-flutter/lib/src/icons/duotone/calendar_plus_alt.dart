...
/// Duotone style CalendarPlusAlt icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarPlusAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarPlusAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarPlusAlt.
  const DuotoneCalendarPlusAlt({
    super.key,
    this.size = 24,
    this.color,
  });
