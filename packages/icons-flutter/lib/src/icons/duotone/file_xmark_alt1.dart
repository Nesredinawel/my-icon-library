...
/// Duotone style FileXmarkAlt1 icon.
///
/// Example:
/// ```dart
/// DuotoneFileXmarkAlt1(size: 24, color: Colors.blue);
/// ```
class DuotoneFileXmarkAlt1 extends StatelessWidget {
  ...
  /// Creates a DuotoneFileXmarkAlt1.
  const DuotoneFileXmarkAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
