...
/// Duotone style CalendarArrowUp icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarArrowUp(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarArrowUp extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarArrowUp.
  const DuotoneCalendarArrowUp({
    super.key,
    this.size = 24,
    this.color,
  });
