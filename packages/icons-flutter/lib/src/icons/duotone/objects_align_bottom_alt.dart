...
/// Duotone style ObjectsAlignBottomAlt icon.
///
/// Example:
/// ```dart
/// DuotoneObjectsAlignBottomAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneObjectsAlignBottomAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneObjectsAlignBottomAlt.
  const DuotoneObjectsAlignBottomAlt({
    super.key,
    this.size = 24,
    this.color,
  });
