...
/// Duotone style TrafficLightSlow icon.
///
/// Example:
/// ```dart
/// DuotoneTrafficLightSlow(size: 24, color: Colors.blue);
/// ```
class DuotoneTrafficLightSlow extends StatelessWidget {
  ...
  /// Creates a DuotoneTrafficLightSlow.
  const DuotoneTrafficLightSlow({
    super.key,
    this.size = 24,
    this.color,
  });
