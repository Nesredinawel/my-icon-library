...
/// Duotone style TableLayout icon.
///
/// Example:
/// ```dart
/// DuotoneTableLayout(size: 24, color: Colors.blue);
/// ```
class DuotoneTableLayout extends StatelessWidget {
  ...
  /// Creates a DuotoneTableLayout.
  const DuotoneTableLayout({
    super.key,
    this.size = 24,
    this.color,
  });
