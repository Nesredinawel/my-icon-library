...
/// Duotone style FileExclamationAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileExclamationAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileExclamationAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileExclamationAlt.
  const DuotoneFileExclamationAlt({
    super.key,
    this.size = 24,
    this.color,
  });
