...
/// Duotone style FileExclamation icon.
///
/// Example:
/// ```dart
/// DuotoneFileExclamation(size: 24, color: Colors.blue);
/// ```
class DuotoneFileExclamation extends StatelessWidget {
  ...
  /// Creates a DuotoneFileExclamation.
  const DuotoneFileExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
