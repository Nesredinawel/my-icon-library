...
/// Duotone style MessageSquareInfo icon.
///
/// Example:
/// ```dart
/// DuotoneMessageSquareInfo(size: 24, color: Colors.blue);
/// ```
class DuotoneMessageSquareInfo extends StatelessWidget {
  ...
  /// Creates a DuotoneMessageSquareInfo.
  const DuotoneMessageSquareInfo({
    super.key,
    this.size = 24,
    this.color,
  });
