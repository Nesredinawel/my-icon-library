...
/// Duotone style GridSearch icon.
///
/// Example:
/// ```dart
/// DuotoneGridSearch(size: 24, color: Colors.blue);
/// ```
class DuotoneGridSearch extends StatelessWidget {
  ...
  /// Creates a DuotoneGridSearch.
  const DuotoneGridSearch({
    super.key,
    this.size = 24,
    this.color,
  });
