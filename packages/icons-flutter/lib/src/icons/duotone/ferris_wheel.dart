...
/// Duotone style FerrisWheel icon.
///
/// Example:
/// ```dart
/// DuotoneFerrisWheel(size: 24, color: Colors.blue);
/// ```
class DuotoneFerrisWheel extends StatelessWidget {
  ...
  /// Creates a DuotoneFerrisWheel.
  const DuotoneFerrisWheel({
    super.key,
    this.size = 24,
    this.color,
  });
