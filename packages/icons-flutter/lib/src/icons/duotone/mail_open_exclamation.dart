...
/// Duotone style MailOpenExclamation icon.
///
/// Example:
/// ```dart
/// DuotoneMailOpenExclamation(size: 24, color: Colors.blue);
/// ```
class DuotoneMailOpenExclamation extends StatelessWidget {
  ...
  /// Creates a DuotoneMailOpenExclamation.
  const DuotoneMailOpenExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
