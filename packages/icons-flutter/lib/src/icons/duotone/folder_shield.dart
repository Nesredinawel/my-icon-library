...
/// Duotone style FolderShield icon.
///
/// Example:
/// ```dart
/// DuotoneFolderShield(size: 24, color: Colors.blue);
/// ```
class DuotoneFolderShield extends StatelessWidget {
  ...
  /// Creates a DuotoneFolderShield.
  const DuotoneFolderShield({
    super.key,
    this.size = 24,
    this.color,
  });
