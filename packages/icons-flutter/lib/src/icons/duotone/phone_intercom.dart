...
/// Duotone style PhoneIntercom icon.
///
/// Example:
/// ```dart
/// DuotonePhoneIntercom(size: 24, color: Colors.blue);
/// ```
class DuotonePhoneIntercom extends StatelessWidget {
  ...
  /// Creates a DuotonePhoneIntercom.
  const DuotonePhoneIntercom({
    super.key,
    this.size = 24,
    this.color,
  });
