...
/// Duotone style AddressCard icon.
///
/// Example:
/// ```dart
/// DuotoneAddressCard(size: 24, color: Colors.blue);
/// ```
class DuotoneAddressCard extends StatelessWidget {
  ...
  /// Creates a DuotoneAddressCard.
  const DuotoneAddressCard({
    super.key,
    this.size = 24,
    this.color,
  });
