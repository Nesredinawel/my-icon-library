...
/// Duotone style MailShield icon.
///
/// Example:
/// ```dart
/// DuotoneMailShield(size: 24, color: Colors.blue);
/// ```
class DuotoneMailShield extends StatelessWidget {
  ...
  /// Creates a DuotoneMailShield.
  const DuotoneMailShield({
    super.key,
    this.size = 24,
    this.color,
  });
