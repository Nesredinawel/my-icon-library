...
/// Duotone style TabletAlt2 icon.
///
/// Example:
/// ```dart
/// DuotoneTabletAlt2(size: 24, color: Colors.blue);
/// ```
class DuotoneTabletAlt2 extends StatelessWidget {
  ...
  /// Creates a DuotoneTabletAlt2.
  const DuotoneTabletAlt2({
    super.key,
    this.size = 24,
    this.color,
  });
