...
/// Duotone style ClockFive icon.
///
/// Example:
/// ```dart
/// DuotoneClockFive(size: 24, color: Colors.blue);
/// ```
class DuotoneClockFive extends StatelessWidget {
  ...
  /// Creates a DuotoneClockFive.
  const DuotoneClockFive({
    super.key,
    this.size = 24,
    this.color,
  });
