...
/// Duotone style MailInfo icon.
///
/// Example:
/// ```dart
/// DuotoneMailInfo(size: 24, color: Colors.blue);
/// ```
class DuotoneMailInfo extends StatelessWidget {
  ...
  /// Creates a DuotoneMailInfo.
  const DuotoneMailInfo({
    super.key,
    this.size = 24,
    this.color,
  });
