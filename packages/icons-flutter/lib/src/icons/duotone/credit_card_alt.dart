...
/// Duotone style CreditCardAlt icon.
///
/// Example:
/// ```dart
/// DuotoneCreditCardAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneCreditCardAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneCreditCardAlt.
  const DuotoneCreditCardAlt({
    super.key,
    this.size = 24,
    this.color,
  });
