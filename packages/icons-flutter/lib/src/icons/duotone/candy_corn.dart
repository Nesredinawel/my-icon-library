...
/// Duotone style CandyCorn icon.
///
/// Example:
/// ```dart
/// DuotoneCandyCorn(size: 24, color: Colors.blue);
/// ```
class DuotoneCandyCorn extends StatelessWidget {
  ...
  /// Creates a DuotoneCandyCorn.
  const DuotoneCandyCorn({
    super.key,
    this.size = 24,
    this.color,
  });
