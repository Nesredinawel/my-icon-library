...
/// Duotone style MailOpenXmark icon.
///
/// Example:
/// ```dart
/// DuotoneMailOpenXmark(size: 24, color: Colors.blue);
/// ```
class DuotoneMailOpenXmark extends StatelessWidget {
  ...
  /// Creates a DuotoneMailOpenXmark.
  const DuotoneMailOpenXmark({
    super.key,
    this.size = 24,
    this.color,
  });
