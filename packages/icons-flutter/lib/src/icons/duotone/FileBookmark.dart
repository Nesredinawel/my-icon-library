...
class DuotoneFileBookmark extends StatelessWidget {
  final double size;
  final Color? color;

  const DuotoneFileBookmark({
    super.key,
    this.size = 24,
    this.color,
  });
