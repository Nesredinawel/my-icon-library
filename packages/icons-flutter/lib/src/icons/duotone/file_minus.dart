...
/// Duotone style FileMinus icon.
///
/// Example:
/// ```dart
/// DuotoneFileMinus(size: 24, color: Colors.blue);
/// ```
class DuotoneFileMinus extends StatelessWidget {
  ...
  /// Creates a DuotoneFileMinus.
  const DuotoneFileMinus({
    super.key,
    this.size = 24,
    this.color,
  });
