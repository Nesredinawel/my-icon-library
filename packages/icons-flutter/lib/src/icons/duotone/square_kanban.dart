...
/// Duotone style SquareKanban icon.
///
/// Example:
/// ```dart
/// DuotoneSquareKanban(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareKanban extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareKanban.
  const DuotoneSquareKanban({
    super.key,
    this.size = 24,
    this.color,
  });
