...
/// Duotone style CalendarDays icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarDays(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarDays extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarDays.
  const DuotoneCalendarDays({
    super.key,
    this.size = 24,
    this.color,
  });
