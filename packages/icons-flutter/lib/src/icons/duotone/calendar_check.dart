...
/// Duotone style CalendarCheck icon.
///
/// Example:
/// ```dart
/// DuotoneCalendarCheck(size: 24, color: Colors.blue);
/// ```
class DuotoneCalendarCheck extends StatelessWidget {
  ...
  /// Creates a DuotoneCalendarCheck.
  const DuotoneCalendarCheck({
    super.key,
    this.size = 24,
    this.color,
  });
