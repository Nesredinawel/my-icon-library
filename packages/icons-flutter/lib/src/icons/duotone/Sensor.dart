...
/// Duotone style Sensor icon.
///
/// Example:
/// ```dart
/// DuotoneSensor(size: 24, color: Colors.blue);
/// ```
class DuotoneSensor extends StatelessWidget {
