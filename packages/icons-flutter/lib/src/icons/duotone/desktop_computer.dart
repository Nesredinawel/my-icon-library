...
/// Duotone style DesktopComputer icon.
///
/// Example:
/// ```dart
/// DuotoneDesktopComputer(size: 24, color: Colors.blue);
/// ```
class DuotoneDesktopComputer extends StatelessWidget {
  ...
  /// Creates a DuotoneDesktopComputer.
  const DuotoneDesktopComputer({
    super.key,
    this.size = 24,
    this.color,
  });
