...
/// Duotone style LocationCrosshairs icon.
///
/// Example:
/// ```dart
/// DuotoneLocationCrosshairs(size: 24, color: Colors.blue);
/// ```
class DuotoneLocationCrosshairs extends StatelessWidget {
  ...
  /// Creates a DuotoneLocationCrosshairs.
  const DuotoneLocationCrosshairs({
    super.key,
    this.size = 24,
    this.color,
  });
