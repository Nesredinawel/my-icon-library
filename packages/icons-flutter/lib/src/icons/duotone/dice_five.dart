...
/// Duotone style DiceFive icon.
///
/// Example:
/// ```dart
/// DuotoneDiceFive(size: 24, color: Colors.blue);
/// ```
class DuotoneDiceFive extends StatelessWidget {
  ...
  /// Creates a DuotoneDiceFive.
  const DuotoneDiceFive({
    super.key,
    this.size = 24,
    this.color,
  });
