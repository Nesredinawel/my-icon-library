...
/// Duotone style Simcard icon.
///
/// Example:
/// ```dart
/// DuotoneSimcard(size: 24, color: Colors.blue);
/// ```
class DuotoneSimcard extends StatelessWidget {
  ...
  /// Creates a DuotoneSimcard.
  const DuotoneSimcard({
    super.key,
    this.size = 24,
    this.color,
  });
