...
/// Duotone style SquareMedical icon.
///
/// Example:
/// ```dart
/// DuotoneSquareMedical(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareMedical extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareMedical.
  const DuotoneSquareMedical({
    super.key,
    this.size = 24,
    this.color,
  });
