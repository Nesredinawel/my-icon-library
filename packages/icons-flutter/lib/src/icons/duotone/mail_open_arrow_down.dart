...
/// Duotone style MailOpenArrowDown icon.
///
/// Example:
/// ```dart
/// DuotoneMailOpenArrowDown(size: 24, color: Colors.blue);
/// ```
class DuotoneMailOpenArrowDown extends StatelessWidget {
  ...
  /// Creates a DuotoneMailOpenArrowDown.
  const DuotoneMailOpenArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
