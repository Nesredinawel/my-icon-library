...
/// Duotone style BatteryEmpty icon.
///
/// Example:
/// ```dart
/// DuotoneBatteryEmpty(size: 24, color: Colors.blue);
/// ```
class DuotoneBatteryEmpty extends StatelessWidget {
  ...
  /// Creates a DuotoneBatteryEmpty.
  const DuotoneBatteryEmpty({
    super.key,
    this.size = 24,
    this.color,
  });
