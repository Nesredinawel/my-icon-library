...
/// Duotone style BatteryMid icon.
///
/// Example:
/// ```dart
/// DuotoneBatteryMid(size: 24, color: Colors.blue);
/// ```
class DuotoneBatteryMid extends StatelessWidget {
  ...
  /// Creates a DuotoneBatteryMid.
  const DuotoneBatteryMid({
    super.key,
    this.size = 24,
    this.color,
  });
