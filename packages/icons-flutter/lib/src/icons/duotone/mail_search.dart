...
/// Duotone style MailSearch icon.
///
/// Example:
/// ```dart
/// DuotoneMailSearch(size: 24, color: Colors.blue);
/// ```
class DuotoneMailSearch extends StatelessWidget {
  ...
  /// Creates a DuotoneMailSearch.
  const DuotoneMailSearch({
    super.key,
    this.size = 24,
    this.color,
  });
