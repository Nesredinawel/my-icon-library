...
/// Duotone style FileInfoAlt icon.
///
/// Example:
/// ```dart
/// DuotoneFileInfoAlt(size: 24, color: Colors.blue);
/// ```
class DuotoneFileInfoAlt extends StatelessWidget {
  ...
  /// Creates a DuotoneFileInfoAlt.
  const DuotoneFileInfoAlt({
    super.key,
    this.size = 24,
    this.color,
  });
