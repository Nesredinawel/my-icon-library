...
/// Duotone style SquareCv icon.
///
/// Example:
/// ```dart
/// DuotoneSquareCv(size: 24, color: Colors.blue);
/// ```
class DuotoneSquareCv extends StatelessWidget {
  ...
  /// Creates a DuotoneSquareCv.
  const DuotoneSquareCv({
    super.key,
    this.size = 24,
    this.color,
  });
