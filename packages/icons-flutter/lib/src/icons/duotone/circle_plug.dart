...
/// Duotone style CirclePlug icon.
///
/// Example:
/// ```dart
/// DuotoneCirclePlug(size: 24, color: Colors.blue);
/// ```
class DuotoneCirclePlug extends StatelessWidget {
  ...
  /// Creates a DuotoneCirclePlug.
  const DuotoneCirclePlug({
    super.key,
    this.size = 24,
    this.color,
  });
