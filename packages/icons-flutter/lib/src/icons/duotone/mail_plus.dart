...
/// Duotone style MailPlus icon.
///
/// Example:
/// ```dart
/// DuotoneMailPlus(size: 24, color: Colors.blue);
/// ```
class DuotoneMailPlus extends StatelessWidget {
  ...
  /// Creates a DuotoneMailPlus.
  const DuotoneMailPlus({
    super.key,
    this.size = 24,
    this.color,
  });
