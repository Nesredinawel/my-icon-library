...
/// Duotone style MonitorAlt3 icon.
///
/// Example:
/// ```dart
/// DuotoneMonitorAlt3(size: 24, color: Colors.blue);
/// ```
class DuotoneMonitorAlt3 extends StatelessWidget {
  ...
  /// Creates a DuotoneMonitorAlt3.
  const DuotoneMonitorAlt3({
    super.key,
    this.size = 24,
    this.color,
  });
