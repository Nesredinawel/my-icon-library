...
/// Duotone style VolumePlus icon.
///
/// Example:
/// ```dart
/// DuotoneVolumePlus(size: 24, color: Colors.blue);
/// ```
class DuotoneVolumePlus extends StatelessWidget {
  ...
  /// Creates a DuotoneVolumePlus.
  const DuotoneVolumePlus({
    super.key,
    this.size = 24,
    this.color,
  });
