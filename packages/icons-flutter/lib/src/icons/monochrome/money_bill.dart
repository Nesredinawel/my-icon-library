...
/// Monochrome style MoneyBill icon.
///
/// Example:
/// ```dart
/// MonochromeMoneyBill(size: 24, color: Colors.blue);
/// ```
class MonochromeMoneyBill extends StatelessWidget {
  ...
  /// Creates a MonochromeMoneyBill.
  const MonochromeMoneyBill({
    super.key,
    this.size = 24,
    this.color,
  });
