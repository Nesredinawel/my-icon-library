...
/// Monochrome style FolderHeart icon.
///
/// Example:
/// ```dart
/// MonochromeFolderHeart(size: 24, color: Colors.blue);
/// ```
class MonochromeFolderHeart extends StatelessWidget {
  ...
  /// Creates a MonochromeFolderHeart.
  const MonochromeFolderHeart({
    super.key,
    this.size = 24,
    this.color,
  });
