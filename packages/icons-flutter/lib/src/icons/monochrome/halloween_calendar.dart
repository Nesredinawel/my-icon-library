...
/// Monochrome style HalloweenCalendar icon.
///
/// Example:
/// ```dart
/// MonochromeHalloweenCalendar(size: 24, color: Colors.blue);
/// ```
class MonochromeHalloweenCalendar extends StatelessWidget {
  ...
  /// Creates a MonochromeHalloweenCalendar.
  const MonochromeHalloweenCalendar({
    super.key,
    this.size = 24,
    this.color,
  });
