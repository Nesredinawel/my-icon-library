...
/// Monochrome style BatteryEmpty icon.
///
/// Example:
/// ```dart
/// MonochromeBatteryEmpty(size: 24, color: Colors.blue);
/// ```
class MonochromeBatteryEmpty extends StatelessWidget {
  ...
  /// Creates a MonochromeBatteryEmpty.
  const MonochromeBatteryEmpty({
    super.key,
    this.size = 24,
    this.color,
  });
