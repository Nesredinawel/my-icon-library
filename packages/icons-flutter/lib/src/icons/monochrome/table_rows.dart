...
/// Monochrome style TableRows icon.
///
/// Example:
/// ```dart
/// MonochromeTableRows(size: 24, color: Colors.blue);
/// ```
class MonochromeTableRows extends StatelessWidget {
  ...
  /// Creates a MonochromeTableRows.
  const MonochromeTableRows({
    super.key,
    this.size = 24,
    this.color,
  });
