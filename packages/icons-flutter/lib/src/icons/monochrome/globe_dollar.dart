...
/// Monochrome style GlobeDollar icon.
///
/// Example:
/// ```dart
/// MonochromeGlobeDollar(size: 24, color: Colors.blue);
/// ```
class MonochromeGlobeDollar extends StatelessWidget {
  ...
  /// Creates a MonochromeGlobeDollar.
  const MonochromeGlobeDollar({
    super.key,
    this.size = 24,
    this.color,
  });
