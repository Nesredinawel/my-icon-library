...
/// Monochrome style ArrowNarrowCircleBrokenDownRight icon.
///
/// Example:
/// ```dart
/// MonochromeArrowNarrowCircleBrokenDownRight(size: 24, color: Colors.blue);
/// ```
class MonochromeArrowNarrowCircleBrokenDownRight extends StatelessWidget {
  ...
  /// Creates a MonochromeArrowNarrowCircleBrokenDownRight.
