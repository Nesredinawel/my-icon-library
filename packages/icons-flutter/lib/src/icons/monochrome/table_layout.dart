...
/// Monochrome style TableLayout icon.
///
/// Example:
/// ```dart
/// MonochromeTableLayout(size: 24, color: Colors.blue);
/// ```
class MonochromeTableLayout extends StatelessWidget {
  ...
  /// Creates a MonochromeTableLayout.
  const MonochromeTableLayout({
    super.key,
    this.size = 24,
    this.color,
  });
