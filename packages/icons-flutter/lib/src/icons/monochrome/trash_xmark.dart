...
/// Monochrome style TrashXmark icon.
///
/// Example:
/// ```dart
/// MonochromeTrashXmark(size: 24, color: Colors.blue);
/// ```
class MonochromeTrashXmark extends StatelessWidget {
  ...
  /// Creates a MonochromeTrashXmark.
  const MonochromeTrashXmark({
    super.key,
    this.size = 24,
    this.color,
  });
