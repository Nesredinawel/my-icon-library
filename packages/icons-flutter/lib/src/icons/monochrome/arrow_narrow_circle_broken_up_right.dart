...
/// Monochrome style ArrowNarrowCircleBrokenUpRight icon.
///
/// Example:
/// ```dart
/// MonochromeArrowNarrowCircleBrokenUpRight(size: 24, color: Colors.blue);
/// ```
class MonochromeArrowNarrowCircleBrokenUpRight extends StatelessWidget {
  ...
  /// Creates a MonochromeArrowNarrowCircleBrokenUpRight.
