...
/// Monochrome style LightEmergencyOn icon.
///
/// Example:
/// ```dart
/// MonochromeLightEmergencyOn(size: 24, color: Colors.blue);
/// ```
class MonochromeLightEmergencyOn extends StatelessWidget {
  ...
  /// Creates a MonochromeLightEmergencyOn.
  const MonochromeLightEmergencyOn({
    super.key,
    this.size = 24,
    this.color,
  });
