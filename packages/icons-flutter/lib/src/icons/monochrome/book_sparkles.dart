...
/// Monochrome style BookSparkles icon.
///
/// Example:
/// ```dart
/// MonochromeBookSparkles(size: 24, color: Colors.blue);
/// ```
class MonochromeBookSparkles extends StatelessWidget {
  ...
  /// Creates a MonochromeBookSparkles.
  const MonochromeBookSparkles({
    super.key,
    this.size = 24,
    this.color,
  });
