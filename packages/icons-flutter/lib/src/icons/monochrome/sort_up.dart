...
/// Monochrome style SortUp icon.
///
/// Example:
/// ```dart
/// MonochromeSortUp(size: 24, color: Colors.blue);
/// ```
class MonochromeSortUp extends StatelessWidget {
  ...
  /// Creates a MonochromeSortUp.
  const MonochromeSortUp({
    super.key,
    this.size = 24,
    this.color,
  });
