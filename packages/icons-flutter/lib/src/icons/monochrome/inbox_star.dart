...
/// Monochrome style InboxStar icon.
///
/// Example:
/// ```dart
/// MonochromeInboxStar(size: 24, color: Colors.blue);
/// ```
class MonochromeInboxStar extends StatelessWidget {
  ...
  /// Creates a MonochromeInboxStar.
  const MonochromeInboxStar({
    super.key,
    this.size = 24,
    this.color,
  });
