...
/// Monochrome style MoneyCheckPen icon.
///
/// Example:
/// ```dart
/// MonochromeMoneyCheckPen(size: 24, color: Colors.blue);
/// ```
class MonochromeMoneyCheckPen extends StatelessWidget {
  ...
  /// Creates a MonochromeMoneyCheckPen.
  const MonochromeMoneyCheckPen({
    super.key,
    this.size = 24,
    this.color,
  });
