...
/// Monochrome style DistributeSpacingHorizontal icon.
///
/// Example:
/// ```dart
/// MonochromeDistributeSpacingHorizontal(size: 24, color: Colors.blue);
/// ```
class MonochromeDistributeSpacingHorizontal extends StatelessWidget {
  ...
  /// Creates a MonochromeDistributeSpacingHorizontal.
