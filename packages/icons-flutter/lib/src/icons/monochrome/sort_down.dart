...
/// Monochrome style SortDown icon.
///
/// Example:
/// ```dart
/// MonochromeSortDown(size: 24, color: Colors.blue);
/// ```
class MonochromeSortDown extends StatelessWidget {
  ...
  /// Creates a MonochromeSortDown.
  const MonochromeSortDown({
    super.key,
    this.size = 24,
    this.color,
  });
