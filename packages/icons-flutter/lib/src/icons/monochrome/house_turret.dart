...
/// Monochrome style HouseTurret icon.
///
/// Example:
/// ```dart
/// MonochromeHouseTurret(size: 24, color: Colors.blue);
/// ```
class MonochromeHouseTurret extends StatelessWidget {
  ...
  /// Creates a MonochromeHouseTurret.
  const MonochromeHouseTurret({
    super.key,
    this.size = 24,
    this.color,
  });
