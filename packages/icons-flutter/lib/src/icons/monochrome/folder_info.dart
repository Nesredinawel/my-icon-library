...
/// Monochrome style FolderInfo icon.
///
/// Example:
/// ```dart
/// MonochromeFolderInfo(size: 24, color: Colors.blue);
/// ```
class MonochromeFolderInfo extends StatelessWidget {
  ...
  /// Creates a MonochromeFolderInfo.
  const MonochromeFolderInfo({
    super.key,
    this.size = 24,
    this.color,
  });
