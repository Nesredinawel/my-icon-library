...
/// Monochrome style CalendarArrowDown icon.
///
/// Example:
/// ```dart
/// MonochromeCalendarArrowDown(size: 24, color: Colors.blue);
/// ```
class MonochromeCalendarArrowDown extends StatelessWidget {
  ...
  /// Creates a MonochromeCalendarArrowDown.
  const MonochromeCalendarArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
