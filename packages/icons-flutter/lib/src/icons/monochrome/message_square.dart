...
/// Monochrome style MessageSquare icon.
///
/// Example:
/// ```dart
/// MonochromeMessageSquare(size: 24, color: Colors.blue);
/// ```
class MonochromeMessageSquare extends StatelessWidget {
  ...
  /// Creates a MonochromeMessageSquare.
  const MonochromeMessageSquare({
    super.key,
    this.size = 24,
    this.color,
  });
