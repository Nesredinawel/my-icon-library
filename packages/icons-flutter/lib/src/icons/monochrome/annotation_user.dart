...
/// Monochrome style AnnotationUser icon.
///
/// Example:
/// ```dart
/// MonochromeAnnotationUser(size: 24, color: Colors.blue);
/// ```
class MonochromeAnnotationUser extends StatelessWidget {
  ...
  /// Creates a MonochromeAnnotationUser.
  const MonochromeAnnotationUser({
    super.key,
    this.size = 24,
    this.color,
  });
