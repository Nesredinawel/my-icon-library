...
/// Monochrome style SquareCheck icon.
///
/// Example:
/// ```dart
/// MonochromeSquareCheck(size: 24, color: Colors.blue);
/// ```
class MonochromeSquareCheck extends StatelessWidget {
  ...
  /// Creates a MonochromeSquareCheck.
  const MonochromeSquareCheck({
    super.key,
    this.size = 24,
    this.color,
  });
