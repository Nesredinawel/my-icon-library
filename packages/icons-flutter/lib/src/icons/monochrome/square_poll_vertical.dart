...
/// Monochrome style SquarePollVertical icon.
///
/// Example:
/// ```dart
/// MonochromeSquarePollVertical(size: 24, color: Colors.blue);
/// ```
class MonochromeSquarePollVertical extends StatelessWidget {
  ...
  /// Creates a MonochromeSquarePollVertical.
  const MonochromeSquarePollVertical({
    super.key,
    this.size = 24,
    this.color,
  });
