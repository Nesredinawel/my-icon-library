...
/// Monochrome style Folder icon.
///
/// Example:
/// ```dart
/// MonochromeFolder(size: 24, color: Colors.blue);
/// ```
class MonochromeFolder extends StatelessWidget {
  ...
  /// Creates a MonochromeFolder.
  const MonochromeFolder({
    super.key,
    this.size = 24,
    this.color,
  });
