...
/// Monochrome style ObjectsAlignCenterHorizontal icon.
///
/// Example:
/// ```dart
/// MonochromeObjectsAlignCenterHorizontal(size: 24, color: Colors.blue);
/// ```
class MonochromeObjectsAlignCenterHorizontal extends StatelessWidget {
  ...
  /// Creates a MonochromeObjectsAlignCenterHorizontal.
