...
/// Monochrome style CalendarExclamationAlt icon.
///
/// Example:
/// ```dart
/// MonochromeCalendarExclamationAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeCalendarExclamationAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeCalendarExclamationAlt.
  const MonochromeCalendarExclamationAlt({
    super.key,
    this.size = 24,
    this.color,
  });
