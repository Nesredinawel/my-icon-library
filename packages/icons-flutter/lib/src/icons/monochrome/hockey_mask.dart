...
/// Monochrome style HockeyMask icon.
///
/// Example:
/// ```dart
/// MonochromeHockeyMask(size: 24, color: Colors.blue);
/// ```
class MonochromeHockeyMask extends StatelessWidget {
  ...
  /// Creates a MonochromeHockeyMask.
  const MonochromeHockeyMask({
    super.key,
    this.size = 24,
    this.color,
  });
