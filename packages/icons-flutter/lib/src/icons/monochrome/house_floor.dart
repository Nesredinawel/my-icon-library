...
/// Monochrome style HouseFloor icon.
///
/// Example:
/// ```dart
/// MonochromeHouseFloor(size: 24, color: Colors.blue);
/// ```
class MonochromeHouseFloor extends StatelessWidget {
  ...
  /// Creates a MonochromeHouseFloor.
  const MonochromeHouseFloor({
    super.key,
    this.size = 24,
    this.color,
  });
