...
/// Monochrome style BatteryLow icon.
///
/// Example:
/// ```dart
/// MonochromeBatteryLow(size: 24, color: Colors.blue);
/// ```
class MonochromeBatteryLow extends StatelessWidget {
  ...
  /// Creates a MonochromeBatteryLow.
  const MonochromeBatteryLow({
    super.key,
    this.size = 24,
    this.color,
  });
