...
/// Monochrome style CalendarPlus icon.
///
/// Example:
/// ```dart
/// MonochromeCalendarPlus(size: 24, color: Colors.blue);
/// ```
class MonochromeCalendarPlus extends StatelessWidget {
  ...
  /// Creates a MonochromeCalendarPlus.
  const MonochromeCalendarPlus({
    super.key,
    this.size = 24,
    this.color,
  });
