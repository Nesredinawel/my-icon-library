...
/// Monochrome style DesktopComputer icon.
///
/// Example:
/// ```dart
/// MonochromeDesktopComputer(size: 24, color: Colors.blue);
/// ```
class MonochromeDesktopComputer extends StatelessWidget {
  ...
  /// Creates a MonochromeDesktopComputer.
  const MonochromeDesktopComputer({
    super.key,
    this.size = 24,
    this.color,
  });
