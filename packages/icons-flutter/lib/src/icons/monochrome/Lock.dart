...
/// Monochrome style Lock icon.
///
/// Example:
/// ```dart
/// MonochromeLock(size: 24, color: Colors.blue);
/// ```
class MonochromeLock extends StatelessWidget {
  ...
  /// Creates a MonochromeLock.
  const MonochromeLock({
    super.key,
    this.size = 24,
    this.color,
  });
