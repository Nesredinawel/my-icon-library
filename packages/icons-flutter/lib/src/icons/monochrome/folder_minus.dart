...
/// Monochrome style FolderMinus icon.
///
/// Example:
/// ```dart
/// MonochromeFolderMinus(size: 24, color: Colors.blue);
/// ```
class MonochromeFolderMinus extends StatelessWidget {
  ...
  /// Creates a MonochromeFolderMinus.
  const MonochromeFolderMinus({
    super.key,
    this.size = 24,
    this.color,
  });
