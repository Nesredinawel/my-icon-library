...
/// Monochrome style ClipboardListAlt icon.
///
/// Example:
/// ```dart
/// MonochromeClipboardListAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeClipboardListAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeClipboardListAlt.
  const MonochromeClipboardListAlt({
    super.key,
    this.size = 24,
    this.color,
  });
