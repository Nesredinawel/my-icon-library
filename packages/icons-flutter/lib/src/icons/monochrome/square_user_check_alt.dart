...
/// Monochrome style SquareUserCheckAlt icon.
///
/// Example:
/// ```dart
/// MonochromeSquareUserCheckAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeSquareUserCheckAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeSquareUserCheckAlt.
  const MonochromeSquareUserCheckAlt({
    super.key,
    this.size = 24,
    this.color,
  });
