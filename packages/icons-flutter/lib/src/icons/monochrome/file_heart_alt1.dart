...
/// Monochrome style FileHeartAlt1 icon.
///
/// Example:
/// ```dart
/// MonochromeFileHeartAlt1(size: 24, color: Colors.blue);
/// ```
class MonochromeFileHeartAlt1 extends StatelessWidget {
  ...
  /// Creates a MonochromeFileHeartAlt1.
  const MonochromeFileHeartAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
