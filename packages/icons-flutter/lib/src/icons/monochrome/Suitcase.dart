...
/// Monochrome style Suitcase icon.
///
/// Example:
/// ```dart
/// MonochromeSuitcase(size: 24, color: Colors.blue);
/// ```
class MonochromeSuitcase extends StatelessWidget {
  ...
  /// Creates a MonochromeSuitcase.
  const MonochromeSuitcase({
    super.key,
    this.size = 24,
    this.color,
  });
