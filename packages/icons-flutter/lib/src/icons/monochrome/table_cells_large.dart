...
/// Monochrome style TableCellsLarge icon.
///
/// Example:
/// ```dart
/// MonochromeTableCellsLarge(size: 24, color: Colors.blue);
/// ```
class MonochromeTableCellsLarge extends StatelessWidget {
  ...
  /// Creates a MonochromeTableCellsLarge.
  const MonochromeTableCellsLarge({
    super.key,
    this.size = 24,
    this.color,
  });
