...
/// Monochrome style TrashUndoAlt icon.
///
/// Example:
/// ```dart
/// MonochromeTrashUndoAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeTrashUndoAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeTrashUndoAlt.
  const MonochromeTrashUndoAlt({
    super.key,
    this.size = 24,
    this.color,
  });
