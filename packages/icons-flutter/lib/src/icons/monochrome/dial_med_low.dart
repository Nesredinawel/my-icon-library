...
/// Monochrome style DialMedLow icon.
///
/// Example:
/// ```dart
/// MonochromeDialMedLow(size: 24, color: Colors.blue);
/// ```
class MonochromeDialMedLow extends StatelessWidget {
  ...
  /// Creates a MonochromeDialMedLow.
  const MonochromeDialMedLow({
    super.key,
    this.size = 24,
    this.color,
  });
