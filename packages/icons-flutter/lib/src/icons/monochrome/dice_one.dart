...
/// Monochrome style DiceOne icon.
///
/// Example:
/// ```dart
/// MonochromeDiceOne(size: 24, color: Colors.blue);
/// ```
class MonochromeDiceOne extends StatelessWidget {
  ...
  /// Creates a MonochromeDiceOne.
  const MonochromeDiceOne({
    super.key,
    this.size = 24,
    this.color,
  });
