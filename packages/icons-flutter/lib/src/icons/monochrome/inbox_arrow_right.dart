...
/// Monochrome style InboxArrowRight icon.
///
/// Example:
/// ```dart
/// MonochromeInboxArrowRight(size: 24, color: Colors.blue);
/// ```
class MonochromeInboxArrowRight extends StatelessWidget {
  ...
  /// Creates a MonochromeInboxArrowRight.
  const MonochromeInboxArrowRight({
    super.key,
    this.size = 24,
    this.color,
  });
