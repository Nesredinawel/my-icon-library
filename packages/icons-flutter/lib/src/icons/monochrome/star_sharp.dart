...
/// Monochrome style StarSharp icon.
///
/// Example:
/// ```dart
/// MonochromeStarSharp(size: 24, color: Colors.blue);
/// ```
class MonochromeStarSharp extends StatelessWidget {
  ...
  /// Creates a MonochromeStarSharp.
  const MonochromeStarSharp({
    super.key,
    this.size = 24,
    this.color,
  });
