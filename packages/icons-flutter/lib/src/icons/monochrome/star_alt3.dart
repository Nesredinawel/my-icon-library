...
/// Monochrome style StarAlt3 icon.
///
/// Example:
/// ```dart
/// MonochromeStarAlt3(size: 24, color: Colors.blue);
/// ```
class MonochromeStarAlt3 extends StatelessWidget {
  ...
  /// Creates a MonochromeStarAlt3.
  const MonochromeStarAlt3({
    super.key,
    this.size = 24,
    this.color,
  });
