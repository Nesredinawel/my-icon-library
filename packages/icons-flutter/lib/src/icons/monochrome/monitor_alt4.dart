...
/// Monochrome style MonitorAlt4 icon.
///
/// Example:
/// ```dart
/// MonochromeMonitorAlt4(size: 24, color: Colors.blue);
/// ```
class MonochromeMonitorAlt4 extends StatelessWidget {
  ...
  /// Creates a MonochromeMonitorAlt4.
  const MonochromeMonitorAlt4({
    super.key,
    this.size = 24,
    this.color,
  });
