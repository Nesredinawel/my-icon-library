...
/// Monochrome style CalendarLines icon.
///
/// Example:
/// ```dart
/// MonochromeCalendarLines(size: 24, color: Colors.blue);
/// ```
class MonochromeCalendarLines extends StatelessWidget {
  ...
  /// Creates a MonochromeCalendarLines.
  const MonochromeCalendarLines({
    super.key,
    this.size = 24,
    this.color,
  });
