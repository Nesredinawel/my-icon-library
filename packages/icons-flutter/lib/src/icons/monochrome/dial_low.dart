...
/// Monochrome style DialLow icon.
///
/// Example:
/// ```dart
/// MonochromeDialLow(size: 24, color: Colors.blue);
/// ```
class MonochromeDialLow extends StatelessWidget {
  ...
  /// Creates a MonochromeDialLow.
  const MonochromeDialLow({
    super.key,
    this.size = 24,
    this.color,
  });
