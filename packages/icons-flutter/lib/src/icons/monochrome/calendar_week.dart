...
/// Monochrome style CalendarWeek icon.
///
/// Example:
/// ```dart
/// MonochromeCalendarWeek(size: 24, color: Colors.blue);
/// ```
class MonochromeCalendarWeek extends StatelessWidget {
  ...
  /// Creates a MonochromeCalendarWeek.
  const MonochromeCalendarWeek({
    super.key,
    this.size = 24,
    this.color,
  });
