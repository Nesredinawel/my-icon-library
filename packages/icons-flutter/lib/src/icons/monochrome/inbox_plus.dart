...
/// Monochrome style InboxPlus icon.
///
/// Example:
/// ```dart
/// MonochromeInboxPlus(size: 24, color: Colors.blue);
/// ```
class MonochromeInboxPlus extends StatelessWidget {
  ...
  /// Creates a MonochromeInboxPlus.
  const MonochromeInboxPlus({
    super.key,
    this.size = 24,
    this.color,
  });
