...
/// Monochrome style MoneyStack icon.
///
/// Example:
/// ```dart
/// MonochromeMoneyStack(size: 24, color: Colors.blue);
/// ```
class MonochromeMoneyStack extends StatelessWidget {
  ...
  /// Creates a MonochromeMoneyStack.
  const MonochromeMoneyStack({
    super.key,
    this.size = 24,
    this.color,
  });
