...
/// Monochrome style ChevronSelectorVerticalDot icon.
///
/// Example:
/// ```dart
/// MonochromeChevronSelectorVerticalDot(size: 24, color: Colors.blue);
/// ```
class MonochromeChevronSelectorVerticalDot extends StatelessWidget {
  ...
  /// Creates a MonochromeChevronSelectorVerticalDot.
