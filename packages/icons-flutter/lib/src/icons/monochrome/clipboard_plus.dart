...
/// Monochrome style ClipboardPlus icon.
///
/// Example:
/// ```dart
/// MonochromeClipboardPlus(size: 24, color: Colors.blue);
/// ```
class MonochromeClipboardPlus extends StatelessWidget {
  ...
  /// Creates a MonochromeClipboardPlus.
  const MonochromeClipboardPlus({
    super.key,
    this.size = 24,
    this.color,
  });
