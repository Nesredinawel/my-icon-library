...
/// Monochrome style HexagonAlt1 icon.
///
/// Example:
/// ```dart
/// MonochromeHexagonAlt1(size: 24, color: Colors.blue);
/// ```
class MonochromeHexagonAlt1 extends StatelessWidget {
  ...
  /// Creates a MonochromeHexagonAlt1.
  const MonochromeHexagonAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
