...
/// Monochrome style AwardAlt icon.
///
/// Example:
/// ```dart
/// MonochromeAwardAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeAwardAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeAwardAlt.
  const MonochromeAwardAlt({
    super.key,
    this.size = 24,
    this.color,
  });
