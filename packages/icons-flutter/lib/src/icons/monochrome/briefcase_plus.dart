...
/// Monochrome style BriefcasePlus icon.
///
/// Example:
/// ```dart
/// MonochromeBriefcasePlus(size: 24, color: Colors.blue);
/// ```
class MonochromeBriefcasePlus extends StatelessWidget {
  ...
  /// Creates a MonochromeBriefcasePlus.
  const MonochromeBriefcasePlus({
    super.key,
    this.size = 24,
    this.color,
  });
