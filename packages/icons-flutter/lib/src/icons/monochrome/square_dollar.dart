...
/// Monochrome style SquareDollar icon.
///
/// Example:
/// ```dart
/// MonochromeSquareDollar(size: 24, color: Colors.blue);
/// ```
class MonochromeSquareDollar extends StatelessWidget {
  ...
  /// Creates a MonochromeSquareDollar.
  const MonochromeSquareDollar({
    super.key,
    this.size = 24,
    this.color,
  });
