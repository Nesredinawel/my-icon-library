...
/// Monochrome style TrashClock icon.
///
/// Example:
/// ```dart
/// MonochromeTrashClock(size: 24, color: Colors.blue);
/// ```
class MonochromeTrashClock extends StatelessWidget {
  ...
  /// Creates a MonochromeTrashClock.
  const MonochromeTrashClock({
    super.key,
    this.size = 24,
    this.color,
  });
