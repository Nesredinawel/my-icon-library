...
/// Monochrome style MobileAlt icon.
///
/// Example:
/// ```dart
/// MonochromeMobileAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeMobileAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeMobileAlt.
  const MonochromeMobileAlt({
    super.key,
    this.size = 24,
    this.color,
  });
