...
/// Monochrome style ArrowDownSmallBig icon.
///
/// Example:
/// ```dart
/// MonochromeArrowDownSmallBig(size: 24, color: Colors.blue);
/// ```
class MonochromeArrowDownSmallBig extends StatelessWidget {
  ...
  /// Creates a MonochromeArrowDownSmallBig.
  const MonochromeArrowDownSmallBig({
    super.key,
    this.size = 24,
    this.color,
  });
