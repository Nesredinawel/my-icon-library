...
/// Monochrome style BatteryExclamation icon.
///
/// Example:
/// ```dart
/// MonochromeBatteryExclamation(size: 24, color: Colors.blue);
/// ```
class MonochromeBatteryExclamation extends StatelessWidget {
  ...
  /// Creates a MonochromeBatteryExclamation.
  const MonochromeBatteryExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
