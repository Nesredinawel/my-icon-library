...
/// Monochrome style TowerBroadcast icon.
///
/// Example:
/// ```dart
/// MonochromeTowerBroadcast(size: 24, color: Colors.blue);
/// ```
class MonochromeTowerBroadcast extends StatelessWidget {
  ...
  /// Creates a MonochromeTowerBroadcast.
  const MonochromeTowerBroadcast({
    super.key,
    this.size = 24,
    this.color,
  });
