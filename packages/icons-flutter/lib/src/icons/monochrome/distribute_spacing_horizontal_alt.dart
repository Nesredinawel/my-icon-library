...
/// Monochrome style DistributeSpacingHorizontalAlt icon.
///
/// Example:
/// ```dart
/// MonochromeDistributeSpacingHorizontalAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeDistributeSpacingHorizontalAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeDistributeSpacingHorizontalAlt.
