...
/// Monochrome style InboxXmark icon.
///
/// Example:
/// ```dart
/// MonochromeInboxXmark(size: 24, color: Colors.blue);
/// ```
class MonochromeInboxXmark extends StatelessWidget {
  ...
  /// Creates a MonochromeInboxXmark.
  const MonochromeInboxXmark({
    super.key,
    this.size = 24,
    this.color,
  });
