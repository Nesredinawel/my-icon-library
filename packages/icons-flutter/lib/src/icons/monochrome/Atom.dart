...
/// Monochrome style Atom icon.
///
/// Example:
/// ```dart
/// MonochromeAtom(size: 24, color: Colors.blue);
/// ```
class MonochromeAtom extends StatelessWidget {
  ...
  /// Creates a MonochromeAtom.
  const MonochromeAtom({
    super.key,
    this.size = 24,
    this.color,
  });
