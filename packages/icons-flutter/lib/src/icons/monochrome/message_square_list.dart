...
/// Monochrome style MessageSquareList icon.
///
/// Example:
/// ```dart
/// MonochromeMessageSquareList(size: 24, color: Colors.blue);
/// ```
class MonochromeMessageSquareList extends StatelessWidget {
  ...
  /// Creates a MonochromeMessageSquareList.
  const MonochromeMessageSquareList({
    super.key,
    this.size = 24,
    this.color,
  });
