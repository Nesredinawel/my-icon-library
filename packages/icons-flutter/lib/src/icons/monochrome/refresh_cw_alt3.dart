...
/// Monochrome style RefreshCwAlt3 icon.
///
/// Example:
/// ```dart
/// MonochromeRefreshCwAlt3(size: 24, color: Colors.blue);
/// ```
class MonochromeRefreshCwAlt3 extends StatelessWidget {
  ...
  /// Creates a MonochromeRefreshCwAlt3.
  const MonochromeRefreshCwAlt3({
    super.key,
    this.size = 24,
    this.color,
  });
