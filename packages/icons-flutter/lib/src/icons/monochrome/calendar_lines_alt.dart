...
/// Monochrome style CalendarLinesAlt icon.
///
/// Example:
/// ```dart
/// MonochromeCalendarLinesAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeCalendarLinesAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeCalendarLinesAlt.
  const MonochromeCalendarLinesAlt({
    super.key,
    this.size = 24,
    this.color,
  });
