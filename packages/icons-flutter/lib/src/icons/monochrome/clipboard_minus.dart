...
/// Monochrome style ClipboardMinus icon.
///
/// Example:
/// ```dart
/// MonochromeClipboardMinus(size: 24, color: Colors.blue);
/// ```
class MonochromeClipboardMinus extends StatelessWidget {
  ...
  /// Creates a MonochromeClipboardMinus.
  const MonochromeClipboardMinus({
    super.key,
    this.size = 24,
    this.color,
  });
