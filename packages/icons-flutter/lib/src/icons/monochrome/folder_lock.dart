...
/// Monochrome style FolderLock icon.
///
/// Example:
/// ```dart
/// MonochromeFolderLock(size: 24, color: Colors.blue);
/// ```
class MonochromeFolderLock extends StatelessWidget {
  ...
  /// Creates a MonochromeFolderLock.
  const MonochromeFolderLock({
    super.key,
    this.size = 24,
    this.color,
  });
