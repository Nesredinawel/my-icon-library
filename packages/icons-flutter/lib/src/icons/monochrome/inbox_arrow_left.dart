...
/// Monochrome style InboxArrowLeft icon.
///
/// Example:
/// ```dart
/// MonochromeInboxArrowLeft(size: 24, color: Colors.blue);
/// ```
class MonochromeInboxArrowLeft extends StatelessWidget {
  ...
  /// Creates a MonochromeInboxArrowLeft.
  const MonochromeInboxArrowLeft({
    super.key,
    this.size = 24,
    this.color,
  });
