...
/// Monochrome style ObjectsAlignCenterVertical icon.
///
/// Example:
/// ```dart
/// MonochromeObjectsAlignCenterVertical(size: 24, color: Colors.blue);
/// ```
class MonochromeObjectsAlignCenterVertical extends StatelessWidget {
  ...
  /// Creates a MonochromeObjectsAlignCenterVertical.
