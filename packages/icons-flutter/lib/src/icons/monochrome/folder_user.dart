...
/// Monochrome style FolderUser icon.
///
/// Example:
/// ```dart
/// MonochromeFolderUser(size: 24, color: Colors.blue);
/// ```
class MonochromeFolderUser extends StatelessWidget {
  ...
  /// Creates a MonochromeFolderUser.
  const MonochromeFolderUser({
    super.key,
    this.size = 24,
    this.color,
  });
