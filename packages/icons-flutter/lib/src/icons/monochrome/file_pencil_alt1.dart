...
/// Monochrome style FilePencilAlt1 icon.
///
/// Example:
/// ```dart
/// MonochromeFilePencilAlt1(size: 24, color: Colors.blue);
/// ```
class MonochromeFilePencilAlt1 extends StatelessWidget {
  ...
  /// Creates a MonochromeFilePencilAlt1.
  const MonochromeFilePencilAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
