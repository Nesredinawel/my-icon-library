...
/// Monochrome style CircleVideo icon.
///
/// Example:
/// ```dart
/// MonochromeCircleVideo(size: 24, color: Colors.blue);
/// ```
class MonochromeCircleVideo extends StatelessWidget {
  ...
  /// Creates a MonochromeCircleVideo.
  const MonochromeCircleVideo({
    super.key,
    this.size = 24,
    this.color,
  });
