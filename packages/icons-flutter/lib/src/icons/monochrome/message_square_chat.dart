...
/// Monochrome style MessageSquareChat icon.
///
/// Example:
/// ```dart
/// MonochromeMessageSquareChat(size: 24, color: Colors.blue);
/// ```
class MonochromeMessageSquareChat extends StatelessWidget {
  ...
  /// Creates a MonochromeMessageSquareChat.
  const MonochromeMessageSquareChat({
    super.key,
    this.size = 24,
    this.color,
  });
