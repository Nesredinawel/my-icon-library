...
class MonochromeClipboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return NasIcon(
      svg: '''
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path fill="currentColor" d="M4 8.8c0-1.68 0-2.52.33-3.16a3 3 0 0 1 1.3-1.31C6.29 4 7.13 4 8.8 4h6.4c1.68 0 2.52 0 3.16.33a3 3 0 0 1 1.31 1.3c.33.65.33 1.49.33 3.17v8.4c0 1.68 0 2.52-.33 3.16a3 3 0 0 1-1.3 1.31c-.65.33-1.49.33-3.17.33H8.8c-1.68 0-2.52 0-3.16-.33a3 3 0 0 1-1.31-1.3C4 19.71 4 18.87 4 17.2z" opacity=".3"/><path fill="currentColor" d="M7 5.75c0-.7 0-1.05.06-1.34A3 3 0 0 1 9.4 2.06C9.7 2 10.04 2 10.74 2h2.5c.7 0 1.05 0 1.34.06a3 3 0 0 1 2.35 2.35c.06.3.06.64.06 1.34 0 .23 0 .35-.02.45a1 1 0 0 1-.78.78c-.1.02-.22.02-.45.02h-7.5c-.23 0-.35 0-.45-.02a1 1 0 0 1-.78-.78z"/></svg>
''',
      size: size,
      color: color,
    );
