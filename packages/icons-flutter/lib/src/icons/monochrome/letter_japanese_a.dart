...
/// Monochrome style LetterJapaneseA icon.
///
/// Example:
/// ```dart
/// MonochromeLetterJapaneseA(size: 24, color: Colors.blue);
/// ```
class MonochromeLetterJapaneseA extends StatelessWidget {
  ...
  /// Creates a MonochromeLetterJapaneseA.
  const MonochromeLetterJapaneseA({
    super.key,
    this.size = 24,
    this.color,
  });
