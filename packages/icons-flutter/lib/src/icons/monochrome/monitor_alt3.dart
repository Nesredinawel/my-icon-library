...
/// Monochrome style MonitorAlt3 icon.
///
/// Example:
/// ```dart
/// MonochromeMonitorAlt3(size: 24, color: Colors.blue);
/// ```
class MonochromeMonitorAlt3 extends StatelessWidget {
  ...
  /// Creates a MonochromeMonitorAlt3.
  const MonochromeMonitorAlt3({
    super.key,
    this.size = 24,
    this.color,
  });
