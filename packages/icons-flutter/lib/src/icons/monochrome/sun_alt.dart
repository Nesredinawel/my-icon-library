...
/// Monochrome style SunAlt icon.
///
/// Example:
/// ```dart
/// MonochromeSunAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeSunAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeSunAlt.
  const MonochromeSunAlt({
    super.key,
    this.size = 24,
    this.color,
  });
