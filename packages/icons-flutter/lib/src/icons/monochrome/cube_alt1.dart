...
/// Monochrome style CubeAlt1 icon.
///
/// Example:
/// ```dart
/// MonochromeCubeAlt1(size: 24, color: Colors.blue);
/// ```
class MonochromeCubeAlt1 extends StatelessWidget {
  ...
  /// Creates a MonochromeCubeAlt1.
  const MonochromeCubeAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
