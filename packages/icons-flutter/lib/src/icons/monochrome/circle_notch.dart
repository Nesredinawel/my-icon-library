...
/// Monochrome style CircleNotch icon.
///
/// Example:
/// ```dart
/// MonochromeCircleNotch(size: 24, color: Colors.blue);
/// ```
class MonochromeCircleNotch extends StatelessWidget {
  ...
  /// Creates a MonochromeCircleNotch.
  const MonochromeCircleNotch({
    super.key,
    this.size = 24,
    this.color,
  });
