...
/// Monochrome style Mobile icon.
///
/// Example:
/// ```dart
/// MonochromeMobile(size: 24, color: Colors.blue);
/// ```
class MonochromeMobile extends StatelessWidget {
  ...
  /// Creates a MonochromeMobile.
  const MonochromeMobile({
    super.key,
    this.size = 24,
    this.color,
  });
