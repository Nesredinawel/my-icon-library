...
/// Monochrome style MobileAlt1 icon.
///
/// Example:
/// ```dart
/// MonochromeMobileAlt1(size: 24, color: Colors.blue);
/// ```
class MonochromeMobileAlt1 extends StatelessWidget {
  ...
  /// Creates a MonochromeMobileAlt1.
  const MonochromeMobileAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
