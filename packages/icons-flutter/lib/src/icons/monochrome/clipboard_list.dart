...
/// Monochrome style ClipboardList icon.
///
/// Example:
/// ```dart
/// MonochromeClipboardList(size: 24, color: Colors.blue);
/// ```
class MonochromeClipboardList extends StatelessWidget {
  ...
  /// Creates a MonochromeClipboardList.
  const MonochromeClipboardList({
    super.key,
    this.size = 24,
    this.color,
  });
