...
/// Monochrome style CalendarXmarkAlt icon.
///
/// Example:
/// ```dart
/// MonochromeCalendarXmarkAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeCalendarXmarkAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeCalendarXmarkAlt.
  const MonochromeCalendarXmarkAlt({
    super.key,
    this.size = 24,
    this.color,
  });
