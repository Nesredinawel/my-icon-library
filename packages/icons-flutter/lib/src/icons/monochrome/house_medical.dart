...
/// Monochrome style HouseMedical icon.
///
/// Example:
/// ```dart
/// MonochromeHouseMedical(size: 24, color: Colors.blue);
/// ```
class MonochromeHouseMedical extends StatelessWidget {
  ...
  /// Creates a MonochromeHouseMedical.
  const MonochromeHouseMedical({
    super.key,
    this.size = 24,
    this.color,
  });
