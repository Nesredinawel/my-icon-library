...
/// Monochrome style FolderPlus icon.
///
/// Example:
/// ```dart
/// MonochromeFolderPlus(size: 24, color: Colors.blue);
/// ```
class MonochromeFolderPlus extends StatelessWidget {
  ...
  /// Creates a MonochromeFolderPlus.
  const MonochromeFolderPlus({
    super.key,
    this.size = 24,
    this.color,
  });
