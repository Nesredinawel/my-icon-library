...
/// Monochrome style CaretRight icon.
///
/// Example:
/// ```dart
/// MonochromeCaretRight(size: 24, color: Colors.blue);
/// ```
class MonochromeCaretRight extends StatelessWidget {
  ...
  /// Creates a MonochromeCaretRight.
  const MonochromeCaretRight({
    super.key,
    this.size = 24,
    this.color,
  });
