...
/// Monochrome style BookOpen icon.
///
/// Example:
/// ```dart
/// MonochromeBookOpen(size: 24, color: Colors.blue);
/// ```
class MonochromeBookOpen extends StatelessWidget {
  ...
  /// Creates a MonochromeBookOpen.
  const MonochromeBookOpen({
    super.key,
    this.size = 24,
    this.color,
  });
