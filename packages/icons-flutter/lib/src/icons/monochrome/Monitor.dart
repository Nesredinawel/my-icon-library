...
/// Monochrome style Monitor icon.
///
/// Example:
/// ```dart
/// MonochromeMonitor(size: 24, color: Colors.blue);
/// ```
class MonochromeMonitor extends StatelessWidget {
