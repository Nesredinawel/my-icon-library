...
/// Monochrome style RectangleXmark icon.
///
/// Example:
/// ```dart
/// MonochromeRectangleXmark(size: 24, color: Colors.blue);
/// ```
class MonochromeRectangleXmark extends StatelessWidget {
  ...
  /// Creates a MonochromeRectangleXmark.
  const MonochromeRectangleXmark({
    super.key,
    this.size = 24,
    this.color,
  });
