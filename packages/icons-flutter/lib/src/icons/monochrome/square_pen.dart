...
/// Monochrome style SquarePen icon.
///
/// Example:
/// ```dart
/// MonochromeSquarePen(size: 24, color: Colors.blue);
/// ```
class MonochromeSquarePen extends StatelessWidget {
  ...
  /// Creates a MonochromeSquarePen.
  const MonochromeSquarePen({
    super.key,
    this.size = 24,
    this.color,
  });
