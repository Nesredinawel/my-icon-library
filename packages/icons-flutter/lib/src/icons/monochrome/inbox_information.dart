...
/// Monochrome style InboxInformation icon.
///
/// Example:
/// ```dart
/// MonochromeInboxInformation(size: 24, color: Colors.blue);
/// ```
class MonochromeInboxInformation extends StatelessWidget {
  ...
  /// Creates a MonochromeInboxInformation.
  const MonochromeInboxInformation({
    super.key,
    this.size = 24,
    this.color,
  });
