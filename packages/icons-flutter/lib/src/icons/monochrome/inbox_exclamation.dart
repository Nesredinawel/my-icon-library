...
/// Monochrome style InboxExclamation icon.
///
/// Example:
/// ```dart
/// MonochromeInboxExclamation(size: 24, color: Colors.blue);
/// ```
class MonochromeInboxExclamation extends StatelessWidget {
  ...
  /// Creates a MonochromeInboxExclamation.
  const MonochromeInboxExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
