...
/// Monochrome style InboxArrowDown icon.
///
/// Example:
/// ```dart
/// MonochromeInboxArrowDown(size: 24, color: Colors.blue);
/// ```
class MonochromeInboxArrowDown extends StatelessWidget {
  ...
  /// Creates a MonochromeInboxArrowDown.
  const MonochromeInboxArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
