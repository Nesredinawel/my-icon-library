...
/// Monochrome style CalendarArrowUp icon.
///
/// Example:
/// ```dart
/// MonochromeCalendarArrowUp(size: 24, color: Colors.blue);
/// ```
class MonochromeCalendarArrowUp extends StatelessWidget {
  ...
  /// Creates a MonochromeCalendarArrowUp.
  const MonochromeCalendarArrowUp({
    super.key,
    this.size = 24,
    this.color,
  });
