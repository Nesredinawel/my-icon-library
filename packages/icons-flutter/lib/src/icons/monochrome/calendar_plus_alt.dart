...
/// Monochrome style CalendarPlusAlt icon.
///
/// Example:
/// ```dart
/// MonochromeCalendarPlusAlt(size: 24, color: Colors.blue);
/// ```
class MonochromeCalendarPlusAlt extends StatelessWidget {
  ...
  /// Creates a MonochromeCalendarPlusAlt.
  const MonochromeCalendarPlusAlt({
    super.key,
    this.size = 24,
    this.color,
  });
