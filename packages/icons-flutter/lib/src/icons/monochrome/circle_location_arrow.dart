...
/// Monochrome style CircleLocationArrow icon.
///
/// Example:
/// ```dart
/// MonochromeCircleLocationArrow(size: 24, color: Colors.blue);
/// ```
class MonochromeCircleLocationArrow extends StatelessWidget {
  ...
  /// Creates a MonochromeCircleLocationArrow.
  const MonochromeCircleLocationArrow({
    super.key,
    this.size = 24,
    this.color,
  });
