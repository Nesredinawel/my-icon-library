...
/// Monochrome style GridPlus icon.
///
/// Example:
/// ```dart
/// MonochromeGridPlus(size: 24, color: Colors.blue);
/// ```
class MonochromeGridPlus extends StatelessWidget {
  ...
  /// Creates a MonochromeGridPlus.
  const MonochromeGridPlus({
    super.key,
    this.size = 24,
    this.color,
  });
