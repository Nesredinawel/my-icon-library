...
/// Monochrome style RectangleVertical icon.
///
/// Example:
/// ```dart
/// MonochromeRectangleVertical(size: 24, color: Colors.blue);
/// ```
class MonochromeRectangleVertical extends StatelessWidget {
  ...
  /// Creates a MonochromeRectangleVertical.
  const MonochromeRectangleVertical({
    super.key,
    this.size = 24,
    this.color,
  });
