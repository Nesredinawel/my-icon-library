...
/// Monochrome style ClipboardAttachment icon.
///
/// Example:
/// ```dart
/// MonochromeClipboardAttachment(size: 24, color: Colors.blue);
/// ```
class MonochromeClipboardAttachment extends StatelessWidget {
  ...
  /// Creates a MonochromeClipboardAttachment.
  const MonochromeClipboardAttachment({
    super.key,
    this.size = 24,
    this.color,
  });
