...
/// Monochrome style InboxCheck icon.
///
/// Example:
/// ```dart
/// MonochromeInboxCheck(size: 24, color: Colors.blue);
/// ```
class MonochromeInboxCheck extends StatelessWidget {
  ...
  /// Creates a MonochromeInboxCheck.
  const MonochromeInboxCheck({
    super.key,
    this.size = 24,
    this.color,
  });
