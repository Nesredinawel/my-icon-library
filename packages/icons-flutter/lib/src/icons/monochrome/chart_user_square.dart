...
/// Monochrome style ChartUserSquare icon.
///
/// Example:
/// ```dart
/// MonochromeChartUserSquare(size: 24, color: Colors.blue);
/// ```
class MonochromeChartUserSquare extends StatelessWidget {
  ...
  /// Creates a MonochromeChartUserSquare.
  const MonochromeChartUserSquare({
    super.key,
    this.size = 24,
    this.color,
  });
