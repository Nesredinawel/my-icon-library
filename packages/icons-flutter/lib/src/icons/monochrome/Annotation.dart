...
/// Monochrome style Annotation icon.
///
/// Example:
/// ```dart
/// MonochromeAnnotation(size: 24, color: Colors.blue);
/// ```
class MonochromeAnnotation extends StatelessWidget {
  ...
  /// Creates a MonochromeAnnotation.
  const MonochromeAnnotation({
    super.key,
    this.size = 24,
    this.color,
  });
