...
/// Monochrome style TrashCheck icon.
///
/// Example:
/// ```dart
/// MonochromeTrashCheck(size: 24, color: Colors.blue);
/// ```
class MonochromeTrashCheck extends StatelessWidget {
  ...
  /// Creates a MonochromeTrashCheck.
  const MonochromeTrashCheck({
    super.key,
    this.size = 24,
    this.color,
  });
