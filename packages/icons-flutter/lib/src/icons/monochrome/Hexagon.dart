...
/// Monochrome style Hexagon icon.
///
/// Example:
/// ```dart
/// MonochromeHexagon(size: 24, color: Colors.blue);
/// ```
class MonochromeHexagon extends StatelessWidget {
  ...
  /// Creates a MonochromeHexagon.
  const MonochromeHexagon({
    super.key,
    this.size = 24,
    this.color,
  });
