...
/// Monochrome style InboxMinus icon.
///
/// Example:
/// ```dart
/// MonochromeInboxMinus(size: 24, color: Colors.blue);
/// ```
class MonochromeInboxMinus extends StatelessWidget {
  ...
  /// Creates a MonochromeInboxMinus.
  const MonochromeInboxMinus({
    super.key,
    this.size = 24,
    this.color,
  });
