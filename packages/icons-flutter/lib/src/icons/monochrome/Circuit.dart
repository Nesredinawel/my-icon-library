...
/// Monochrome style Circuit icon.
///
/// Example:
/// ```dart
/// MonochromeCircuit(size: 24, color: Colors.blue);
/// ```
class MonochromeCircuit extends StatelessWidget {
  ...
  /// Creates a MonochromeCircuit.
  const MonochromeCircuit({
    super.key,
    this.size = 24,
    this.color,
  });
