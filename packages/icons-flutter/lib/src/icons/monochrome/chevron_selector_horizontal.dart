...
/// Monochrome style ChevronSelectorHorizontal icon.
///
/// Example:
/// ```dart
/// MonochromeChevronSelectorHorizontal(size: 24, color: Colors.blue);
/// ```
class MonochromeChevronSelectorHorizontal extends StatelessWidget {
  ...
  /// Creates a MonochromeChevronSelectorHorizontal.
