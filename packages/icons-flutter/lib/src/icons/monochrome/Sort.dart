...
/// Monochrome style Sort icon.
///
/// Example:
/// ```dart
/// MonochromeSort(size: 24, color: Colors.blue);
/// ```
class MonochromeSort extends StatelessWidget {
  ...
  /// Creates a MonochromeSort.
  const MonochromeSort({
    super.key,
    this.size = 24,
    this.color,
  });
