...
/// Monochrome style ArrowNarrowLeftAlignment icon.
///
/// Example:
/// ```dart
/// MonochromeArrowNarrowLeftAlignment(size: 24, color: Colors.blue);
/// ```
class MonochromeArrowNarrowLeftAlignment extends StatelessWidget {
  ...
  /// Creates a MonochromeArrowNarrowLeftAlignment.
