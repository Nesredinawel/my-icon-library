...
/// Monochrome style TrashPlus icon.
///
/// Example:
/// ```dart
/// MonochromeTrashPlus(size: 24, color: Colors.blue);
/// ```
class MonochromeTrashPlus extends StatelessWidget {
  ...
  /// Creates a MonochromeTrashPlus.
  const MonochromeTrashPlus({
    super.key,
    this.size = 24,
    this.color,
  });
