...
/// Monochrome style LaptopXmark icon.
///
/// Example:
/// ```dart
/// MonochromeLaptopXmark(size: 24, color: Colors.blue);
/// ```
class MonochromeLaptopXmark extends StatelessWidget {
  ...
  /// Creates a MonochromeLaptopXmark.
  const MonochromeLaptopXmark({
    super.key,
    this.size = 24,
    this.color,
  });
