...
/// Monochrome style BorderClear icon.
///
/// Example:
/// ```dart
/// MonochromeBorderClear(size: 24, color: Colors.blue);
/// ```
class MonochromeBorderClear extends StatelessWidget {
  ...
  /// Creates a MonochromeBorderClear.
  const MonochromeBorderClear({
    super.key,
    this.size = 24,
    this.color,
  });
