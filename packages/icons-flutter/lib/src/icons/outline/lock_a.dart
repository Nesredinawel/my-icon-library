...
/// Outline style LockA icon.
///
/// Example:
/// ```dart
/// OutlineLockA(size: 24, color: Colors.blue);
/// ```
class OutlineLockA extends StatelessWidget {
