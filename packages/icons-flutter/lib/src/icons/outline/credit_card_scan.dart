...
/// Outline style CreditCardScan icon.
///
/// Example:
/// ```dart
/// OutlineCreditCardScan(size: 24, color: Colors.blue);
/// ```
class OutlineCreditCardScan extends StatelessWidget {
  ...
  /// Creates a OutlineCreditCardScan.
  const OutlineCreditCardScan({
    super.key,
    this.size = 24,
    this.color,
  });
