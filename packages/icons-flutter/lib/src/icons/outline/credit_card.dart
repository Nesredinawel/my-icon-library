...
/// Outline style CreditCard icon.
///
/// Example:
/// ```dart
/// OutlineCreditCard(size: 24, color: Colors.blue);
/// ```
class OutlineCreditCard extends StatelessWidget {
