...
/// Outline style InboxXmark icon.
///
/// Example:
/// ```dart
/// OutlineInboxXmark(size: 24, color: Colors.blue);
/// ```
class OutlineInboxXmark extends StatelessWidget {
  ...
  /// Creates a OutlineInboxXmark.
  const OutlineInboxXmark({
    super.key,
    this.size = 24,
    this.color,
  });
