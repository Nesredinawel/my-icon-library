...
/// Outline style ClipboardList icon.
///
/// Example:
/// ```dart
/// OutlineClipboardList(size: 24, color: Colors.blue);
/// ```
class OutlineClipboardList extends StatelessWidget {
  ...
  /// Creates a OutlineClipboardList.
