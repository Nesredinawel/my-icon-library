...
/// Outline style InboxInformation icon.
///
/// Example:
/// ```dart
/// OutlineInboxInformation(size: 24, color: Colors.blue);
/// ```
class OutlineInboxInformation extends StatelessWidget {
  ...
  /// Creates a OutlineInboxInformation.
  const OutlineInboxInformation({
    super.key,
    this.size = 24,
    this.color,
  });
