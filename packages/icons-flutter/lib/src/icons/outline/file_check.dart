...
/// Outline style FileCheck icon.
///
/// Example:
/// ```dart
/// OutlineFileCheck(size: 24, color: Colors.blue);
/// ```
class OutlineFileCheck extends StatelessWidget {
  ...
  /// Creates a OutlineFileCheck.
  const OutlineFileCheck({
    super.key,
    this.size = 24,
    this.color,
  });
