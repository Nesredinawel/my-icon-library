...
/// Outline style ObjectsAlignCenterVerticalAlt icon.
///
/// Example:
/// ```dart
/// OutlineObjectsAlignCenterVerticalAlt(size: 24, color: Colors.blue);
/// ```
class OutlineObjectsAlignCenterVerticalAlt extends StatelessWidget {
  ...
  /// Creates a OutlineObjectsAlignCenterVerticalAlt.
