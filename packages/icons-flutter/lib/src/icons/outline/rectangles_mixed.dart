...
/// Outline style RectanglesMixed icon.
///
/// Example:
/// ```dart
/// OutlineRectanglesMixed(size: 24, color: Colors.blue);
/// ```
class OutlineRectanglesMixed extends StatelessWidget {
  ...
  /// Creates a OutlineRectanglesMixed.
  const OutlineRectanglesMixed({
    super.key,
    this.size = 24,
    this.color,
  });
