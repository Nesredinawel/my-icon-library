...
/// Outline style WalletArrowRight icon.
///
/// Example:
/// ```dart
/// OutlineWalletArrowRight(size: 24, color: Colors.blue);
/// ```
class OutlineWalletArrowRight extends StatelessWidget {
  ...
  /// Creates a OutlineWalletArrowRight.
  const OutlineWalletArrowRight({
    super.key,
    this.size = 24,
    this.color,
  });
