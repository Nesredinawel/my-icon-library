...
/// Outline style RestaurantMenu icon.
///
/// Example:
/// ```dart
/// OutlineRestaurantMenu(size: 24, color: Colors.blue);
/// ```
class OutlineRestaurantMenu extends StatelessWidget {
  ...
  /// Creates a OutlineRestaurantMenu.
  const OutlineRestaurantMenu({
    super.key,
    this.size = 24,
    this.color,
  });
