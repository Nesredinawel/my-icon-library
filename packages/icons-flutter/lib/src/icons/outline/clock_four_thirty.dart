...
/// Outline style ClockFourThirty icon.
///
/// Example:
/// ```dart
/// OutlineClockFourThirty(size: 24, color: Colors.blue);
/// ```
class OutlineClockFourThirty extends StatelessWidget {
  ...
  /// Creates a OutlineClockFourThirty.
  const OutlineClockFourThirty({
    super.key,
    this.size = 24,
    this.color,
  });
