...
/// Outline style SortDown icon.
///
/// Example:
/// ```dart
/// OutlineSortDown(size: 24, color: Colors.blue);
/// ```
class OutlineSortDown extends StatelessWidget {
  ...
  /// Creates a OutlineSortDown.
  const OutlineSortDown({
    super.key,
    this.size = 24,
    this.color,
  });
