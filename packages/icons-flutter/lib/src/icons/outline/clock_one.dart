...
/// Outline style ClockOne icon.
///
/// Example:
/// ```dart
/// OutlineClockOne(size: 24, color: Colors.blue);
/// ```
class OutlineClockOne extends StatelessWidget {
  ...
  /// Creates a OutlineClockOne.
  const OutlineClockOne({
    super.key,
    this.size = 24,
    this.color,
  });
