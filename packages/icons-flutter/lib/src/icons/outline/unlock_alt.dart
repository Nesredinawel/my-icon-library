...
/// Outline style UnlockAlt icon.
///
/// Example:
/// ```dart
/// OutlineUnlockAlt(size: 24, color: Colors.blue);
/// ```
class OutlineUnlockAlt extends StatelessWidget {
  ...
  /// Creates a OutlineUnlockAlt.
  const OutlineUnlockAlt({
    super.key,
    this.size = 24,
    this.color,
  });
