...
/// Outline style ShieldMinus icon.
///
/// Example:
/// ```dart
/// OutlineShieldMinus(size: 24, color: Colors.blue);
/// ```
class OutlineShieldMinus extends StatelessWidget {
  ...
  /// Creates a OutlineShieldMinus.
  const OutlineShieldMinus({
    super.key,
    this.size = 24,
    this.color,
  });
