...
/// Outline style InboxArrowDown icon.
///
/// Example:
/// ```dart
/// OutlineInboxArrowDown(size: 24, color: Colors.blue);
/// ```
class OutlineInboxArrowDown extends StatelessWidget {
  ...
  /// Creates a OutlineInboxArrowDown.
  const OutlineInboxArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
