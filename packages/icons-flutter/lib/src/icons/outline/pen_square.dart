...
/// Outline style PenSquare icon.
///
/// Example:
/// ```dart
/// OutlinePenSquare(size: 24, color: Colors.blue);
/// ```
class OutlinePenSquare extends StatelessWidget {
  ...
  /// Creates a OutlinePenSquare.
  const OutlinePenSquare({
    super.key,
    this.size = 24,
    this.color,
  });
