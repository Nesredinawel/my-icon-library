...
/// Outline style WarehouseFull icon.
///
/// Example:
/// ```dart
/// OutlineWarehouseFull(size: 24, color: Colors.blue);
/// ```
class OutlineWarehouseFull extends StatelessWidget {
  ...
  /// Creates a OutlineWarehouseFull.
  const OutlineWarehouseFull({
    super.key,
    this.size = 24,
    this.color,
  });
