...
/// Outline style TrafficLightStop icon.
///
/// Example:
/// ```dart
/// OutlineTrafficLightStop(size: 24, color: Colors.blue);
/// ```
class OutlineTrafficLightStop extends StatelessWidget {
  ...
  /// Creates a OutlineTrafficLightStop.
  const OutlineTrafficLightStop({
    super.key,
    this.size = 24,
    this.color,
  });
