...
/// Outline style Server icon.
///
/// Example:
/// ```dart
/// OutlineServer(size: 24, color: Colors.blue);
/// ```
class OutlineServer extends StatelessWidget {
