...
/// Outline style GiftCard icon.
///
/// Example:
/// ```dart
/// OutlineGiftCard(size: 24, color: Colors.blue);
/// ```
class OutlineGiftCard extends StatelessWidget {
  ...
  /// Creates a OutlineGiftCard.
  const OutlineGiftCard({
    super.key,
    this.size = 24,
    this.color,
  });
