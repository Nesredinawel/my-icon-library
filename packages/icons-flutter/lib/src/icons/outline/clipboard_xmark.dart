...
/// Outline style ClipboardXmark icon.
///
/// Example:
/// ```dart
/// OutlineClipboardXmark(size: 24, color: Colors.blue);
/// ```
class OutlineClipboardXmark extends StatelessWidget {
  ...
  /// Creates a OutlineClipboardXmark.
  const OutlineClipboardXmark({
    super.key,
    this.size = 24,
    this.color,
  });
