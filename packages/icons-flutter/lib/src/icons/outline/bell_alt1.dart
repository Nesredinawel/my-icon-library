...
/// Outline style BellAlt1 icon.
///
/// Example:
/// ```dart
/// OutlineBellAlt1(size: 24, color: Colors.blue);
/// ```
class OutlineBellAlt1 extends StatelessWidget {
  ...
  /// Creates a OutlineBellAlt1.
  const OutlineBellAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
