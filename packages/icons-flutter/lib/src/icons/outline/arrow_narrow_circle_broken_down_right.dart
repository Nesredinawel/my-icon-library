...
/// Outline style ArrowNarrowCircleBrokenDownRight icon.
///
/// Example:
/// ```dart
/// OutlineArrowNarrowCircleBrokenDownRight(size: 24, color: Colors.blue);
/// ```
class OutlineArrowNarrowCircleBrokenDownRight extends StatelessWidget {
  ...
  /// Creates a OutlineArrowNarrowCircleBrokenDownRight.
