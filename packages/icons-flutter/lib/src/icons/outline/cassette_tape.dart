...
/// Outline style CassetteTape icon.
///
/// Example:
/// ```dart
/// OutlineCassetteTape(size: 24, color: Colors.blue);
/// ```
class OutlineCassetteTape extends StatelessWidget {
  ...
  /// Creates a OutlineCassetteTape.
  const OutlineCassetteTape({
    super.key,
    this.size = 24,
    this.color,
  });
