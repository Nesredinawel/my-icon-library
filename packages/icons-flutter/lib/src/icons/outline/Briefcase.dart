...
/// Outline style Briefcase icon.
///
/// Example:
/// ```dart
/// OutlineBriefcase(size: 24, color: Colors.blue);
/// ```
class OutlineBriefcase extends StatelessWidget {
