...
/// Outline style TableCellsLarge icon.
///
/// Example:
/// ```dart
/// OutlineTableCellsLarge(size: 24, color: Colors.blue);
/// ```
class OutlineTableCellsLarge extends StatelessWidget {
  ...
  /// Creates a OutlineTableCellsLarge.
  const OutlineTableCellsLarge({
    super.key,
    this.size = 24,
    this.color,
  });
