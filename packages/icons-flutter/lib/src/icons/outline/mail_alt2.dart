...
/// Outline style MailAlt2 icon.
///
/// Example:
/// ```dart
/// OutlineMailAlt2(size: 24, color: Colors.blue);
/// ```
class OutlineMailAlt2 extends StatelessWidget {
  ...
  /// Creates a OutlineMailAlt2.
  const OutlineMailAlt2({
    super.key,
    this.size = 24,
    this.color,
  });
