...
/// Outline style BuildingLock icon.
///
/// Example:
/// ```dart
/// OutlineBuildingLock(size: 24, color: Colors.blue);
/// ```
class OutlineBuildingLock extends StatelessWidget {
  ...
  /// Creates a OutlineBuildingLock.
  const OutlineBuildingLock({
    super.key,
    this.size = 24,
    this.color,
  });
