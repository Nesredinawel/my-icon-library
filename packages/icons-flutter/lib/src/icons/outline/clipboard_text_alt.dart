...
/// Outline style ClipboardTextAlt icon.
///
/// Example:
/// ```dart
/// OutlineClipboardTextAlt(size: 24, color: Colors.blue);
/// ```
class OutlineClipboardTextAlt extends StatelessWidget {
  ...
  /// Creates a OutlineClipboardTextAlt.
  const OutlineClipboardTextAlt({
    super.key,
    this.size = 24,
    this.color,
  });
