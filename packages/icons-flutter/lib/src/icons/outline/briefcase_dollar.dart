...
/// Outline style BriefcaseDollar icon.
///
/// Example:
/// ```dart
/// OutlineBriefcaseDollar(size: 24, color: Colors.blue);
/// ```
class OutlineBriefcaseDollar extends StatelessWidget {
  ...
  /// Creates a OutlineBriefcaseDollar.
  const OutlineBriefcaseDollar({
    super.key,
    this.size = 24,
    this.color,
  });
