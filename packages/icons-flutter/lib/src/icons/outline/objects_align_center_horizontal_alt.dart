...
/// Outline style ObjectsAlignCenterHorizontalAlt icon.
///
/// Example:
/// ```dart
/// OutlineObjectsAlignCenterHorizontalAlt(size: 24, color: Colors.blue);
/// ```
class OutlineObjectsAlignCenterHorizontalAlt extends StatelessWidget {
  ...
  /// Creates a OutlineObjectsAlignCenterHorizontalAlt.
