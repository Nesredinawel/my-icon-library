...
/// Outline style SpiderWidow icon.
///
/// Example:
/// ```dart
/// OutlineSpiderWidow(size: 24, color: Colors.blue);
/// ```
class OutlineSpiderWidow extends StatelessWidget {
  ...
  /// Creates a OutlineSpiderWidow.
  const OutlineSpiderWidow({
    super.key,
    this.size = 24,
    this.color,
  });
