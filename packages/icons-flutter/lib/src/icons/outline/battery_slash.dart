...
/// Outline style BatterySlash icon.
///
/// Example:
/// ```dart
/// OutlineBatterySlash(size: 24, color: Colors.blue);
/// ```
class OutlineBatterySlash extends StatelessWidget {
  ...
  /// Creates a OutlineBatterySlash.
  const OutlineBatterySlash({
    super.key,
    this.size = 24,
    this.color,
  });
