...
/// Outline style SantaHatAlt icon.
///
/// Example:
/// ```dart
/// OutlineSantaHatAlt(size: 24, color: Colors.blue);
/// ```
class OutlineSantaHatAlt extends StatelessWidget {
  ...
  /// Creates a OutlineSantaHatAlt.
  const OutlineSantaHatAlt({
    super.key,
    this.size = 24,
    this.color,
  });
