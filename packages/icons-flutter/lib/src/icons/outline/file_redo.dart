...
/// Outline style FileRedo icon.
///
/// Example:
/// ```dart
/// OutlineFileRedo(size: 24, color: Colors.blue);
/// ```
class OutlineFileRedo extends StatelessWidget {
  ...
  /// Creates a OutlineFileRedo.
  const OutlineFileRedo({
    super.key,
    this.size = 24,
    this.color,
  });
