...
/// Outline style InboxExclamation icon.
///
/// Example:
/// ```dart
/// OutlineInboxExclamation(size: 24, color: Colors.blue);
/// ```
class OutlineInboxExclamation extends StatelessWidget {
  ...
  /// Creates a OutlineInboxExclamation.
  const OutlineInboxExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
