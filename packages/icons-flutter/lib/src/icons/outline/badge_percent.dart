...
/// Outline style BadgePercent icon.
///
/// Example:
/// ```dart
/// OutlineBadgePercent(size: 24, color: Colors.blue);
/// ```
class OutlineBadgePercent extends StatelessWidget {
  ...
  /// Creates a OutlineBadgePercent.
  const OutlineBadgePercent({
    super.key,
    this.size = 24,
    this.color,
  });
