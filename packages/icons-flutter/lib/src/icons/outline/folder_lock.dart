...
/// Outline style FolderLock icon.
///
/// Example:
/// ```dart
/// OutlineFolderLock(size: 24, color: Colors.blue);
/// ```
class OutlineFolderLock extends StatelessWidget {
