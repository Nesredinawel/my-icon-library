...
/// Outline style RectangleTerminal icon.
///
/// Example:
/// ```dart
/// OutlineRectangleTerminal(size: 24, color: Colors.blue);
/// ```
class OutlineRectangleTerminal extends StatelessWidget {
  ...
  /// Creates a OutlineRectangleTerminal.
  const OutlineRectangleTerminal({
    super.key,
    this.size = 24,
    this.color,
  });
