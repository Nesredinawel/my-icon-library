...
/// Outline style CameraAlt icon.
///
/// Example:
/// ```dart
/// OutlineCameraAlt(size: 24, color: Colors.blue);
/// ```
class OutlineCameraAlt extends StatelessWidget {
  ...
  /// Creates a OutlineCameraAlt.
  const OutlineCameraAlt({
    super.key,
    this.size = 24,
    this.color,
  });
