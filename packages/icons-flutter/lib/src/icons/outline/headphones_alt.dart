...
/// Outline style HeadphonesAlt icon.
///
/// Example:
/// ```dart
/// OutlineHeadphonesAlt(size: 24, color: Colors.blue);
/// ```
class OutlineHeadphonesAlt extends StatelessWidget {
  ...
  /// Creates a OutlineHeadphonesAlt.
  const OutlineHeadphonesAlt({
    super.key,
    this.size = 24,
    this.color,
  });
