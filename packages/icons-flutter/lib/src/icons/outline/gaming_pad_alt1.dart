...
/// Outline style GamingPadAlt1 icon.
///
/// Example:
/// ```dart
/// OutlineGamingPadAlt1(size: 24, color: Colors.blue);
/// ```
class OutlineGamingPadAlt1 extends StatelessWidget {
  ...
  /// Creates a OutlineGamingPadAlt1.
  const OutlineGamingPadAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
