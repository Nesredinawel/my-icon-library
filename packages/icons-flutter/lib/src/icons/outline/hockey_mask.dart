...
/// Outline style HockeyMask icon.
///
/// Example:
/// ```dart
/// OutlineHockeyMask(size: 24, color: Colors.blue);
/// ```
class OutlineHockeyMask extends StatelessWidget {
  ...
  /// Creates a OutlineHockeyMask.
  const OutlineHockeyMask({
    super.key,
    this.size = 24,
    this.color,
  });
