...
/// Outline style FileDashedLine icon.
///
/// Example:
/// ```dart
/// OutlineFileDashedLine(size: 24, color: Colors.blue);
/// ```
class OutlineFileDashedLine extends StatelessWidget {
  ...
  /// Creates a OutlineFileDashedLine.
  const OutlineFileDashedLine({
    super.key,
    this.size = 24,
    this.color,
  });
