...
/// Outline style PhoneSignal icon.
///
/// Example:
/// ```dart
/// OutlinePhoneSignal(size: 24, color: Colors.blue);
/// ```
class OutlinePhoneSignal extends StatelessWidget {
  ...
  /// Creates a OutlinePhoneSignal.
  const OutlinePhoneSignal({
    super.key,
    this.size = 24,
    this.color,
  });
