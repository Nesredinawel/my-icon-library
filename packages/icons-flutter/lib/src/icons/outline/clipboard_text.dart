...
/// Outline style ClipboardText icon.
///
/// Example:
/// ```dart
/// OutlineClipboardText(size: 24, color: Colors.blue);
/// ```
class OutlineClipboardText extends StatelessWidget {
  ...
  /// Creates a OutlineClipboardText.
