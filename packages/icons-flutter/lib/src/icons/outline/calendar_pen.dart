...
/// Outline style CalendarPen icon.
///
/// Example:
/// ```dart
/// OutlineCalendarPen(size: 24, color: Colors.blue);
/// ```
class OutlineCalendarPen extends StatelessWidget {
  ...
  /// Creates a OutlineCalendarPen.
  const OutlineCalendarPen({
    super.key,
    this.size = 24,
    this.color,
  });
