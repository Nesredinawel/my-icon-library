...
/// Outline style PhoneXmarkAlt icon.
///
/// Example:
/// ```dart
/// OutlinePhoneXmarkAlt(size: 24, color: Colors.blue);
/// ```
class OutlinePhoneXmarkAlt extends StatelessWidget {
  ...
  /// Creates a OutlinePhoneXmarkAlt.
  const OutlinePhoneXmarkAlt({
    super.key,
    this.size = 24,
    this.color,
  });
