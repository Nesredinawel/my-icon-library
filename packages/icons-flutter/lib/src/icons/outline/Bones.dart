...
/// Outline style Bones icon.
///
/// Example:
/// ```dart
/// OutlineBones(size: 24, color: Colors.blue);
/// ```
class OutlineBones extends StatelessWidget {
