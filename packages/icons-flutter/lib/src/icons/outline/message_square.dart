...
/// Outline style MessageSquare icon.
///
/// Example:
/// ```dart
/// OutlineMessageSquare(size: 24, color: Colors.blue);
/// ```
class OutlineMessageSquare extends StatelessWidget {
  ...
  /// Creates a OutlineMessageSquare.
  const OutlineMessageSquare({
    super.key,
    this.size = 24,
    this.color,
  });
