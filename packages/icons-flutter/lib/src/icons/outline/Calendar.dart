...
/// Outline style Calendar icon.
///
/// Example:
/// ```dart
/// OutlineCalendar(size: 24, color: Colors.blue);
/// ```
class OutlineCalendar extends StatelessWidget {
