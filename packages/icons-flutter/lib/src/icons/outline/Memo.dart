...
/// Outline style Memo icon.
///
/// Example:
/// ```dart
/// OutlineMemo(size: 24, color: Colors.blue);
/// ```
class OutlineMemo extends StatelessWidget {
