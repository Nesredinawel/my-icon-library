...
/// Outline style MailOpenCheck icon.
///
/// Example:
/// ```dart
/// OutlineMailOpenCheck(size: 24, color: Colors.blue);
/// ```
class OutlineMailOpenCheck extends StatelessWidget {
  ...
  /// Creates a OutlineMailOpenCheck.
  const OutlineMailOpenCheck({
    super.key,
    this.size = 24,
    this.color,
  });
