...
/// Outline style FileUser icon.
///
/// Example:
/// ```dart
/// OutlineFileUser(size: 24, color: Colors.blue);
/// ```
class OutlineFileUser extends StatelessWidget {
  ...
  /// Creates a OutlineFileUser.
  const OutlineFileUser({
    super.key,
    this.size = 24,
    this.color,
  });
