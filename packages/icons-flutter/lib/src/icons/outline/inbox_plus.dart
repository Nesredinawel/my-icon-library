...
/// Outline style InboxPlus icon.
///
/// Example:
/// ```dart
/// OutlineInboxPlus(size: 24, color: Colors.blue);
/// ```
class OutlineInboxPlus extends StatelessWidget {
  ...
  /// Creates a OutlineInboxPlus.
  const OutlineInboxPlus({
    super.key,
    this.size = 24,
    this.color,
  });
