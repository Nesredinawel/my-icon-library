...
/// Outline style TrafficLightSlow icon.
///
/// Example:
/// ```dart
/// OutlineTrafficLightSlow(size: 24, color: Colors.blue);
/// ```
class OutlineTrafficLightSlow extends StatelessWidget {
  ...
  /// Creates a OutlineTrafficLightSlow.
  const OutlineTrafficLightSlow({
    super.key,
    this.size = 24,
    this.color,
  });
