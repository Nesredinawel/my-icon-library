...
/// Outline style Cube icon.
///
/// Example:
/// ```dart
/// OutlineCube(size: 24, color: Colors.blue);
/// ```
class OutlineCube extends StatelessWidget {
