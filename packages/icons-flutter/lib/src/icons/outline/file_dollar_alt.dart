...
/// Outline style FileDollarAlt icon.
///
/// Example:
/// ```dart
/// OutlineFileDollarAlt(size: 24, color: Colors.blue);
/// ```
class OutlineFileDollarAlt extends StatelessWidget {
  ...
  /// Creates a OutlineFileDollarAlt.
  const OutlineFileDollarAlt({
    super.key,
    this.size = 24,
    this.color,
  });
