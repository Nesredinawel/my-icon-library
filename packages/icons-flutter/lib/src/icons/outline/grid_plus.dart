...
/// Outline style GridPlus icon.
///
/// Example:
/// ```dart
/// OutlineGridPlus(size: 24, color: Colors.blue);
/// ```
class OutlineGridPlus extends StatelessWidget {
  ...
  /// Creates a OutlineGridPlus.
  const OutlineGridPlus({
    super.key,
    this.size = 24,
    this.color,
  });
