...
/// Outline style FileQuestionAlt1 icon.
///
/// Example:
/// ```dart
/// OutlineFileQuestionAlt1(size: 24, color: Colors.blue);
/// ```
class OutlineFileQuestionAlt1 extends StatelessWidget {
  ...
  /// Creates a OutlineFileQuestionAlt1.
  const OutlineFileQuestionAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
