...
/// Outline style VolumeOff icon.
///
/// Example:
/// ```dart
/// OutlineVolumeOff(size: 24, color: Colors.blue);
/// ```
class OutlineVolumeOff extends StatelessWidget {
