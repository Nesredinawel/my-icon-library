...
/// Outline style BadgeCheck icon.
///
/// Example:
/// ```dart
/// OutlineBadgeCheck(size: 24, color: Colors.blue);
/// ```
class OutlineBadgeCheck extends StatelessWidget {
