...
/// Outline style PenField icon.
///
/// Example:
/// ```dart
/// OutlinePenField(size: 24, color: Colors.blue);
/// ```
class OutlinePenField extends StatelessWidget {
  ...
  /// Creates a OutlinePenField.
  const OutlinePenField({
    super.key,
    this.size = 24,
    this.color,
  });
