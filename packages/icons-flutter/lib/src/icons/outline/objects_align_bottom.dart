...
/// Outline style ObjectsAlignBottom icon.
///
/// Example:
/// ```dart
/// OutlineObjectsAlignBottom(size: 24, color: Colors.blue);
/// ```
class OutlineObjectsAlignBottom extends StatelessWidget {
  ...
  /// Creates a OutlineObjectsAlignBottom.
  const OutlineObjectsAlignBottom({
    super.key,
    this.size = 24,
    this.color,
  });
