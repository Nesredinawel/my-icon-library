...
/// Outline style TreeDecoratedAlt1 icon.
///
/// Example:
/// ```dart
/// OutlineTreeDecoratedAlt1(size: 24, color: Colors.blue);
/// ```
class OutlineTreeDecoratedAlt1 extends StatelessWidget {
  ...
  /// Creates a OutlineTreeDecoratedAlt1.
  const OutlineTreeDecoratedAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
