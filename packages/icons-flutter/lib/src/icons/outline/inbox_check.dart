...
/// Outline style InboxCheck icon.
///
/// Example:
/// ```dart
/// OutlineInboxCheck(size: 24, color: Colors.blue);
/// ```
class OutlineInboxCheck extends StatelessWidget {
  ...
  /// Creates a OutlineInboxCheck.
  const OutlineInboxCheck({
    super.key,
    this.size = 24,
    this.color,
  });
