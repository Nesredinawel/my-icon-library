...
/// Outline style Moneybag icon.
///
/// Example:
/// ```dart
/// OutlineMoneybag(size: 24, color: Colors.blue);
/// ```
class OutlineMoneybag extends StatelessWidget {
