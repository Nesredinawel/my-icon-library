...
/// Outline style ObjectsAlignTop icon.
///
/// Example:
/// ```dart
/// OutlineObjectsAlignTop(size: 24, color: Colors.blue);
/// ```
class OutlineObjectsAlignTop extends StatelessWidget {
  ...
  /// Creates a OutlineObjectsAlignTop.
  const OutlineObjectsAlignTop({
    super.key,
    this.size = 24,
    this.color,
  });
