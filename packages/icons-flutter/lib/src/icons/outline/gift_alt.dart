...
/// Outline style GiftAlt icon.
///
/// Example:
/// ```dart
/// OutlineGiftAlt(size: 24, color: Colors.blue);
/// ```
class OutlineGiftAlt extends StatelessWidget {
  ...
  /// Creates a OutlineGiftAlt.
  const OutlineGiftAlt({
    super.key,
    this.size = 24,
    this.color,
  });
