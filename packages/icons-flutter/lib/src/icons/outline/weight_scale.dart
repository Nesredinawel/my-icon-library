...
/// Outline style WeightScale icon.
///
/// Example:
/// ```dart
/// OutlineWeightScale(size: 24, color: Colors.blue);
/// ```
class OutlineWeightScale extends StatelessWidget {
  ...
  /// Creates a OutlineWeightScale.
  const OutlineWeightScale({
    super.key,
    this.size = 24,
    this.color,
  });
