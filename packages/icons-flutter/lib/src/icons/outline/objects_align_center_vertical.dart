...
/// Outline style ObjectsAlignCenterVertical icon.
///
/// Example:
/// ```dart
/// OutlineObjectsAlignCenterVertical(size: 24, color: Colors.blue);
/// ```
class OutlineObjectsAlignCenterVertical extends StatelessWidget {
  ...
  /// Creates a OutlineObjectsAlignCenterVertical.
  const OutlineObjectsAlignCenterVertical({
    super.key,
    this.size = 24,
    this.color,
  });
