...
/// Outline style TemperatureSnow icon.
///
/// Example:
/// ```dart
/// OutlineTemperatureSnow(size: 24, color: Colors.blue);
/// ```
class OutlineTemperatureSnow extends StatelessWidget {
  ...
  /// Creates a OutlineTemperatureSnow.
  const OutlineTemperatureSnow({
    super.key,
    this.size = 24,
    this.color,
  });
