...
/// Outline style FilterList icon.
///
/// Example:
/// ```dart
/// OutlineFilterList(size: 24, color: Colors.blue);
/// ```
class OutlineFilterList extends StatelessWidget {
  ...
  /// Creates a OutlineFilterList.
  const OutlineFilterList({
    super.key,
    this.size = 24,
    this.color,
  });
