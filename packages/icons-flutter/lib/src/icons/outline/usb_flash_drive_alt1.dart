...
/// Outline style UsbFlashDriveAlt1 icon.
///
/// Example:
/// ```dart
/// OutlineUsbFlashDriveAlt1(size: 24, color: Colors.blue);
/// ```
class OutlineUsbFlashDriveAlt1 extends StatelessWidget {
  ...
  /// Creates a OutlineUsbFlashDriveAlt1.
  const OutlineUsbFlashDriveAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
