...
/// Outline style FileBlock icon.
///
/// Example:
/// ```dart
/// OutlineFileBlock(size: 24, color: Colors.blue);
/// ```
class OutlineFileBlock extends StatelessWidget {
  ...
  /// Creates a OutlineFileBlock.
  const OutlineFileBlock({
    super.key,
    this.size = 24,
    this.color,
  });
