...
/// Outline style HalloweenCalendarBat icon.
///
/// Example:
/// ```dart
/// OutlineHalloweenCalendarBat(size: 24, color: Colors.blue);
/// ```
class OutlineHalloweenCalendarBat extends StatelessWidget {
  ...
  /// Creates a OutlineHalloweenCalendarBat.
  const OutlineHalloweenCalendarBat({
    super.key,
    this.size = 24,
    this.color,
  });
