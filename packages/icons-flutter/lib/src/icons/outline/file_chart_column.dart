...
/// Outline style FileChartColumn icon.
///
/// Example:
/// ```dart
/// OutlineFileChartColumn(size: 24, color: Colors.blue);
/// ```
class OutlineFileChartColumn extends StatelessWidget {
  ...
  /// Creates a OutlineFileChartColumn.
  const OutlineFileChartColumn({
    super.key,
    this.size = 24,
    this.color,
  });
