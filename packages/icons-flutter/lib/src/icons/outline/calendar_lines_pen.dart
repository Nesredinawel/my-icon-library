...
/// Outline style CalendarLinesPen icon.
///
/// Example:
/// ```dart
/// OutlineCalendarLinesPen(size: 24, color: Colors.blue);
/// ```
class OutlineCalendarLinesPen extends StatelessWidget {
  ...
  /// Creates a OutlineCalendarLinesPen.
  const OutlineCalendarLinesPen({
    super.key,
    this.size = 24,
    this.color,
  });
