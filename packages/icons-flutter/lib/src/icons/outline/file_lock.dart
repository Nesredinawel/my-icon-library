...
/// Outline style FileLock icon.
///
/// Example:
/// ```dart
/// OutlineFileLock(size: 24, color: Colors.blue);
/// ```
class OutlineFileLock extends StatelessWidget {
  ...
  /// Creates a OutlineFileLock.
  const OutlineFileLock({
    super.key,
    this.size = 24,
    this.color,
  });
