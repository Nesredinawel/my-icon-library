...
/// Outline style FerrisWheel icon.
///
/// Example:
/// ```dart
/// OutlineFerrisWheel(size: 24, color: Colors.blue);
/// ```
class OutlineFerrisWheel extends StatelessWidget {
  ...
  /// Creates a OutlineFerrisWheel.
  const OutlineFerrisWheel({
    super.key,
    this.size = 24,
    this.color,
  });
