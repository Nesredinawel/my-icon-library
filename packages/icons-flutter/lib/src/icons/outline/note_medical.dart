...
/// Outline style NoteMedical icon.
///
/// Example:
/// ```dart
/// OutlineNoteMedical(size: 24, color: Colors.blue);
/// ```
class OutlineNoteMedical extends StatelessWidget {
  ...
  /// Creates a OutlineNoteMedical.
  const OutlineNoteMedical({
    super.key,
    this.size = 24,
    this.color,
  });
