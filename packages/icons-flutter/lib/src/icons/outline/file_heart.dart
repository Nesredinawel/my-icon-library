...
/// Outline style FileHeart icon.
///
/// Example:
/// ```dart
/// OutlineFileHeart(size: 24, color: Colors.blue);
/// ```
class OutlineFileHeart extends StatelessWidget {
  ...
  /// Creates a OutlineFileHeart.
  const OutlineFileHeart({
    super.key,
    this.size = 24,
    this.color,
  });
