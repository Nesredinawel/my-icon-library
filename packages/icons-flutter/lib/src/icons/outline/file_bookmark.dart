...
/// Outline style FileBookmark icon.
///
/// Example:
/// ```dart
/// OutlineFileBookmark(size: 24, color: Colors.blue);
/// ```
class OutlineFileBookmark extends StatelessWidget {
  ...
  /// Creates a OutlineFileBookmark.
  const OutlineFileBookmark({
    super.key,
    this.size = 24,
    this.color,
  });
