...
/// Outline style PrinterAlt icon.
///
/// Example:
/// ```dart
/// OutlinePrinterAlt(size: 24, color: Colors.blue);
/// ```
class OutlinePrinterAlt extends StatelessWidget {
  ...
  /// Creates a OutlinePrinterAlt.
  const OutlinePrinterAlt({
    super.key,
    this.size = 24,
    this.color,
  });
