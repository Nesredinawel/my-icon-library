...
/// Outline style SquareRing icon.
///
/// Example:
/// ```dart
/// OutlineSquareRing(size: 24, color: Colors.blue);
/// ```
class OutlineSquareRing extends StatelessWidget {
  ...
  /// Creates a OutlineSquareRing.
  const OutlineSquareRing({
    super.key,
    this.size = 24,
    this.color,
  });
