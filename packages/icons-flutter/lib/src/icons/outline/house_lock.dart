...
/// Outline style HouseLock icon.
///
/// Example:
/// ```dart
/// OutlineHouseLock(size: 24, color: Colors.blue);
/// ```
class OutlineHouseLock extends StatelessWidget {
  ...
  /// Creates a OutlineHouseLock.
  const OutlineHouseLock({
    super.key,
    this.size = 24,
    this.color,
  });
