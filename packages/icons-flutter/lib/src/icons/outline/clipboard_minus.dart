...
/// Outline style ClipboardMinus icon.
///
/// Example:
/// ```dart
/// OutlineClipboardMinus(size: 24, color: Colors.blue);
/// ```
class OutlineClipboardMinus extends StatelessWidget {
  ...
  /// Creates a OutlineClipboardMinus.
  const OutlineClipboardMinus({
    super.key,
    this.size = 24,
    this.color,
  });
