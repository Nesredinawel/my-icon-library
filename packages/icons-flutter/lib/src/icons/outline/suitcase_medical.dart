...
/// Outline style SuitcaseMedical icon.
///
/// Example:
/// ```dart
/// OutlineSuitcaseMedical(size: 24, color: Colors.blue);
/// ```
class OutlineSuitcaseMedical extends StatelessWidget {
  ...
  /// Creates a OutlineSuitcaseMedical.
  const OutlineSuitcaseMedical({
    super.key,
    this.size = 24,
    this.color,
  });
