...
/// Outline style InboxArrowLeft icon.
///
/// Example:
/// ```dart
/// OutlineInboxArrowLeft(size: 24, color: Colors.blue);
/// ```
class OutlineInboxArrowLeft extends StatelessWidget {
  ...
  /// Creates a OutlineInboxArrowLeft.
  const OutlineInboxArrowLeft({
    super.key,
    this.size = 24,
    this.color,
  });
