...
/// Outline style DiagramSuccessor icon.
///
/// Example:
/// ```dart
/// OutlineDiagramSuccessor(size: 24, color: Colors.blue);
/// ```
class OutlineDiagramSuccessor extends StatelessWidget {
  ...
  /// Creates a OutlineDiagramSuccessor.
  const OutlineDiagramSuccessor({
    super.key,
    this.size = 24,
    this.color,
  });
