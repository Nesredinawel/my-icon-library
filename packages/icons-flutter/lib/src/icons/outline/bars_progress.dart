...
/// Outline style BarsProgress icon.
///
/// Example:
/// ```dart
/// OutlineBarsProgress(size: 24, color: Colors.blue);
/// ```
class OutlineBarsProgress extends StatelessWidget {
  ...
  /// Creates a OutlineBarsProgress.
  const OutlineBarsProgress({
    super.key,
    this.size = 24,
    this.color,
  });
