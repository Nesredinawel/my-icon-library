...
/// Outline style WatchAlt icon.
///
/// Example:
/// ```dart
/// OutlineWatchAlt(size: 24, color: Colors.blue);
/// ```
class OutlineWatchAlt extends StatelessWidget {
  ...
  /// Creates a OutlineWatchAlt.
  const OutlineWatchAlt({
    super.key,
    this.size = 24,
    this.color,
  });
