...
class OutlineTableCells extends StatelessWidget {
  final double size;
  final Color? color;

  const OutlineTableCells({
    super.key,
    this.size = 24,
    this.color,
  });
