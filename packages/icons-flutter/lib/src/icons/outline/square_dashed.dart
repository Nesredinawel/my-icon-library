...
/// Outline style SquareDashed icon.
///
/// Example:
/// ```dart
/// OutlineSquareDashed(size: 24, color: Colors.blue);
/// ```
class OutlineSquareDashed extends StatelessWidget {
  ...
  /// Creates a OutlineSquareDashed.
  const OutlineSquareDashed({
    super.key,
    this.size = 24,
    this.color,
  });
