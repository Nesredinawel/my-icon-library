...
/// Outline style InboxArrowUp icon.
///
/// Example:
/// ```dart
/// OutlineInboxArrowUp(size: 24, color: Colors.blue);
/// ```
class OutlineInboxArrowUp extends StatelessWidget {
  ...
  /// Creates a OutlineInboxArrowUp.
  const OutlineInboxArrowUp({
    super.key,
    this.size = 24,
    this.color,
  });
