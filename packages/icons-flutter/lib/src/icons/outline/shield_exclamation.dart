...
/// Outline style ShieldExclamation icon.
///
/// Example:
/// ```dart
/// OutlineShieldExclamation(size: 24, color: Colors.blue);
/// ```
class OutlineShieldExclamation extends StatelessWidget {
  ...
  /// Creates a OutlineShieldExclamation.
