...
/// Outline style MailAlt3 icon.
///
/// Example:
/// ```dart
/// OutlineMailAlt3(size: 24, color: Colors.blue);
/// ```
class OutlineMailAlt3 extends StatelessWidget {
  ...
  /// Creates a OutlineMailAlt3.
  const OutlineMailAlt3({
    super.key,
    this.size = 24,
    this.color,
  });
