...
/// Outline style ClockEleven icon.
///
/// Example:
/// ```dart
/// OutlineClockEleven(size: 24, color: Colors.blue);
/// ```
class OutlineClockEleven extends StatelessWidget {
  ...
  /// Creates a OutlineClockEleven.
  const OutlineClockEleven({
    super.key,
    this.size = 24,
    this.color,
  });
