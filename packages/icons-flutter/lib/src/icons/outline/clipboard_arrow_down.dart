...
/// Outline style ClipboardArrowDown icon.
///
/// Example:
/// ```dart
/// OutlineClipboardArrowDown(size: 24, color: Colors.blue);
/// ```
class OutlineClipboardArrowDown extends StatelessWidget {
  ...
  /// Creates a OutlineClipboardArrowDown.
  const OutlineClipboardArrowDown({
    super.key,
    this.size = 24,
    this.color,
  });
