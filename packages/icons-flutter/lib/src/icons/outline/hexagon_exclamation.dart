...
/// Outline style HexagonExclamation icon.
///
/// Example:
/// ```dart
/// OutlineHexagonExclamation(size: 24, color: Colors.blue);
/// ```
class OutlineHexagonExclamation extends StatelessWidget {
  ...
  /// Creates a OutlineHexagonExclamation.
  const OutlineHexagonExclamation({
    super.key,
    this.size = 24,
    this.color,
  });
