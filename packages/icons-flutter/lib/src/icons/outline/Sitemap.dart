...
/// Outline style Sitemap icon.
///
/// Example:
/// ```dart
/// OutlineSitemap(size: 24, color: Colors.blue);
/// ```
class OutlineSitemap extends StatelessWidget {
  ...
  /// Creates a OutlineSitemap.
  const OutlineSitemap({
    super.key,
    this.size = 24,
    this.color,
  });
