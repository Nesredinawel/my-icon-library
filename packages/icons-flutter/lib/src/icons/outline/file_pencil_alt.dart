...
/// Outline style FilePencilAlt icon.
///
/// Example:
/// ```dart
/// OutlineFilePencilAlt(size: 24, color: Colors.blue);
/// ```
class OutlineFilePencilAlt extends StatelessWidget {
  ...
  /// Creates a OutlineFilePencilAlt.
  const OutlineFilePencilAlt({
    super.key,
    this.size = 24,
    this.color,
  });
