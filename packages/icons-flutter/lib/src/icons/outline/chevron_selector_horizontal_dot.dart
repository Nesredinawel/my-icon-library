...
/// Outline style ChevronSelectorHorizontalDot icon.
///
/// Example:
/// ```dart
/// OutlineChevronSelectorHorizontalDot(size: 24, color: Colors.blue);
/// ```
class OutlineChevronSelectorHorizontalDot extends StatelessWidget {
  ...
  /// Creates a OutlineChevronSelectorHorizontalDot.
