...
/// Outline style ClipboardPlus icon.
///
/// Example:
/// ```dart
/// OutlineClipboardPlus(size: 24, color: Colors.blue);
/// ```
class OutlineClipboardPlus extends StatelessWidget {
  ...
  /// Creates a OutlineClipboardPlus.
  const OutlineClipboardPlus({
    super.key,
    this.size = 24,
    this.color,
  });
