...
/// Outline style Calculator icon.
///
/// Example:
/// ```dart
/// OutlineCalculator(size: 24, color: Colors.blue);
/// ```
class OutlineCalculator extends StatelessWidget {
