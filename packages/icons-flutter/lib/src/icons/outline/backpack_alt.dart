...
/// Outline style BackpackAlt icon.
///
/// Example:
/// ```dart
/// OutlineBackpackAlt(size: 24, color: Colors.blue);
/// ```
class OutlineBackpackAlt extends StatelessWidget {
  ...
  /// Creates a OutlineBackpackAlt.
  const OutlineBackpackAlt({
    super.key,
    this.size = 24,
    this.color,
  });
