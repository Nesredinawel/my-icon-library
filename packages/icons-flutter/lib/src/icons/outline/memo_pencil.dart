...
/// Outline style MemoPencil icon.
///
/// Example:
/// ```dart
/// OutlineMemoPencil(size: 24, color: Colors.blue);
/// ```
class OutlineMemoPencil extends StatelessWidget {
  ...
  /// Creates a OutlineMemoPencil.
  const OutlineMemoPencil({
    super.key,
    this.size = 24,
    this.color,
  });
