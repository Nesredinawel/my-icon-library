...
/// Outline style SquareKanban icon.
///
/// Example:
/// ```dart
/// OutlineSquareKanban(size: 24, color: Colors.blue);
/// ```
class OutlineSquareKanban extends StatelessWidget {
  ...
  /// Creates a OutlineSquareKanban.
  const OutlineSquareKanban({
    super.key,
    this.size = 24,
    this.color,
  });
