...
/// Outline style Hospitals icon.
///
/// Example:
/// ```dart
/// OutlineHospitals(size: 24, color: Colors.blue);
/// ```
class OutlineHospitals extends StatelessWidget {
  ...
  /// Creates a OutlineHospitals.
  const OutlineHospitals({
    super.key,
    this.size = 24,
    this.color,
  });
