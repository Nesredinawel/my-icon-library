...
/// Outline style InboxMinus icon.
///
/// Example:
/// ```dart
/// OutlineInboxMinus(size: 24, color: Colors.blue);
/// ```
class OutlineInboxMinus extends StatelessWidget {
  ...
  /// Creates a OutlineInboxMinus.
  const OutlineInboxMinus({
    super.key,
    this.size = 24,
    this.color,
  });
