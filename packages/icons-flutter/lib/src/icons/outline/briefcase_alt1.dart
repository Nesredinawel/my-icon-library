...
/// Outline style BriefcaseAlt1 icon.
///
/// Example:
/// ```dart
/// OutlineBriefcaseAlt1(size: 24, color: Colors.blue);
/// ```
class OutlineBriefcaseAlt1 extends StatelessWidget {
  ...
  /// Creates a OutlineBriefcaseAlt1.
  const OutlineBriefcaseAlt1({
    super.key,
    this.size = 24,
    this.color,
  });
