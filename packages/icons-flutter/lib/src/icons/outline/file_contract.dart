...
/// Outline style FileContract icon.
///
/// Example:
/// ```dart
/// OutlineFileContract(size: 24, color: Colors.blue);
/// ```
class OutlineFileContract extends StatelessWidget {
  ...
  /// Creates a OutlineFileContract.
  const OutlineFileContract({
    super.key,
    this.size = 24,
    this.color,
  });
