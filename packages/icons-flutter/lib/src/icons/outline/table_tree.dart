...
/// Outline style TableTree icon.
///
/// Example:
/// ```dart
/// OutlineTableTree(size: 24, color: Colors.blue);
/// ```
class OutlineTableTree extends StatelessWidget {
  ...
  /// Creates a OutlineTableTree.
  const OutlineTableTree({
    super.key,
    this.size = 24,
    this.color,
  });
