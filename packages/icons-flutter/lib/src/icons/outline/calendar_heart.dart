...
/// Outline style CalendarHeart icon.
///
/// Example:
/// ```dart
/// OutlineCalendarHeart(size: 24, color: Colors.blue);
/// ```
class OutlineCalendarHeart extends StatelessWidget {
  ...
  /// Creates a OutlineCalendarHeart.
  const OutlineCalendarHeart({
    super.key,
    this.size = 24,
    this.color,
  });
