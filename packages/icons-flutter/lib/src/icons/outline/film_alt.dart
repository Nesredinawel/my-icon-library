...
/// Outline style FilmAlt icon.
///
/// Example:
/// ```dart
/// OutlineFilmAlt(size: 24, color: Colors.blue);
/// ```
class OutlineFilmAlt extends StatelessWidget {
  ...
  /// Creates a OutlineFilmAlt.
  const OutlineFilmAlt({
    super.key,
    this.size = 24,
    this.color,
  });
