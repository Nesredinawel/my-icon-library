...
/// Outline style BriefcaseAlt3 icon.
///
/// Example:
/// ```dart
/// OutlineBriefcaseAlt3(size: 24, color: Colors.blue);
/// ```
class OutlineBriefcaseAlt3 extends StatelessWidget {
  ...
  /// Creates a OutlineBriefcaseAlt3.
  const OutlineBriefcaseAlt3({
    super.key,
    this.size = 24,
    this.color,
  });
