...
/// Outline style MonitorWater icon.
///
/// Example:
/// ```dart
/// OutlineMonitorWater(size: 24, color: Colors.blue);
/// ```
class OutlineMonitorWater extends StatelessWidget {
  ...
  /// Creates a OutlineMonitorWater.
  const OutlineMonitorWater({
    super.key,
    this.size = 24,
    this.color,
  });
