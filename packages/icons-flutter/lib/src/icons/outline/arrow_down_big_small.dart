...
/// Outline style ArrowDownBigSmall icon.
///
/// Example:
/// ```dart
/// OutlineArrowDownBigSmall(size: 24, color: Colors.blue);
/// ```
class OutlineArrowDownBigSmall extends StatelessWidget {
  ...
  /// Creates a OutlineArrowDownBigSmall.
  const OutlineArrowDownBigSmall({
    super.key,
    this.size = 24,
    this.color,
  });
