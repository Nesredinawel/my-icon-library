...
/// Outline style GarageOpen icon.
///
/// Example:
/// ```dart
/// OutlineGarageOpen(size: 24, color: Colors.blue);
/// ```
class OutlineGarageOpen extends StatelessWidget {
  ...
  /// Creates a OutlineGarageOpen.
  const OutlineGarageOpen({
    super.key,
    this.size = 24,
    this.color,
  });
