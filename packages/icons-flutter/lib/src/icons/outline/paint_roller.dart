...
/// Outline style PaintRoller icon.
///
/// Example:
/// ```dart
/// OutlinePaintRoller(size: 24, color: Colors.blue);
/// ```
class OutlinePaintRoller extends StatelessWidget {
  ...
  /// Creates a OutlinePaintRoller.
  const OutlinePaintRoller({
    super.key,
    this.size = 24,
    this.color,
  });
