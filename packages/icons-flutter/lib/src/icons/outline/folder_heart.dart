...
/// Outline style FolderHeart icon.
///
/// Example:
/// ```dart
/// OutlineFolderHeart(size: 24, color: Colors.blue);
/// ```
class OutlineFolderHeart extends StatelessWidget {
  ...
  /// Creates a OutlineFolderHeart.
  const OutlineFolderHeart({
    super.key,
    this.size = 24,
    this.color,
  });
