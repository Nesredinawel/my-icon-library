...
export function Briefcase({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="m22 10.49-4.13 3.3c-.42.33-.74.59-1.1.77a4 4 0 0 1-1.02.36c-.4.08-.8.08-1.35.08H9.6c-.54 0-.95 0-1.35-.08a4 4 0 0 1-1.02-.36c-.36-.18-.68-.44-1.1-.78L2 10.48v5.77q-.01 1.2.04 2.01c.05.56.15 1.08.4 1.57a4 4 0 0 0 1.74 1.74c.49.25 1 .35 1.57.4q.8.05 2 .04h8.5q1.2.01 2-.04a4 4 0 0 0 1.57-.4 4 4 0 0 0 1.74-1.74c.25-.49.35-1 .4-1.57q.05-.8.04-2z"
      />
    </svg>
  );
}
