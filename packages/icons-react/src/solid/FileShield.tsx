  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M13 2H8.8c-1.68 0-2.52 0-3.16.33a3 3 0 0 0-1.31 1.3C4 4.29 4 5.13 4 6.8v10.4c0 1.68 0 2.52.33 3.16a3 3 0 0 0 1.3 1.31c.65.33 1.49.33 3.17.33h6.4c1.68 0 2.52 0 3.16-.33a3 3 0 0 0 1.31-1.3c.33-.65.33-1.49.33-3.17V9h-3.8c-1.12 0-1.68 0-2.1-.22a2 2 0 0 1-.88-.87C13 7.48 13 6.92 13 5.8zm-.64 9.16a.5.5 0 0 0-.72 0 3.2 3.2 0 0 1-2.3 1.05h-.31a.5.5 0 0 0-.53.5v1.19c0 2.39 1.38 4.47 3.35 5.08q.15.05.3 0c1.97-.6 3.35-2.7 3.35-5.08v-1.2a.5.5 0 0 0-.53-.5h-.31a3.2 3.2 0 0 1-2.3-1.05"
        clip-rule="evenodd"
      />
      <path
        fill="currentColor"
