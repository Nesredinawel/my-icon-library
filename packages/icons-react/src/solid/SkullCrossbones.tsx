...
export function SkullCrossbones({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M2.07 13.64a1 1 0 0 1 1.3-.57L12 16.43l8.64-3.36a1 1 0 1 1 .72 1.86l-6.6 2.57 6.6 2.57a1 1 0 0 1-.72 1.86L12 18.57l-8.64 3.36a1 1 0 1 1-.72-1.86l6.6-2.57-6.6-2.57a1 1 0 0 1-.57-1.3"
      />
    </svg>
  );
}
