...
export function FilesAlt({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M6 7a1 1 0 1 0-2 0v7.64q-.01 1.62.06 2.67c.06.73.18 1.37.48 1.96a5 5 0 0 0 2.19 2.18c.6.3 1.23.43 1.96.5q1.04.06 2.67.05H15a1 1 0 1 0 0-2h-3.6c-1.14 0-1.93 0-2.55-.05-.6-.05-.95-.14-1.21-.28a3 3 0 0 1-1.31-1.3 3 3 0 0 1-.28-1.22A35 35 0 0 1 6 14.6z"
      />
    </svg>
  );
}
