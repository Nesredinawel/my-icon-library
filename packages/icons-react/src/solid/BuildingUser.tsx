...
export function BuildingUser({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M15.2 13.5a2.5 2.5 0 1 1 5 0 2.5 2.5 0 0 1-5 0m-1.4 5.55A3 3 0 0 1 16.64 17h2.12a3 3 0 0 1 2.85 2.05l.2.6.14.48c.04.17.09.44.01.74q-.15.57-.65.9c-.26.16-.52.2-.7.22l-.49.01h-4.84l-.5-.01a1.5 1.5 0 0 1-.7-.23 1.5 1.5 0 0 1-.64-.9c-.08-.3-.03-.56.01-.73l.14-.47z"
      />
    </svg>
  );
}
