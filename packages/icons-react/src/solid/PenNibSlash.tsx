...
export function PenNibSlash({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M20.6 9.82 19.4 11 13 4.59l1.18-1.19.52-.49c.17-.14.4-.3.68-.4a2 2 0 0 1 1.24 0c.29.1.51.26.68.4q.25.21.52.5l2.78 2.77.49.52q.23.26.4.68a2 2 0 0 1 0 1.24q-.17.42-.4.68-.21.25-.5.52M18.18 14l.31-1.1-7.4-7.4-1.09.32z"
      />
    </svg>
  );
}
