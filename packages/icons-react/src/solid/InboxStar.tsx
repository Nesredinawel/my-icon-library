...
export function InboxStar({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M12 6.36c.3 0 .58.15.74.4l.78 1.12 1.31.39a.9.9 0 0 1 .46 1.42l-.83 1.08.03 1.37a.9.9 0 0 1-1.2.87L12 12.56l-1.3.44a.9.9 0 0 1-1.2-.87l.03-1.37-.83-1.08a.9.9 0 0 1 .46-1.42l1.31-.39.77-1.13a.9.9 0 0 1 .75-.4"
      />
      <path
        fill="currentColor"
        fill-rule="evenodd"
