...
export function ChartUserSquare({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M10 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0m-8 8.8c0-.74 0-1.11.05-1.43a4 4 0 0 1 3.32-3.32C5.7 16 6.06 16 6.8 16h.4c.74 0 1.11 0 1.43.05a4 4 0 0 1 3.32 3.32c.05.32.05.69.05 1.43l-.01.36a1 1 0 0 1-.83.83l-.36.01H3.2l-.36-.01a1 1 0 0 1-.83-.83z"
      />
    </svg>
  );
}
