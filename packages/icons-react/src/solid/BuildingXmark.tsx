...
export function BuildingXmark({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="m16.7 15.3 1.8 1.79 1.8-1.8a1 1 0 0 1 1.4 1.42l-1.79 1.79 1.8 1.8a1 1 0 0 1-1.42 1.4l-1.79-1.79-1.8 1.8a1 1 0 0 1-1.4-1.42l1.79-1.79-1.8-1.8a1 1 0 0 1 1.42-1.4"
      />
    </svg>
  );
}
