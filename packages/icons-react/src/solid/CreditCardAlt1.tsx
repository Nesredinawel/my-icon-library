...
export function CreditCardAlt1({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M17.84 4H6.16q-.8 0-1.36.03c-.39.03-.78.1-1.16.3a3 3 0 0 0-1.31 1.3A3 3 0 0 0 2.02 7h19.96l-.01-.2a3 3 0 0 0-.3-1.16 3 3 0 0 0-1.3-1.31c-.39-.2-.78-.27-1.18-.3A18 18 0 0 0 17.85 4M22 8H2v2h20z"
      />
      <path
        fill="currentColor"
        fill-rule="evenodd"
