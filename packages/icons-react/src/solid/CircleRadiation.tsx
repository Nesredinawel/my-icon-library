...
export function CircleRadiation({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M9.78 9.98a3 3 0 0 0-.6 1.02H7.1c.23-1.02.8-1.92 1.62-2.6zM14.83 11a3 3 0 0 0-.61-1.02l1.05-1.58a4.8 4.8 0 0 1 1.62 2.6zm-4.41 5.67 1.14-1.7a3 3 0 0 0 .88 0l1.14 1.7a4 4 0 0 1-3.16 0M11 12a1 1 0 1 1 2 0 1 1 0 0 1-2 0"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
