...
export function InboxXmark({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M9.3 6.8a1 1 0 0 1 1.4 0L12 8.08l1.3-1.3a1 1 0 1 1 1.4 1.42l-1.28 1.3 1.3 1.3a1 1 0 0 1-1.42 1.4L12 10.92l-1.3 1.3a1 1 0 0 1-1.4-1.42l1.29-1.29-1.3-1.3a1 1 0 0 1 0-1.4"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
