...
export function SquareParkingSlash({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="m13.23 9.02 1.25 1.25a1.5 1.5 0 0 0-1.25-1.25"
      />
      <path
        fill="currentColor"
        d="M16.5 10.5q0 .79-.32 1.47L21 16.79V7.8c0-1.68 0-2.52-.33-3.16a3 3 0 0 0-1.3-1.31C18.71 3 17.87 3 16.2 3H7.21l4 4H13a3.5 3.5 0 0 1 3.5 3.5"
      />
    </svg>
  );
}
