...
export function CameraSlash({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M17 12.76a5 5 0 0 0-4.76-4.75L8.11 3.88a3 3 0 0 1 1.78-.86q.26-.03.56-.02h3.1q.3 0 .56.02a3 3 0 0 1 2.43 1.83l.02.04.06.1.13.01h1.09q.8 0 1.36.03c.39.03.78.1 1.16.3a3 3 0 0 1 1.31 1.3c.2.39.27.78.3 1.17q.04.57.03 1.36v8.6z"
      />
    </svg>
  );
}
