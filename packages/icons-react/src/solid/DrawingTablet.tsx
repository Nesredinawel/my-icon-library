...
export function DrawingTablet({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M12 13.55c0 .53 0 .8.06 1.05a2 2 0 0 0 .29.62c.14.2.34.38.74.74l5.92 5.17a1.41 1.41 0 0 0 1.85-2.12l-5.96-5.22c-.33-.3-.5-.44-.69-.54a2 2 0 0 0-.53-.2c-.21-.05-.44-.05-.88-.05h-.3a.5.5 0 0 0-.5.5z"
      />
    </svg>
  );
}
