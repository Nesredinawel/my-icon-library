...
export function Calendars({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M7 7.2c0-1.12 0-1.68.22-2.1a2 2 0 0 1 .87-.88C8.52 4 9.08 4 10.2 4h7.6c1.12 0 1.68 0 2.1.22q.58.3.88.87c.22.43.22.99.22 2.11V8H7z"
