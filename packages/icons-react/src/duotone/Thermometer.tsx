...
export function Thermometer({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M12.87 15.13 20 8a2.83 2.83 0 1 0-4-4l-7.13 7.13a8 8 0 0 0-1.28 1.44 4 4 0 0 0-.48 1.15c-.11.46-.11.95-.11 1.93V17h1.35c.98 0 1.47 0 1.93-.11a4 4 0 0 0 1.15-.48c.4-.25.75-.6 1.44-1.28"
        opacity=".14"
      />
      <path
        stroke="currentColor"
