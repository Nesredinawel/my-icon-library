...
export function RestaurantMenu({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M5 9.2c0-1.12 0-1.68.22-2.1a2 2 0 0 1 .87-.88C6.52 6 7.08 6 8.2 6h7.6c1.12 0 1.68 0 2.1.22q.58.3.88.87c.22.43.22.99.22 2.11v8.6c0 1.12 0 1.68-.22 2.1a2 2 0 0 1-.87.88c-.43.22-.99.22-2.11.22H8.2c-1.12 0-1.68 0-2.1-.22a2 2 0 0 1-.88-.87C5 19.48 5 18.92 5 17.8z"
