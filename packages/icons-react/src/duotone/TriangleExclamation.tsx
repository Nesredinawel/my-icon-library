...
export function TriangleExclamation({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M9.2 6.1c.91-1.66 1.37-2.5 1.97-2.77a2 2 0 0 1 1.66 0c.6.28 1.06 1.1 1.97 2.77l5.6 10.16c.85 1.56 1.28 2.34 1.2 2.98a2 2 0 0 1-.82 1.39c-.52.37-1.41.37-3.2.37H6.42c-1.78 0-2.67 0-3.2-.37a2 2 0 0 1-.81-1.4c-.08-.63.35-1.41 1.2-2.97z"
        opacity=".14"
      />
      <path
        stroke="currentColor"
