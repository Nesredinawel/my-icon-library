...
export function ImagesUser({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M6 6.2c0-1.12 0-1.68.22-2.1a2 2 0 0 1 .87-.88C7.52 3 8.08 3 9.2 3h8.6c1.12 0 1.68 0 2.1.22q.58.3.88.87c.22.43.22.99.22 2.11v8.6c0 1.12 0 1.68-.22 2.1a2 2 0 0 1-.87.88c-.43.22-.99.22-2.11.22H9.2c-1.12 0-1.68 0-2.1-.22a2 2 0 0 1-.88-.87C6 16.48 6 15.92 6 14.8z"
