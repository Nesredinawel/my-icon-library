...
export function FolderImage({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M21 13.98v1.82c0 1.12 0 1.68-.22 2.1a2 2 0 0 1-.87.88c-.43.22-.99.22-2.11.22H6.96l5-5.02 1.65 1.37 4.26-4.37zm-13.03-6a2 2 0 1 1 0 4 2 2 0 0 1 0-4"
        opacity=".14"
      />
      <path
        stroke="currentColor"
