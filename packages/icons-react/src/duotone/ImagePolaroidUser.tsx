...
export function ImagePolaroidUser({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M4 16h16v.8c0 1.12 0 1.68-.22 2.1a2 2 0 0 1-.87.88c-.43.22-.99.22-2.11.22H7.2c-1.12 0-1.68 0-2.1-.22a2 2 0 0 1-.88-.87C4 18.48 4 17.92 4 16.8z"
