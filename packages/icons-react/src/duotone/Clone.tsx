...
export function Clone({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M9.1 15.78c.42.22.98.22 2.1.22h4c.44 0 .8.36.8.8 0 1.12 0 1.68-.22 2.1a2 2 0 0 1-.87.88c-.43.22-.99.22-2.11.22H7.2c-1.12 0-1.68 0-2.1-.22a2 2 0 0 1-.88-.87C4 18.48 4 17.92 4 16.8v-5.6c0-1.12 0-1.68.22-2.1a2 2 0 0 1 .87-.88C5.52 8 6.08 8 7.2 8c.44 0 .8.36.8.8v4c0 1.12 0 1.68.22 2.1q.3.58.87.88"
        opacity=".14"
      />
      <path
        stroke="currentColor"
