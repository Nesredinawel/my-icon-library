...
export function HouseSun({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M12.4 9.02 8 13.13v6.27c0 .56 0 .84.1 1.05a1 1 0 0 0 .45.44c.21.11.49.11 1.05.11h7.8c.56 0 .84 0 1.05-.1a1 1 0 0 0 .44-.45c.11-.21.11-.49.11-1.05v-6.27l-4.4-4.11c-.4-.36-.59-.54-.8-.6a1 1 0 0 0-.6 0c-.21.06-.4.24-.8.6"
