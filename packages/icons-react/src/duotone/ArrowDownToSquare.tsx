...
export function ArrowDownToSquare({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M3 12.2c0-1.12 0-1.68.22-2.1a2 2 0 0 1 .87-.88C4.52 9 5.08 9 6.2 9h11.6c1.12 0 1.68 0 2.1.22q.58.3.88.87c.22.43.22.99.22 2.11v4.6c0 1.12 0 1.68-.22 2.1a2 2 0 0 1-.87.88c-.43.22-.99.22-2.11.22H6.2c-1.12 0-1.68 0-2.1-.22a2 2 0 0 1-.88-.87C3 18.48 3 17.92 3 16.8z"
