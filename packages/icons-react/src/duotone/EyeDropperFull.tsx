...
export function EyeDropperFull({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M20 8a2.83 2.83 0 1 0-4-4l-2.8 2.8 4 4zM9.3 10.7l-2.9 2.9c-.51.51-.77.77-.96 1.08a3 3 0 0 0-.36.86C5 15.9 5 16.25 5 17v1l-2 3 3-2h1.01c.74 0 1.1 0 1.45-.08a3 3 0 0 0 .86-.36c.3-.19.57-.45 1.09-.97l2.88-2.88z"
