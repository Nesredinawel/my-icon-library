...
export function Chimney({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M3.1 3.55C3 3.76 3 4.04 3 4.6v2.8c0 .56 0 .84.1 1.05a1 1 0 0 0 .45.44C3.76 9 4.04 9 4.6 9H5v7h14V9h.4c.56 0 .84 0 1.05-.1a1 1 0 0 0 .44-.45c.11-.21.11-.49.11-1.05V4.6c0-.56 0-.84-.1-1.05a1 1 0 0 0-.45-.44C20.24 3 19.96 3 19.4 3H4.6c-.56 0-.84 0-1.05.1a1 1 0 0 0-.44.45"
