...
export function CreditCardScan({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M6 10.2c0-1.12 0-1.68.22-2.1a2 2 0 0 1 .87-.88C7.52 7 8.08 7 9.2 7h5.6c1.12 0 1.68 0 2.1.22q.58.3.88.87c.22.43.22.99.22 2.11v3.6c0 1.12 0 1.68-.22 2.1a2 2 0 0 1-.87.88c-.43.22-.99.22-2.11.22H9.2c-1.12 0-1.68 0-2.1-.22a2 2 0 0 1-.88-.87C6 15.48 6 14.92 6 13.8z"
