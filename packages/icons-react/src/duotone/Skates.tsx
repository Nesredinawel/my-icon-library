...
export function Skates({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M13 6.2c0-1.12 0-1.68.22-2.1a2 2 0 0 1 .87-.88C14.52 3 15.08 3 16.2 3h.6c1.12 0 1.68 0 2.1.22q.58.3.88.87c.22.43.22.99.22 2.11v9.2c0 .56 0 .84-.1 1.05a1 1 0 0 1-.45.44c-.21.11-.49.11-1.05.11H8.19a2.19 2.19 0 0 1 0-4.37h2.48c.3 0 .46 0 .6-.02a2 2 0 0 0 1.71-1.72c.02-.13.02-.29.02-.6z"
