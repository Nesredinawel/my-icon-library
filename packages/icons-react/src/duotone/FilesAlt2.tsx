...
export function FilesAlt2({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M10.2 5H17v2.4c0 .56 0 .84.1 1.05a1 1 0 0 0 .45.44c.21.11.49.11 1.05.11H21v2.8c0 1.12 0 1.68-.22 2.1a2 2 0 0 1-.87.88c-.43.22-.99.22-2.11.22h-7.6c-1.12 0-1.68 0-2.1-.22a2 2 0 0 1-.88-.87C7 13.48 7 12.92 7 11.8V8.2c0-1.12 0-1.68.22-2.1a2 2 0 0 1 .87-.88C8.52 5 9.08 5 10.2 5"
        opacity=".14"
      />
      <path
        stroke="currentColor"
