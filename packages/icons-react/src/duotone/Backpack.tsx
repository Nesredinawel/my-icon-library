...
export function Backpack({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M6 10.8c0-1.68 0-2.52.33-3.16a3 3 0 0 1 1.3-1.31C8.29 6 9.13 6 10.8 6h2.4c1.68 0 2.52 0 3.16.33a3 3 0 0 1 1.31 1.3c.33.65.33 1.49.33 3.17v5.4c0 1.68 0 2.52-.33 3.16a3 3 0 0 1-1.3 1.31c-.65.33-1.49.33-3.17.33h-2.4c-1.68 0-2.52 0-3.16-.33a3 3 0 0 1-1.31-1.3C6 18.71 6 17.87 6 16.2z"
        opacity=".14"
      />
      <path
        stroke="currentColor"
