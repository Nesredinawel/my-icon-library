...
export function BuildingCar({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M3 4.6c0-.56 0-.84.1-1.05a1 1 0 0 1 .45-.44C3.76 3 4.04 3 4.6 3h8.8c.56 0 .84 0 1.05.1a1 1 0 0 1 .44.45c.11.21.11.49.11 1.05V12h-2.56a2 2 0 0 0-1.9 1.37l-.62 1.95a2 2 0 0 0-.66.7A2 2 0 0 0 7 18v3H3z"
