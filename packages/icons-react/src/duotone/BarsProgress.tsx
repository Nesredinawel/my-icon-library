...
export function BarsProgress({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M3 6.6c0-.56 0-.84.1-1.05a1 1 0 0 1 .45-.44C3.76 5 4.04 5 4.6 5H15v5H4.6c-.56 0-.84 0-1.05-.1a1 1 0 0 1-.44-.45C3 9.24 3 8.96 3 8.4zm0 9c0-.56 0-.84.1-1.05a1 1 0 0 1 .45-.44C3.76 14 4.04 14 4.6 14H9v5H4.6c-.56 0-.84 0-1.05-.1a1 1 0 0 1-.44-.45C3 18.24 3 17.96 3 17.4z"
