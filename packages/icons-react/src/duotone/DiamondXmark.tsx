...
export function DiamondXmark({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M19.74 9.74c.79.79 1.19 1.19 1.33 1.64a2 2 0 0 1 0 1.24c-.14.45-.54.85-1.33 1.64L17 17l-5-5-5 5-2.74-2.74c-.79-.79-1.19-1.19-1.33-1.64a2 2 0 0 1 0-1.24c.14-.45.54-.85 1.33-1.64L7 7l5 5 5-5z"
        opacity=".14"
      />
      <path
        stroke="currentColor"
