  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke-width="2"
        d="M12 14H8m13-2v-.8c0-1.12 0-1.68-.22-2.1a2 2 0 0 0-.87-.88C19.48 8 18.92 8 17.8 8H3m18 4v4m0-4h-2a2 2 0 1 0 0 4h2m0 0v.8c0 1.12 0 1.68-.22 2.1a2 2 0 0 1-.87.88c-.43.22-.99.22-2.11.22H6.2c-1.12 0-1.68 0-2.1-.22a2 2 0 0 1-.88-.87C3 18.48 3 17.92 3 16.8V8m15 0v-.8c0-1.12 0-1.68-.22-2.1a2 2 0 0 0-.87-.88C16.48 4 15.92 4 14.8 4H6.2c-1.12 0-1.68 0-2.1.22a2 2 0 0 0-.88.87C3 5.52 3 6.08 3 7.2V8"
        fill="none"
      />
    </svg>
  );
