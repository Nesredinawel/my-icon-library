  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke-width="2"
        d="M10.5 10.18a2.3 2.3 0 0 0-1.6-.68c-1.32 0-2.4 1.2-2.4 2.7s1.08 2.7 2.4 2.7c.62 0 1.18-.25 1.6-.68m7-4.04a2.3 2.3 0 0 0-1.6-.68c-1.32 0-2.4 1.2-2.4 2.7s1.08 2.7 2.4 2.7c.62 0 1.18-.25 1.6-.68M6.2 19h11.6c1.12 0 1.68 0 2.1-.22a2 2 0 0 0 .88-.87c.22-.43.22-.99.22-2.11V8.2c0-1.12 0-1.68-.22-2.1a2 2 0 0 0-.87-.88C19.48 5 18.92 5 17.8 5H6.2c-1.12 0-1.68 0-2.1.22a2 2 0 0 0-.88.87C3 6.52 3 7.08 3 8.2v7.6c0 1.12 0 1.68.22 2.1q.3.58.87.88c.43.22.99.22 2.11.22"
      />
    </svg>
  );
}
