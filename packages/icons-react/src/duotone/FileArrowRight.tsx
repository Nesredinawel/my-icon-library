  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke-width="2"
        d="M15 17h6m0 0-2 2m2-2-2-2M13 3H8.2c-1.12 0-1.68 0-2.1.22a2 2 0 0 0-.88.87C5 4.52 5 5.08 5 6.2v11.6c0 1.12 0 1.68.22 2.1q.3.58.87.88c.43.22.99.22 2.11.22H15M13 3l6 6m-6-6v4.4c0 .56 0 .84.1 1.05a1 1 0 0 0 .45.44c.21.11.49.11 1.05.11H19m0 0v2.02"
        fill="none"
      />
    </svg>
  );
