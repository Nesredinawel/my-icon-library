...
export function FingerprintAlt({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M2.76 14a9.25 9.25 0 1 1 18.49 0 3.75 3.75 0 1 1-7.5 0 1.75 1.75 0 1 0-3.5 0c0 2.6 1.37 4.87 3.42 6.15a1 1 0 0 1-1.06 1.7A9.2 9.2 0 0 1 8.25 14a3.75 3.75 0 1 1 7.5 0 1.75 1.75 0 1 0 3.5 0 7.25 7.25 0 1 0-14.5 0q0 1.41.3 2.74a1 1 0 0 1-1.95.43A15 15 0 0 1 2.76 14"
        opacity=".3"
      />
      <path
        fill="currentColor"
