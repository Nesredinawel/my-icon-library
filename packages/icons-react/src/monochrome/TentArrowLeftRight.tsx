...
export function TentArrowLeftRight({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M5.7 2.3a1 1 0 0 1 0 1.4l-.29.3H9a1 1 0 0 1 0 2H5.41l.3.3a1 1 0 0 1-1.42 1.4l-2-2a1 1 0 0 1 0-1.4l2-2a1 1 0 0 1 1.42 0m12.59 0a1 1 0 0 1 1.4 0l2 2a1 1 0 0 1 0 1.4l-2 2a1 1 0 1 1-1.4-1.4l.29-.3H15a1 1 0 1 1 0-2h3.59l-.3-.3a1 1 0 0 1 0-1.4M12 22v-7l4.5 7z"
      />
    </svg>
  );
}
