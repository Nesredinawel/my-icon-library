...
export function FileBookmark({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M14 2v5.2c0 .28 0 .42.05.53q.08.15.22.22c.11.05.25.05.53.05H20zM9.5 12.5c0-.28.22-.5.5-.5h4c.28 0 .5.22.5.5v6a.5.5 0 0 1-.76.43L12 17.89l-1.74 1.04a.5.5 0 0 1-.76-.43z"
      />
    </svg>
  );
}
