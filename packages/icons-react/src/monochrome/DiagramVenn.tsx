...
export function DiagramVenn({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M17 12a8 8 0 0 1-5 7.42q1.4.57 3 .58a8 8 0 1 0-3-15.42A8 8 0 0 1 17 12M7 12c0-2.37 1.03-4.5 2.67-5.96q1.27.15 2.33.76a6 6 0 0 0 0 10.4q-1.06.61-2.33.76A8 8 0 0 1 7 12"
        opacity=".3"
      />
      <path
        fill="currentColor"
