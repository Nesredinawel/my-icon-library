  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M12 9q.37 0 .64.28c.47.51 1.07.8 1.7.8h.24q.37-.02.64.24.27.27.28.64v1.06c0 2.28-1.3 4.34-3.24 4.94a1 1 0 0 1-.52 0c-1.94-.6-3.24-2.66-3.24-4.94v-1.06q0-.37.28-.64.27-.26.64-.24h.25c.62 0 1.22-.29 1.7-.8q.26-.27.63-.28"
        clip-rule="evenodd"
      />
    </svg>
  );
