...
export function EnglishToChinese({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M17 12.5a1 1 0 0 1 1 1v.5h2a1 1 0 1 1 0 2h-.02a6.5 6.5 0 0 1-1.4 3.57q.7.33 1.51.41a1 1 0 0 1-.18 2 6.5 6.5 0 0 1-2.91-1 6.6 6.6 0 0 1-2.91 1 1 1 0 1 1-.18-2q.81-.09 1.52-.41a7 7 0 0 1-.72-1.11 1 1 0 0 1 1.78-.92q.21.43.51.79.82-1 .97-2.33H14a1 1 0 1 1 0-2h2v-.5a1 1 0 0 1 1-1M7 14a1 1 0 0 1 1 1c0 .48 0 .79.02 1.03q.02.31.06.35.17.38.54.54.04.04.35.06c.24.02.55.02 1.03.02a1 1 0 1 1 0 2h-.03q-.66 0-1.13-.02a3 3 0 0 1-.99-.2 3 3 0 0 1-1.62-1.63 3 3 0 0 1-.2-.99q-.04-.47-.03-1.13V15a1 1 0 0 1 1-1"
        opacity=".3"
      />
    </svg>
  );
