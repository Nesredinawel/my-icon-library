  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M4 9h7v4H4zm9 0h7v4h-7zm7 6h-7v4h5.4c.56 0 .84 0 1.05-.1a1 1 0 0 0 .44-.45c.11-.21.11-.49.11-1.05zM4 15h7v4H5.6c-.56 0-.84 0-1.05-.1a1 1 0 0 1-.44-.45C4 18.24 4 17.96 4 17.4z"
        clip-rule="evenodd"
        opacity=".3"
      />
      <path
