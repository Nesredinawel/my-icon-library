  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M13.95 8.68a1 1 0 0 0-1.9.64l2 6a1 1 0 0 0 1.9 0l2-6a1 1 0 0 0-1.9-.64L15 11.84zM10 8h-.03q-.66 0-1.13.02-.5.02-.99.2a3 3 0 0 0-1.62 1.63q-.2.5-.2.99-.04.47-.03 1.13v.06q0 .66.02 1.13.02.5.2.99a3 3 0 0 0 1.63 1.62q.5.2.99.2.47.04 1.13.03H10a1 1 0 1 0 0-2c-.48 0-.79 0-1.03-.02a1 1 0 0 1-.35-.06 1 1 0 0 1-.54-.54 1 1 0 0 1-.06-.35C8 12.79 8 12.48 8 12s0-.79.02-1.03q.02-.31.06-.35a1 1 0 0 1 .54-.54q.04-.04.35-.06C9.21 10 9.52 10 10 10a1 1 0 0 0 0-2"
        clip-rule="evenodd"
      />
    </svg>
  );
