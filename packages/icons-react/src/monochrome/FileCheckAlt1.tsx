...
export function FileCheckAlt1({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M14 7.2V2l6 6h-5.2c-.28 0-.42 0-.53-.05a.5.5 0 0 1-.22-.22C14 7.62 14 7.48 14 7.2m7.7 10.5a1 1 0 0 0-1.4-1.4L17 19.58l-1.3-1.3a1 1 0 0 0-1.4 1.42l2 2a1 1 0 0 0 1.4 0z"
      />
    </svg>
  );
}
