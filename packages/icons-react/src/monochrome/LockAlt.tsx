...
export function LockAlt({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M6 8a6 6 0 1 1 12 0v1.15a6 6 0 0 0-.75-.1A17 17 0 0 0 16 9V8a4 4 0 0 0-8 0v1q-.72 0-1.25.04-.38.04-.75.11zm6 5.5a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0v-2a1 1 0 0 1 1-1"
      />
    </svg>
  );
}
