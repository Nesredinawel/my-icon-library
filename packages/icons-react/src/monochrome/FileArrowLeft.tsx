...
export function FileArrowLeft({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M14 7.2V2l6 6h-5.2c-.28 0-.42 0-.53-.05a.5.5 0 0 1-.22-.22C14 7.62 14 7.48 14 7.2m3.7 8.5a1 1 0 0 0-1.4-1.4l-2 2a1 1 0 0 0 0 1.4l2 2a1 1 0 0 0 1.4-1.4l-.29-.3H21a1 1 0 1 0 0-2h-3.59z"
      />
    </svg>
  );
}
