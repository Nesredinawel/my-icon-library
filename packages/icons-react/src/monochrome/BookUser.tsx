...
export function BookUser({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M10 7.5a2 2 0 1 1 4 0 2 2 0 0 1-4 0m2 3a4 4 0 0 0-3.35 1.81c-.18.28-.27.42-.25.76.01.22.21.6.4.73.26.2.52.2 1.04.2h4.32c.52 0 .78 0 1.05-.2.18-.14.38-.5.4-.73.01-.34-.08-.48-.26-.76A4 4 0 0 0 12 10.5M7 18a1 1 0 1 0 0 2h11v-2z"
      />
    </svg>
  );
}
