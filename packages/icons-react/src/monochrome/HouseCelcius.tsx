  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M16 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0m-4.03 1H13a1 1 0 1 1 0 2h-1c-.48 0-.79 0-1.03.02q-.31.02-.35.06a1 1 0 0 0-.54.54q-.04.04-.06.35c-.02.24-.02.55-.02 1.03s0 .79.02 1.03q.02.31.06.35.17.38.54.54.04.04.35.06c.24.02.55.02 1.03.02h1a1 1 0 1 1 0 2h-1.03q-.66 0-1.13-.02a3 3 0 0 1-.99-.2 3 3 0 0 1-1.62-1.63 3 3 0 0 1-.2-.99Q7.98 14.68 8 14v-.18l.02-.98q.02-.5.2-.99a3 3 0 0 1 1.63-1.62q.5-.2.99-.2.47-.04 1.13-.03"
        clip-rule="evenodd"
      />
    </svg>
  );
