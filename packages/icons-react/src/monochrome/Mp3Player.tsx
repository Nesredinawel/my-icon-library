...
export function Mp3Player({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M18 10H6V6.2c0-.58 0-.95.02-1.23.03-.27.06-.37.09-.42a1 1 0 0 1 .44-.44c.05-.03.15-.06.42-.09A17 17 0 0 1 8.2 4h7.6c.58 0 .95 0 1.23.02.27.03.37.06.42.09a1 1 0 0 1 .44.44c.03.05.06.15.09.42.02.28.02.65.02 1.23z"
      />
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M8 16a4 4 0 1 1 8 0 4 4 0 0 1-8 0m4-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4"
        clip-rule="evenodd"
      />
    </svg>
  );
