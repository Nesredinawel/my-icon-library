...
export function MonitorAlt1({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M4.1 4.55C4 4.76 4 5.04 4 5.6V14h16V5.6c0-.56 0-.84-.1-1.05a1 1 0 0 0-.45-.44C19.24 4 18.96 4 18.4 4H5.6c-.56 0-.84 0-1.05.1a1 1 0 0 0-.44.45M8.22 20l.5-2h2.06l-.5 2h3.44l-.5-2h2.06l.5 2H17a1 1 0 1 1 0 2H7a1 1 0 1 1 0-2z"
      />
    </svg>
  );
}
