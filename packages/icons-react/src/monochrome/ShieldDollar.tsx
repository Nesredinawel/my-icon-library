  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M13 7.5a1 1 0 1 0-2 0v.44q-.56.09-1.07.42C9.36 8.76 9 9.38 9 10.2c0 .92.5 1.56 1.15 1.91.59.32 1.28.4 1.85.4q.69.01.92.14l.06.04v.02l.02.12-.06.05q-.2.14-.82.23h-.29c-.58 0-.93 0-1.7-.1a1 1 0 0 0-.25 2l1.12.1v.4a1 1 0 1 0 2 0v-.53q.54-.13 1-.4c.56-.36 1-.94 1-1.76q0-.65-.33-1.2-.34-.52-.84-.75c-.6-.3-1.29-.36-1.83-.36q-.65-.01-.9-.16l-.07-.04-.02-.02v-.01L11 10.2l.02-.14.05-.04q.11-.1.56-.13H12c.72 0 1.4 0 1.75.09a1 1 0 1 0 .48-1.94 6 6 0 0 0-1.24-.14z"
        clipRule="evenodd"
      />
    </svg>
  );
