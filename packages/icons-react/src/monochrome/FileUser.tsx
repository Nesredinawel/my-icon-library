...
export function FileUser({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M14 2v5.2c0 .28 0 .42.05.53q.08.15.22.22c.11.05.25.05.53.05H20zm-4 12a2 2 0 1 1 4 0 2 2 0 0 1-4 0m2 3c2.1 0 3.98 1.2 4.73 3H7.27c.75-1.8 2.62-3 4.73-3"
      />
    </svg>
  );
}
