...
export function PenLine({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M20.6 3.24a2.5 2.5 0 0 0-3.54 0L15.5 4.79l3.54 3.54 1.55-1.56a2.5 2.5 0 0 0 0-3.53M12.93 19.5c-.51 0-.93.45-.93 1s.42 1 .93 1h7.46c.51 0 .93-.45.93-1s-.42-1-.93-1z"
      />
    </svg>
  );
}
