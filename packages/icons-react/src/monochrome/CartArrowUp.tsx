...
export function CartArrowUp({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M12.8 2.3a1 1 0 0 1 1.4 0l2 2a1 1 0 0 1-1.4 1.4l-.3-.29V9a1 1 0 1 1-2 0V5.41l-.3.3a1 1 0 1 1-1.4-1.42zM6 20a2 2 0 1 1 4 0 2 2 0 0 1-4 0m11 0a2 2 0 1 1 4 0 2 2 0 0 1-4 0"
      />
    </svg>
  );
}
