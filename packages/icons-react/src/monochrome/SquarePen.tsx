  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M14.09 7.52A1.76 1.76 0 0 1 16.57 10l-5.14 5.15a8 8 0 0 1-1.06.97 4 4 0 0 1-.83.45c-.34.13-.69.2-1.4.34l-.1.01c-.4.08-.6.13-.75.06a.5.5 0 0 1-.27-.28c-.05-.14 0-.34.09-.74l.03-.15c.16-.66.24-.99.37-1.3a4 4 0 0 1 .43-.77c.19-.27.43-.5.9-.99z"
        clipRule="evenodd"
      />
    </svg>
  );
