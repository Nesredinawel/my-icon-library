...
export function BluetoothSignal({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M19.03 5.63a1 1 0 0 1 1.36.37 12 12 0 0 1 0 12 1 1 0 1 1-1.73-1 10 10 0 0 0 0-10 1 1 0 0 1 .37-1.37M15.9 8.1a1 1 0 0 1 1.33.47 8 8 0 0 1 0 6.86 1 1 0 0 1-1.8-.86 6 6 0 0 0 0-5.14 1 1 0 0 1 .47-1.33"
        opacity=".3"
      />
      <path
        fill="currentColor"
