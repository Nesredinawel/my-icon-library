  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M8.5 11.95a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0m4.8 0a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0m4.7 0a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0"
        clip-rule="evenodd"
      />
    </svg>
  );
