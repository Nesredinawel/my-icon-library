...
export function UserPen({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M11 2a5 5 0 1 0 0 10 5 5 0 0 0 0-10m0 11a8 8 0 0 0-8 8 1 1 0 0 0 1 1h6.04a3 3 0 0 1-.01-.85c.03-.21.09-.45.12-.61l.07-.3q.18-.81.44-1.5a6 6 0 0 1 .65-1.16q.44-.58 1.04-1.16l2.46-2.46A8 8 0 0 0 11 13"
        opacity=".3"
      />
      <path
        fill="currentColor"
