...
export function ChartLineUp({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M16 10a1 1 0 1 1 0-2h4a1 1 0 0 1 1 1v4a1 1 0 1 1-2 0v-1.59l-4.3 4.3a1 1 0 0 1-1.4 0L10 12.4l-3.3 3.3a1 1 0 0 1-1.4-1.42l4-4a1 1 0 0 1 1.4 0l3.3 3.3L17.59 10z"
      />
    </svg>
  );
}
