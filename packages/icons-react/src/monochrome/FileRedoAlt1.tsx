...
export function FileRedoAlt1({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M14 2v5.2c0 .28 0 .42.05.53q.08.15.22.22c.11.05.25.05.53.05H20zm7 11.5a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-3a1 1 0 1 1 0-2h.82A2 2 0 0 0 15.5 18a2 2 0 0 0 3.33 1.5 1 1 0 1 1 1.34 1.48A3.99 3.99 0 0 1 13.5 18a4 4 0 0 1 6.5-3.12v-.38a1 1 0 0 1 1-1"
      />
    </svg>
  );
}
