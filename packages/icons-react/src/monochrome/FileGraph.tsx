...
export function FileGraph({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M14 2v5.2c0 .28 0 .42.05.53q.08.15.22.22c.11.05.25.05.53.05H20zm-6 8a1 1 0 1 0 0 2h2a1 1 0 1 0 0-2zm8.7 3.3a1 1 0 0 0-1.4 0L13 15.58l-1.3-1.3a1 1 0 0 0-1.4 0l-3 3a1 1 0 1 0 1.4 1.42l2.3-2.3 1.3 1.3a1 1 0 0 0 1.4 0l3-3a1 1 0 0 0 0-1.42"
      />
    </svg>
  );
}
