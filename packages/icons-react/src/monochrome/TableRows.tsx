  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M4.1 5.55C4 5.76 4 6.04 4 6.6v10.8c0 .56 0 .84.1 1.05a1 1 0 0 0 .45.44c.21.11.49.11 1.05.11H8V5H5.6c-.56 0-.84 0-1.05.1a1 1 0 0 0-.44.45M10 5h8.4c.56 0 .84 0 1.05.1a1 1 0 0 1 .44.45c.11.21.11.49.11 1.05V11H10zm10 8H10v6h8.4c.56 0 .84 0 1.05-.1a1 1 0 0 0 .44-.45c.11-.21.11-.49.11-1.05z"
        clipRule="evenodd"
        opacity=".3"
      />
      <path
