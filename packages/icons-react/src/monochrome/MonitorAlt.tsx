...
export function MonitorAlt({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M4.1 4.55C4 4.76 4 5.04 4 5.6V14h16V5.6c0-.56 0-.84-.1-1.05a1 1 0 0 0-.45-.44C19.24 4 18.96 4 18.4 4H5.6c-.56 0-.84 0-1.05.1a1 1 0 0 0-.44.45M11 19.03V18h2v1.03a13 13 0 0 1 3.1.51c.69.21 1.12.43 1.32.55.51.3.77.92.41 1.46a1 1 0 0 1-1.37.29c-.03-.01-.32-.2-.94-.38A12 12 0 0 0 12 21a12 12 0 0 0-3.52.46c-.62.19-.91.37-.94.38a1 1 0 0 1-1.1-1.67q.7-.4 1.45-.63a13 13 0 0 1 3.11-.51"
      />
    </svg>
  );
}
