...
export function HouseSun({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M12.9 7.46a2 2 0 0 1 1.2 0 2 2 0 0 1 .65.36q.24.2.5.45l6.43 6a1 1 0 1 1-1.36 1.46l-.32-.3v4q0 .39-.02.7-.01.36-.2.78a2 2 0 0 1-.87.87q-.41.19-.77.2-.33.02-.7.02H9.56q-.39 0-.7-.02c-.24-.02-.5-.06-.78-.2a2 2 0 0 1-.87-.87 2 2 0 0 1-.2-.77l-.01-.7v-4l-.32.3a1 1 0 1 1-1.36-1.47l6.43-6q.26-.25.5-.45c.17-.13.38-.28.66-.36"
      />
    </svg>
  );
}
