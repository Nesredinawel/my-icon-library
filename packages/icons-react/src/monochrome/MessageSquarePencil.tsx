  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M15.59 7.41a1.4 1.4 0 0 0-1.98 0L9.66 11.4c-.46.46-.69.7-.87.96q-.25.35-.42.74c-.12.3-.2.62-.34 1.26L8 14.4c-.08.34.22.65.56.58.68-.14 1.02-.2 1.34-.33q.42-.15.8-.43c.28-.2.53-.44 1.02-.94l3.86-3.89a1.4 1.4 0 0 0 0-1.99"
        clip-rule="evenodd"
      />
    </svg>
  );
