...
export function LaptopLockAlt({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M11.46 5h6.34c.58 0 .95 0 1.23.02.27.03.37.06.42.09a1 1 0 0 1 .44.44c.03.05.06.15.09.42.02.28.02.65.02 1.23V15h2V7.16q0-.8-.03-1.36a3 3 0 0 0-.3-1.16 3 3 0 0 0-1.3-1.31c-.39-.2-.78-.27-1.18-.3Q18.65 3 17.85 3h-7.26q.27.6.37 1.3a4 4 0 0 1 .51.7M2 15v-3.54A4 4 0 0 0 4 12v3z"
        opacity=".3"
      />
      <path
        fill="currentColor"
