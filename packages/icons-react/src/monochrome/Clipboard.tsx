...
export function Clipboard({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M7 5.75c0-.7 0-1.05.06-1.34A3 3 0 0 1 9.4 2.06C9.7 2 10.04 2 10.74 2h2.5c.7 0 1.05 0 1.34.06a3 3 0 0 1 2.35 2.35c.06.3.06.64.06 1.34 0 .23 0 .35-.02.45a1 1 0 0 1-.78.78c-.1.02-.22.02-.45.02h-7.5c-.23 0-.35 0-.45-.02a1 1 0 0 1-.78-.78z"
      />
    </svg>
  );
}
