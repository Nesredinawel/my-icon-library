...
export function LifeRing({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M14.03 8.55a4 4 0 0 0-4.06 0l-4.3-4.3a9.96 9.96 0 0 1 12.66 0zm1.42 5.48a4 4 0 0 0 0-4.06l4.3-4.3a9.96 9.96 0 0 1 0 12.66zm-5.48 1.42a4 4 0 0 0 4.06 0l4.3 4.3a9.96 9.96 0 0 1-12.66 0zM8.55 9.97a4 4 0 0 0 0 4.06l-4.3 4.3a9.96 9.96 0 0 1 0-12.66z"
        opacity=".3"
      />
      <path
        fill="currentColor"
