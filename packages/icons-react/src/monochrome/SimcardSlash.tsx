  ...
  return (
    ...
    >
      <g fill="currentColor" opacity=".3">
        <path d="M11 6.5v.27l1 1V6.5a1 1 0 1 1 2 0v2a1 1 0 0 1-.44.83L20 15.77V9.74c0-.65 0-.97-.06-1.27a3 3 0 0 0-.29-.79 6 6 0 0 0-.76-1.02l-2.45-2.93a6 6 0 0 0-1.12-1.18 3 3 0 0 0-.95-.45C14 2 13.57 2 12.75 2H8.8c-1.14 0-1.9 0-2.46.1l3.42 3.43A1 1 0 0 1 11 6.5" />
        <path
          fill-rule="evenodd"
