  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M15.6 9.41a1.4 1.4 0 0 0-1.99 0L9.67 13.4c-.46.46-.7.7-.88.96q-.25.35-.41.74c-.13.3-.2.62-.35 1.26L8 16.4c-.08.34.22.65.56.58.68-.14 1.02-.2 1.34-.33q.42-.16.8-.43c.28-.2.53-.44 1.02-.94l3.86-3.89a1.4 1.4 0 0 0 0-1.99"
        clip-rule="evenodd"
      />
    </svg>
  );
