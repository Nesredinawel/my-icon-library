...
export function FileCode({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M14 2v5.2c0 .28 0 .42.05.53q.08.15.22.22c.11.05.25.05.53.05H20zm-3.3 11.7a1 1 0 0 0-1.4-1.4l-2 2a1 1 0 0 0 0 1.4l2 2a1 1 0 0 0 1.4-1.4L9.42 15zm6 .6-2-2a1 1 0 0 0-1.4 1.4l1.29 1.3-1.3 1.3a1 1 0 0 0 1.42 1.4l2-2a1 1 0 0 0 0-1.4"
      />
    </svg>
  );
}
