  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M11.51 14.09a1.4 1.4 0 0 1 1.49.32l.26.28.01.02 2.86 3.2.03.03.48.56c.12.16.33.47.36.87.03.44-.13.9-.47 1.23a1.5 1.5 0 0 1-.92.38q-.32.03-.71.02H9.1q-.39 0-.7-.02a1.5 1.5 0 0 1-.93-.38c-.34-.33-.5-.8-.47-1.23.03-.4.24-.7.36-.87q.2-.26.48-.56l.03-.03 2.86-3.2.01-.02q.12-.15.26-.28c.1-.1.27-.24.51-.32"
        clip-rule="evenodd"
      />
    </svg>
  );
