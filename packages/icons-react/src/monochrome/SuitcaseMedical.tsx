...
export function SuitcaseMedical({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M17 5v1h-2V5a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v1H7V5a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3M5 6.16c.52-.1 1.15-.14 2-.15v15.98c-.85 0-1.48-.04-2-.15zm14 15.68c-.52.1-1.15.14-2 .15V6.01c.85 0 1.48.04 2 .15zM12 11a1 1 0 0 1 1 1v1h1a1 1 0 1 1 0 2h-1v1a1 1 0 1 1-2 0v-1h-1a1 1 0 1 1 0-2h1v-1a1 1 0 0 1 1-1"
      />
    </svg>
  );
}
