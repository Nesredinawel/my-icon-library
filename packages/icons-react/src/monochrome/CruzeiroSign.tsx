...
export function CruzeiroSign({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M14 19.99v-6.7c.63-.94 1.14-1.29 1.6-1.29.52 0 1.1.28 1.62.94a1 1 0 1 0 1.56-1.25A4.1 4.1 0 0 0 15.6 10c-.66 0-1.23.21-1.71.53A1 1 0 0 0 12 11v8.82a7 7 0 0 0 2 .17"
      />
      <path
        fill="currentColor"
        fill-rule="evenodd"
