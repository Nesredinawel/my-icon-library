...
export function VolumeXmark({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M15.3 8.8a1 1 0 0 1 1.4 0l1.8 1.79 1.8-1.8a1 1 0 1 1 1.4 1.42L19.92 12l1.8 1.8a1 1 0 0 1-1.42 1.4l-1.79-1.79-1.8 1.8a1 1 0 0 1-1.4-1.42L17.08 12l-1.8-1.8a1 1 0 0 1 0-1.4"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
