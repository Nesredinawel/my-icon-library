...
export function ClipboardList({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M7.06 4.41C7 4.71 7 5.05 7 5.75c0 .23 0 .35.02.45.08.4.39.7.78.78.1.02.22.02.45.02h7.5c.23 0 .35 0 .45-.02a1 1 0 0 0 .78-.78c.02-.1.02-.22.02-.45 0-.7 0-1.05-.06-1.34a3 3 0 0 0-2.35-2.35C14.29 2 13.95 2 13.25 2h-2.5c-.7 0-1.05 0-1.34.06A3 3 0 0 0 7.06 4.4m4.64 5.9a1 1 0 0 0-1.4 0L9 11.58l-.3-.3a1 1 0 0 0-1.4 1.42l1 1a1 1 0 0 0 1.4 0l2-2a1 1 0 0 0 0-1.42M14 11a1 1 0 1 0 0 2h2a1 1 0 1 0 0-2zm-2.3 5.7a1 1 0 0 0-1.4-1.4L9 16.58l-.3-.3a1 1 0 0 0-1.4 1.42l1 1a1 1 0 0 0 1.4 0zM14 16a1 1 0 1 0 0 2h2a1 1 0 1 0 0-2z"
      />
    </svg>
  );
}
