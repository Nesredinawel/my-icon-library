...
export function PhoneXmark({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M16.7 2.3a1 1 0 1 0-1.4 1.4l1.79 1.8-1.8 1.8a1 1 0 0 0 1.42 1.4l1.79-1.79 1.8 1.8a1 1 0 1 0 1.4-1.42L19.92 5.5l1.8-1.8a1 1 0 0 0-1.42-1.4l-1.8 1.78z"
      />
    </svg>
  );
}
