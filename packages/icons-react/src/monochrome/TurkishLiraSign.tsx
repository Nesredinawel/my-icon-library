...
export function TurkishLiraSign({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M8 4a1 1 0 0 0-2 0v3.48l2-.85zm0 4.8-2 .86v1.82l2-.85zm0 4-2 .86V20a1 1 0 0 0 1 1h4.89A8.1 8.1 0 0 0 20 12.89V12a1 1 0 1 0-2 0v.89A6.1 6.1 0 0 1 11.89 19H8z"
        opacity=".3"
      />
      <path
        fill="currentColor"
