  ...
  return (
    ...
    >
      <g fill="currentColor" opacity=".3">
        <path d="m8.5 11.6.58 1.4H7.92zm6 2.4v-4h.5a2 2 0 0 1 0 4z" />
        <path
          fillRule="evenodd"
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M8.5 8a1 1 0 0 1 .92.62l2.5 6a1 1 0 1 1-1.84.76L9.92 15H7.08l-.16.38a1 1 0 0 1-1.84-.76l2.5-6A1 1 0 0 1 8.5 8m.58 5-.58-1.4-.58 1.4zm3.42-3.5c0-.83.67-1.5 1.5-1.5h1a4 4 0 0 1 0 8h-1a1.5 1.5 0 0 1-1.5-1.5zm2 .5v4h.5a2 2 0 1 0 0-4z"
        clipRule="evenodd"
      />
    </svg>
  );
