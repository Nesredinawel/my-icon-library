...
export function Monitor({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M4 5.6c0-.56 0-.84.1-1.05a1 1 0 0 1 .45-.44C4.76 4 5.04 4 5.6 4h12.8c.56 0 .84 0 1.05.1a1 1 0 0 1 .44.45c.11.21.11.49.11 1.05V14H4zM11 18h2v2h3a1 1 0 1 1 0 2H8a1 1 0 1 1 0-2h3z"
      />
    </svg>
  );
}
