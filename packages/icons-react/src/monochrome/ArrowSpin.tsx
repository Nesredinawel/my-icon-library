...
export function ArrowSpin({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M11 4a1 1 0 0 1 1-1c2.45 0 4.68.98 6.3 2.57V5a1 1 0 1 1 2 0v3a1 1 0 0 1-1 1h-3a1 1 0 1 1 0-2h.6c-1.26-1.24-3-2-4.9-2a1 1 0 0 1-1-1M4 16.3a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-.57A7 7 0 0 0 12 19a1 1 0 1 1 0 2c-2.3 0-4.4-.87-6-2.3v.6a1 1 0 1 1-2 0z"
        opacity=".3"
      />
      <path
        fill="currentColor"
